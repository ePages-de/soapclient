using System;
using EpagesWebServices.OrderService3Ref;
...
namespace EpagesWebServices
{
	...
	/// </summary>
	[TestFixture]
	public class Order3Test : WebServiceConfiguration
	{
        ...
        const string alias = "dotnet_test-3";
        ...
        {
            TGetInfo_Return[] Orders_out = orderService.getInfo(Orders, OrderAttributes, AddressAttributes, null);
