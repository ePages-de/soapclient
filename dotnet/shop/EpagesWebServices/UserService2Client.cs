using System;
using EpagesWebServices.UserService2Ref;
...
namespace EpagesWebServices
{
	...
	/// </summary>
	public class UserService2Client : WebServiceConfiguration
	{
		UserService stub;
		...
		{
			return getInfo(UserPaths, new string[0] );
		}
		...
		{
			TGetInfo_Return[] Users_out = stub.getInfo(UserPaths, attributes);
