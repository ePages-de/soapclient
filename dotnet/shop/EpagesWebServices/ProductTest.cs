...
namespace EpagesWebServices
{
	...
	public class ProductTest
	{
		...
		public void getInfo(bool alreadyUpdated)
		{
            ...
            if (alreadyUpdated) 
			{
				Assert.AreEqual(DateTime.Parse(Product_update.Attributes[0].Value),  DateTime.Parse(Product_out.Attributes[0].Value), "AvailabilityDate");
			...
			{
				Assert.AreEqual(DateTime.Parse(Product_in.Attributes[0].Value),  DateTime.Parse(Product_out.Attributes[0].Value), "AvailabilityDate");
