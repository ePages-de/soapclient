...
namespace EpagesWebServices
{
	...
	/// </summary>
	public class OrderDocumentService6Client : WebServiceConfiguration
	{
		OrderDocumentService stub;

		public OrderDocumentService6Client()
		{
        ...
        {
            return getInfo(OrderDocumentPaths, attributes, new string[0], languages);
        }

        public ArrayList getInfo(string[] OrderDocumentPaths, string[] attributes, string[] addrAttributes, string[] languages)
        {
            return getInfo(OrderDocumentPaths, attributes, addrAttributes, new string[0], languages);
        }
		...
		public ArrayList getInfo(string[] OrderDocumentPaths, string[] attributes, string[] addrAttributes, string[] itemAttributes, string[] languages)
		{
            TGetInfo_Return[] OrderDocuments_out = stub.getInfo(
                                                        OrderDocumentPaths, 
                                                        attributes, 
                                                        addrAttributes,
                                                        itemAttributes,
