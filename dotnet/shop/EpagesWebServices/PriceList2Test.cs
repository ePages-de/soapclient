using System;
using EpagesWebServices.PriceListService2Ref;
...
namespace EpagesWebServices
{
	...
	/// </summary>
	[TestFixture]
	public class PriceList2Test
	{
		PriceListService2Client serviceClient;
		...
		public void Init()
		{
            ...
            serviceClient = new PriceListService2Client();
            ...
            TGlobalValueDiscount discount1 = new TGlobalValueDiscount();
            discount1.Value = 50; discount1.Discount = 10;
            TGlobalValueDiscount discount2 = new TGlobalValueDiscount();
            discount2.Value = 200; discount2.Discount = 15;
            PriceList_in.GlobalValueDiscounts = new TGlobalValueDiscount[] { discount1, discount2 };
            ...
            TGlobalValueDiscount discount3 = new TGlobalValueDiscount();
            discount3.Value = 500; discount2.Discount = 20;
            PriceList_update.GlobalValueDiscounts = new TGlobalValueDiscount[] { discount1, discount3 };
