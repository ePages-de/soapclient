using System;
using EpagesWebServices.CustomerService4Ref;
...
namespace EpagesWebServices
{
	...
	/// </summary>
	public class CustomerService4Client : WebServiceConfiguration
	{
		CustomerService stub;

		public CustomerService4Client()
		{
		...
		{
			TGetInfo_Return[] customers_out = stub.getInfo(customerPaths, attributes, null);
