...
namespace EpagesWebServices
{
	...
	public class Product9Test
	{
		...
		public void Init()
		{
			...
			download.TargetUrl = "http://www.epages.com/de/download/de-epages6-SEO.pdf";
        ...
        /// test creation of a download Product and check if method returns a true value
        /// </summary>
        public void createDownloadWithUpload()
        {
            TCreate_Input[] Products = new TCreate_Input[] { Product_down_up };
        ...
        /// <summary>
        /// test getInfoDownloadWithUpload() is a created download product
        /// </summary>
        public void getInfoDownloadWithUpload()
        {
            string[] ProductPaths = new string[] { path + alias };
            ArrayList Products_out = serviceClient.getInfo(ProductPaths, new string[] { });
		...
		public void runAllTests()
		{
            ...
            createDownloadWithUpload();
            exists(true);
            getInfoDownloadWithUpload();
            delete();
        }
	}
}
