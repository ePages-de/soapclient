...
using EpagesProviderWebServices.ShopConfigService7Ref;
...
namespace EpagesProviderWebServices
{
	...
	/// </summary>
	[TestFixture]
	public class ShopConfig7Test : WebServiceConfiguration
	{
		...
		public void shopInStoreDatabase() 
		{
            ...
            Shop_create.SecondaryDomains = new string[] { "herdomain.com", "hisdomain.com" };
            ...
            Assert.AreEqual(Shop_create.SecondaryDomains, Shop_out.SecondaryDomains, "SecondaryDomains");
            ...
            Shop_update.SecondaryDomains = new string[] { "ourdomain.com", "theirdomain.com" };
            ...
            Assert.AreEqual(Shop_update.SecondaryDomains, Shop_out.SecondaryDomains, "updated SecondaryDomains");
            ...
            Console.WriteLine("shopConfigService.setSecondaryDomains");
            string[] secondaryDomains = new string[]{ "invaliddomain.com", "updateddomain.com" };
            shopConfigService.setSecondaryDomains(shopRef, secondaryDomains);
            Shop_out = shopConfigService.getInfo(infoShopInput);
            Assert.AreEqual(secondaryDomains, Shop_out.SecondaryDomains, "set SecondaryDomains");
