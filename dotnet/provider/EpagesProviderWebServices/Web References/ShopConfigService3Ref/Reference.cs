...
namespace EpagesProviderWebServices.ShopConfigService3Ref {
    ...
    public partial class ShopConfigService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public void getInfoAsync(TShopRef UpdateShopData) {
            this.getInfoAsync(UpdateShopData, null);
        }
        
        /// <remarks/>
        public void getInfoAsync(TShopRef UpdateShopData, object userState) {
            ...
            this.InvokeAsync("getInfo", new object[] {
                        UpdateShopData}, this.getInfoOperationCompleted, userState);
        }
