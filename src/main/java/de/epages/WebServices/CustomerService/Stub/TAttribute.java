...
public class TAttribute  implements java.io.Serializable {
    ...
    private de.epages.WebServices.CustomerService.Stub.TLocalizedValue[] localizedValues;
    ...
    public TAttribute(
           ...
           de.epages.WebServices.CustomerService.Stub.TLocalizedValue[] localizedValues,
     ...
     *             see epagestypes:ListOfLocalizedValues
     */
    public de.epages.WebServices.CustomerService.Stub.TLocalizedValue[] getLocalizedValues() {
     ...
     *             see epagestypes:ListOfLocalizedValues
     */
    public void setLocalizedValues(de.epages.WebServices.CustomerService.Stub.TLocalizedValue[] localizedValues) {
        this.localizedValues = localizedValues;
    }
