...
public class TGetInfo_Return  implements java.io.Serializable {
    ...
    /* product's name */
    private de.epages.WebServices.ProductService7.Stub.TLocalizedValue[] name;

    /* product's description */
    private de.epages.WebServices.ProductService7.Stub.TLocalizedValue[] description;

    /* product's long description (formerly LongDescription) */
    private de.epages.WebServices.ProductService7.Stub.TLocalizedValue[] text;

    /* product's key words */
    private de.epages.WebServices.ProductService7.Stub.TLocalizedValue[] keywords;

    /* Localizable page title shown in SF. */
    private de.epages.WebServices.ProductService7.Stub.TLocalizedValue[] title;
    ...
    private de.epages.WebServices.ProductService7.Stub.TLocalizedValue[] availabilityComment;
    ...
    private de.epages.WebServices.ProductService7.Stub.TLocalizedValue[] URI;

    /* complete url for canonical tag (based on domain name and URI,
     * i.e. http://my.do.main/myURI) */
    private de.epages.WebServices.ProductService7.Stub.TLocalizedValue[] canonicalURL;
    ...
    private de.epages.WebServices.ProductService7.Stub.TDownload[] downloadProductMaps;
    ...
    private de.epages.WebServices.ProductService7.Stub.TAttribute[] variationAttributes;

    /* list of product prices (see producttypes:ListOfListOfProductPrices) */
    private de.epages.WebServices.ProductService7.Stub.TProductPrice[] productPrices;

    /* list of manufacturer prices (see producttypes:ListOfListOfProductPrices) */
    private de.epages.WebServices.ProductService7.Stub.TProductPrice[] manufacturerPrices;

    /* list of deposit prices (see producttypes:ListOfListOfProductPrices) */
    private de.epages.WebServices.ProductService7.Stub.TProductPrice[] depositPrices;

    /* list of eco participation  prices (see producttypes:ListOfListOfProductPrices) */
    private de.epages.WebServices.ProductService7.Stub.TProductPrice[] ecoParticipationPrices;

    /* list of prepayment prices (see producttypes:ListOfListOfProductPrices) */
    private de.epages.WebServices.ProductService7.Stub.TProductPrice[] prepaymentPrices;
    ...
    private de.epages.WebServices.ProductService7.Stub.TAttribute[] attributes;

    /* error object (see epagestypes:TError) */
    private de.epages.WebServices.ProductService7.Stub.TError error;
    ...
    public TGetInfo_Return(
           ...
           de.epages.WebServices.ProductService7.Stub.TLocalizedValue[] name,
           de.epages.WebServices.ProductService7.Stub.TLocalizedValue[] description,
           de.epages.WebServices.ProductService7.Stub.TLocalizedValue[] text,
           de.epages.WebServices.ProductService7.Stub.TLocalizedValue[] keywords,
           de.epages.WebServices.ProductService7.Stub.TLocalizedValue[] title,
           ...
           boolean isAvailable,
           de.epages.WebServices.ProductService7.Stub.TLocalizedValue[] availabilityComment,
           java.util.Calendar availabilityDate,
           de.epages.WebServices.ProductService7.Stub.TLocalizedValue[] URI,
           de.epages.WebServices.ProductService7.Stub.TLocalizedValue[] canonicalURL,
           boolean isDownloadProduct,
           java.math.BigInteger maxDownloadTime,
           java.math.BigInteger maxDownloadCount,
           de.epages.WebServices.ProductService7.Stub.TDownload[] downloadProductMaps,
           ...
           de.epages.WebServices.ProductService7.Stub.TAttribute[] variationAttributes,
           de.epages.WebServices.ProductService7.Stub.TProductPrice[] productPrices,
           de.epages.WebServices.ProductService7.Stub.TProductPrice[] manufacturerPrices,
           de.epages.WebServices.ProductService7.Stub.TProductPrice[] depositPrices,
           de.epages.WebServices.ProductService7.Stub.TProductPrice[] ecoParticipationPrices,
           de.epages.WebServices.ProductService7.Stub.TProductPrice[] prepaymentPrices,
           java.lang.String prepaymentType,
           java.lang.Float prepaymentValue,
           de.epages.WebServices.ProductService7.Stub.TAttribute[] attributes,
           de.epages.WebServices.ProductService7.Stub.TError error) {
           this.path = path;
           this.alias = alias;
           this._class = _class;
           this.name = name;
     ...
     */
    public de.epages.WebServices.ProductService7.Stub.TLocalizedValue[] getName() {
        return name;
    }
     ...
     */
    public void setName(de.epages.WebServices.ProductService7.Stub.TLocalizedValue[] name) {
        this.name = name;
    }
     ...
     */
    public de.epages.WebServices.ProductService7.Stub.TLocalizedValue[] getDescription() {
        return description;
    }
     ...
     */
    public void setDescription(de.epages.WebServices.ProductService7.Stub.TLocalizedValue[] description) {
        this.description = description;
    }
     ...
     */
    public de.epages.WebServices.ProductService7.Stub.TLocalizedValue[] getText() {
        return text;
    }
     ...
     */
    public void setText(de.epages.WebServices.ProductService7.Stub.TLocalizedValue[] text) {
        this.text = text;
    }
     ...
     */
    public de.epages.WebServices.ProductService7.Stub.TLocalizedValue[] getKeywords() {
        return keywords;
    }
     ...
     */
    public void setKeywords(de.epages.WebServices.ProductService7.Stub.TLocalizedValue[] keywords) {
        this.keywords = keywords;
    }
     ...
     */
    public de.epages.WebServices.ProductService7.Stub.TLocalizedValue[] getTitle() {
        return title;
    }
     ...
     */
    public void setTitle(de.epages.WebServices.ProductService7.Stub.TLocalizedValue[] title) {
        this.title = title;
    }
     ...
     */
    public de.epages.WebServices.ProductService7.Stub.TLocalizedValue[] getAvailabilityComment() {
     ...
     */
    public void setAvailabilityComment(de.epages.WebServices.ProductService7.Stub.TLocalizedValue[] availabilityComment) {
        this.availabilityComment = availabilityComment;
    }
     ...
     */
    public de.epages.WebServices.ProductService7.Stub.TLocalizedValue[] getURI() {
        return URI;
    }
     ...
     */
    public void setURI(de.epages.WebServices.ProductService7.Stub.TLocalizedValue[] URI) {
        this.URI = URI;
    }
     ...
     * i.e. http://my.do.main/myURI)
     */
    public de.epages.WebServices.ProductService7.Stub.TLocalizedValue[] getCanonicalURL() {
        return canonicalURL;
    }
     ...
     * i.e. http://my.do.main/myURI)
     */
    public void setCanonicalURL(de.epages.WebServices.ProductService7.Stub.TLocalizedValue[] canonicalURL) {
        this.canonicalURL = canonicalURL;
    }
     ...
     */
    public de.epages.WebServices.ProductService7.Stub.TDownload[] getDownloadProductMaps() {
     ...
     */
    public void setDownloadProductMaps(de.epages.WebServices.ProductService7.Stub.TDownload[] downloadProductMaps) {
        this.downloadProductMaps = downloadProductMaps;
    }
     ...
     *             (see epagestypes:ListOfAttributes)
     */
    public de.epages.WebServices.ProductService7.Stub.TAttribute[] getVariationAttributes() {
     ...
     *             (see epagestypes:ListOfAttributes)
     */
    public void setVariationAttributes(de.epages.WebServices.ProductService7.Stub.TAttribute[] variationAttributes) {
        this.variationAttributes = variationAttributes;
    }
     ...
     */
    public de.epages.WebServices.ProductService7.Stub.TProductPrice[] getProductPrices() {
     ...
     */
    public void setProductPrices(de.epages.WebServices.ProductService7.Stub.TProductPrice[] productPrices) {
        this.productPrices = productPrices;
    }
     ...
     */
    public de.epages.WebServices.ProductService7.Stub.TProductPrice[] getManufacturerPrices() {
     ...
     */
    public void setManufacturerPrices(de.epages.WebServices.ProductService7.Stub.TProductPrice[] manufacturerPrices) {
        this.manufacturerPrices = manufacturerPrices;
    }
     ...
     */
    public de.epages.WebServices.ProductService7.Stub.TProductPrice[] getDepositPrices() {
     ...
     */
    public void setDepositPrices(de.epages.WebServices.ProductService7.Stub.TProductPrice[] depositPrices) {
        this.depositPrices = depositPrices;
    }
     ...
     */
    public de.epages.WebServices.ProductService7.Stub.TProductPrice[] getEcoParticipationPrices() {
     ...
     */
    public void setEcoParticipationPrices(de.epages.WebServices.ProductService7.Stub.TProductPrice[] ecoParticipationPrices) {
        this.ecoParticipationPrices = ecoParticipationPrices;
    }
     ...
     */
    public de.epages.WebServices.ProductService7.Stub.TProductPrice[] getPrepaymentPrices() {
     ...
     */
    public void setPrepaymentPrices(de.epages.WebServices.ProductService7.Stub.TProductPrice[] prepaymentPrices) {
        this.prepaymentPrices = prepaymentPrices;
    }
     ...
     */
    public de.epages.WebServices.ProductService7.Stub.TAttribute[] getAttributes() {
        return attributes;
    }
     ...
     */
    public void setAttributes(de.epages.WebServices.ProductService7.Stub.TAttribute[] attributes) {
        this.attributes = attributes;
    }
     ...
     */
    public de.epages.WebServices.ProductService7.Stub.TError getError() {
        return error;
    }
     ...
     */
    public void setError(de.epages.WebServices.ProductService7.Stub.TError error) {
        this.error = error;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/ProductTypes/2011/01", "TGetInfo_Return"));
