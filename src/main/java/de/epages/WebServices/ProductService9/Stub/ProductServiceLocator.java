...
public class ProductServiceLocator extends org.apache.axis.client.Service implements de.epages.WebServices.ProductService9.Stub.ProductService {
 ...
 */
    ...
    public de.epages.WebServices.ProductService9.Stub.Port_Product_PortType getport_Product() throws javax.xml.rpc.ServiceException {
    ...
    public de.epages.WebServices.ProductService9.Stub.Port_Product_PortType getport_Product(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            de.epages.WebServices.ProductService9.Stub.Bind_Product_SOAPStub _stub = new de.epages.WebServices.ProductService9.Stub.Bind_Product_SOAPStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (de.epages.WebServices.ProductService9.Stub.Port_Product_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                de.epages.WebServices.ProductService9.Stub.Bind_Product_SOAPStub _stub = new de.epages.WebServices.ProductService9.Stub.Bind_Product_SOAPStub(new java.net.URL(port_Product_address), this);
                _stub.setPortName(getport_ProductWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("urn://epages.de/WebService/ProductService/2011/10", "ProductService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("urn://epages.de/WebService/ProductService/2011/10", "port_Product"));
        }
