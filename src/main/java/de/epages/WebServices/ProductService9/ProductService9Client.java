...
import de.epages.WebServices.ProductService9.Stub.Bind_Product_SOAPStub;
import de.epages.WebServices.ProductService9.Stub.ProductService;
import de.epages.WebServices.ProductService9.Stub.ProductServiceLocator;
import de.epages.WebServices.ProductService9.Stub.TCreate_Input;
import de.epages.WebServices.ProductService9.Stub.TCreate_Return;
import de.epages.WebServices.ProductService9.Stub.TDelete_Return;
import de.epages.WebServices.ProductService9.Stub.TExists_Return;
import de.epages.WebServices.ProductService9.Stub.TFind_Input;
import de.epages.WebServices.ProductService9.Stub.TGetInfo_Return;
import de.epages.WebServices.ProductService9.Stub.TUpdate_Input;
import de.epages.WebServices.ProductService9.Stub.TUpdate_Return;

public class ProductService9Client {
    private ProductService service;
    private Bind_Product_SOAPStub stub;
    private static Logger log = Logger.getLogger(ProductService9Client.class.getName());

    /**
     * Class constructor
     */
    public ProductService9Client(WebServiceConfiguration config) {
