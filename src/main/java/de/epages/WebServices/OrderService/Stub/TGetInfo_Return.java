...
public class TGetInfo_Return  implements java.io.Serializable {
    ...
    private de.epages.WebServices.OrderService.Stub.TLineItemContainerOut lineItemContainer;
    ...
    private de.epages.WebServices.OrderService.Stub.TError error;
    ...
    public TGetInfo_Return(
           ...
           de.epages.WebServices.OrderService.Stub.TLineItemContainerOut lineItemContainer,
           ...
           de.epages.WebServices.OrderService.Stub.TError error) {
           this.path = path;
           this.alias = alias;
           this._class = _class;
     ...
     */
    public de.epages.WebServices.OrderService.Stub.TLineItemContainerOut getLineItemContainer() {
     ...
     */
    public void setLineItemContainer(de.epages.WebServices.OrderService.Stub.TLineItemContainerOut lineItemContainer) {
        this.lineItemContainer = lineItemContainer;
    }
     ...
     */
    public de.epages.WebServices.OrderService.Stub.TError getError() {
        return error;
    }
     ...
     */
    public void setError(de.epages.WebServices.OrderService.Stub.TError error) {
        this.error = error;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/OrderTypes/2005/01", "TGetInfo_Return"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/OrderTypes/2005/01", "TLineItemContainerOut"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
