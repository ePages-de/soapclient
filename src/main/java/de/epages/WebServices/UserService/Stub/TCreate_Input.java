...
public class TCreate_Input  implements java.io.Serializable {
    ...
    private de.epages.WebServices.UserService.Stub.TAddress billingAddress;

    /* user's shipping address */
    private de.epages.WebServices.UserService.Stub.TAddress shippingAddress;
    ...
    private de.epages.WebServices.UserService.Stub.TAttribute[] attributes;
    ...
    public TCreate_Input(
           ...
           de.epages.WebServices.UserService.Stub.TAddress billingAddress,
           de.epages.WebServices.UserService.Stub.TAddress shippingAddress,
           java.lang.String[] customers,
           de.epages.WebServices.UserService.Stub.TAttribute[] attributes) {
           this.alias = alias;
     ...
     */
    public de.epages.WebServices.UserService.Stub.TAddress getBillingAddress() {
     ...
     */
    public void setBillingAddress(de.epages.WebServices.UserService.Stub.TAddress billingAddress) {
        this.billingAddress = billingAddress;
    }
     ...
     */
    public de.epages.WebServices.UserService.Stub.TAddress getShippingAddress() {
     ...
     */
    public void setShippingAddress(de.epages.WebServices.UserService.Stub.TAddress shippingAddress) {
        this.shippingAddress = shippingAddress;
    }
     ...
     */
    public de.epages.WebServices.UserService.Stub.TAttribute[] getAttributes() {
        return attributes;
    }
     ...
     */
    public void setAttributes(de.epages.WebServices.UserService.Stub.TAttribute[] attributes) {
        this.attributes = attributes;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/UserTypes/2005/01", "TCreate_Input"));
