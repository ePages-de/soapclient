...
import de.epages.WebServices.ProductService3.Stub.Bind_Product_SOAPStub;
import de.epages.WebServices.ProductService3.Stub.ProductService;
import de.epages.WebServices.ProductService3.Stub.ProductServiceLocator;
...
public class ProductService3Client {
    private ProductService service;
    private Bind_Product_SOAPStub stub;
    private static Logger log = Logger.getLogger(ProductService3Client.class.getName());

    /**
     * Class constructor
     */
    public ProductService3Client(WebServiceConfiguration config) {
