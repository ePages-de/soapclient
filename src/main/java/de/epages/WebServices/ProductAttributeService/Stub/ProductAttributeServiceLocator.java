...
public class ProductAttributeServiceLocator extends org.apache.axis.client.Service implements de.epages.WebServices.ProductAttributeService.Stub.ProductAttributeService {
 ...
 */
    ...
    public de.epages.WebServices.ProductAttributeService.Stub.Port_ProductAttribute_PortType getport_ProductAttribute() throws javax.xml.rpc.ServiceException {
    ...
    public de.epages.WebServices.ProductAttributeService.Stub.Port_ProductAttribute_PortType getport_ProductAttribute(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            de.epages.WebServices.ProductAttributeService.Stub.Bind_ProductAttribute_SOAPStub _stub = new de.epages.WebServices.ProductAttributeService.Stub.Bind_ProductAttribute_SOAPStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (de.epages.WebServices.ProductAttributeService.Stub.Port_ProductAttribute_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                de.epages.WebServices.ProductAttributeService.Stub.Bind_ProductAttribute_SOAPStub _stub = new de.epages.WebServices.ProductAttributeService.Stub.Bind_ProductAttribute_SOAPStub(new java.net.URL(port_ProductAttribute_address), this);
                _stub.setPortName(getport_ProductAttributeWSDDServiceName());
                return _stub;
            }
        }
