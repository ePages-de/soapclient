...
public class TDelete_Input  implements java.io.Serializable {
    ...
    private de.epages.WebServices.ProductBundleService.Stub.TBundledProductPath[] bundledProductPaths;
    ...
    public TDelete_Input(
           ...
           de.epages.WebServices.ProductBundleService.Stub.TBundledProductPath[] bundledProductPaths) {
     ...
     *             see tns:ListOfBundledProductPaths
     */
    public de.epages.WebServices.ProductBundleService.Stub.TBundledProductPath[] getBundledProductPaths() {
     ...
     *             see tns:ListOfBundledProductPaths
     */
    public void setBundledProductPaths(de.epages.WebServices.ProductBundleService.Stub.TBundledProductPath[] bundledProductPaths) {
        this.bundledProductPaths = bundledProductPaths;
    }
