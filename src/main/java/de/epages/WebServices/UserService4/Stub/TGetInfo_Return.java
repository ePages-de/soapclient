...
public class TGetInfo_Return  implements java.io.Serializable {
    ...
    private de.epages.WebServices.UserService4.Stub.TError error;
    ...
    public TGetInfo_Return(
           ...
           de.epages.WebServices.UserService4.Stub.TError error) {
           this.path = path;
           this.alias = alias;
           this._class = _class;
     ...
     */
    public de.epages.WebServices.UserService4.Stub.TError getError() {
        return error;
    }
     ...
     */
    public void setError(de.epages.WebServices.UserService4.Stub.TError error) {
        this.error = error;
    }
