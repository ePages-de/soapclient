...
import de.epages.WebServices.OrderDocumentService2.Stub.Bind_OrderDocument_SOAPStub;
import de.epages.WebServices.OrderDocumentService2.Stub.OrderDocumentService;
import de.epages.WebServices.OrderDocumentService2.Stub.OrderDocumentServiceLocator;
import de.epages.WebServices.OrderDocumentService2.Stub.TCreate_Input;
import de.epages.WebServices.OrderDocumentService2.Stub.TCreate_Return;
import de.epages.WebServices.OrderDocumentService2.Stub.TDelete_Return;
import de.epages.WebServices.OrderDocumentService2.Stub.TExists_Return;
import de.epages.WebServices.OrderDocumentService2.Stub.TGetCreditNotes_Return;
import de.epages.WebServices.OrderDocumentService2.Stub.TGetInfo_Return;
import de.epages.WebServices.OrderDocumentService2.Stub.TGetInvoices_Return;
import de.epages.WebServices.OrderDocumentService2.Stub.TGetPackingSlips_Return;

public class OrderDocumentService2Client {
    private OrderDocumentService service;
    private Bind_OrderDocument_SOAPStub stub;
    private static Logger log = Logger.getLogger(OrderDocumentService2Client.class.getName());

    /**
     * Class constructor
     */
    public OrderDocumentService2Client(WebServiceConfiguration config) {
