...
import de.epages.WebServices.OrderService2.Stub.Bind_Order_SOAPStub;
import de.epages.WebServices.OrderService2.Stub.OrderService;
import de.epages.WebServices.OrderService2.Stub.OrderServiceLocator;
import de.epages.WebServices.OrderService2.Stub.TCreate_Input;
import de.epages.WebServices.OrderService2.Stub.TCreate_Return;
import de.epages.WebServices.OrderService2.Stub.TDelete_Return;
import de.epages.WebServices.OrderService2.Stub.TExists_Return;
import de.epages.WebServices.OrderService2.Stub.TFind_Input;
import de.epages.WebServices.OrderService2.Stub.TGetInfo_Return;
import de.epages.WebServices.OrderService2.Stub.TUpdate_Input;
import de.epages.WebServices.OrderService2.Stub.TUpdate_Return;

public class OrderService2Client {
    private OrderService service;
    private Bind_Order_SOAPStub stub;
    private static Logger log = Logger.getLogger(OrderService2Client.class.getName());

    /**
     * Class constructor
     */
    public OrderService2Client(WebServiceConfiguration config) {
