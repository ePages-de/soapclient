...
public class CustomerServiceLocator extends org.apache.axis.client.Service implements de.epages.WebServices.CustomerService3.Stub.CustomerService {
 ...
 */
    ...
    public de.epages.WebServices.CustomerService3.Stub.Port_Customer_PortType getport_Customer(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            de.epages.WebServices.CustomerService3.Stub.Bind_Customer_SOAPStub _stub = new de.epages.WebServices.CustomerService3.Stub.Bind_Customer_SOAPStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (de.epages.WebServices.CustomerService3.Stub.Port_Customer_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                de.epages.WebServices.CustomerService3.Stub.Bind_Customer_SOAPStub _stub = new de.epages.WebServices.CustomerService3.Stub.Bind_Customer_SOAPStub(new java.net.URL(port_Customer_address), this);
                _stub.setPortName(getport_CustomerWSDDServiceName());
                return _stub;
            }
        }
