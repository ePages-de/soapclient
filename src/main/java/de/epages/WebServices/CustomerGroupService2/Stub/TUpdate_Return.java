 ...
 *         the updated flag will be returned if creation of customer
 * group was successfull
 */
public class TUpdate_Return  implements java.io.Serializable {
    ...
    /* a boolean flag indicating that this group was updated */
    private java.lang.Boolean updated;

    /* error object (see epagestypes:TError) */
    private de.epages.WebServices.CustomerGroupService2.Stub.TError error;
    ...
    public TUpdate_Return(
           ...
           de.epages.WebServices.CustomerGroupService2.Stub.TError error) {
           this.alias = alias;
           this.path = path;
    ...
    /**
     * Gets the alias value for this TUpdate_Return.
     * 
     * @return alias
     */
    ...
    /**
     * Sets the alias value for this TUpdate_Return.
     * 
     * @param alias
     */
     ...
     * 
     * @return updated   * a boolean flag indicating that this group was updated
     */
     ...
     * 
     * @param updated   * a boolean flag indicating that this group was updated
     */
     ...
     */
    public de.epages.WebServices.CustomerGroupService2.Stub.TError getError() {
        return error;
    }
     ...
     */
    public void setError(de.epages.WebServices.CustomerGroupService2.Stub.TError error) {
        this.error = error;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/CustomerGroupTypes/2011/03", "TUpdate_Return"));
