 ...
 *         the created flag will be returned if creation of customer
...
public class TCreate_Return  implements java.io.Serializable {
    ...
    /* a boolean flag indicating that this group was created */
     ...
     * 
     * @return created   * a boolean flag indicating that this group was created
     */
     ...
     * 
     * @param created   * a boolean flag indicating that this group was created
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/CustomerGroupTypes/2011/03", "TCreate_Return"));
