...
public class ShippingMethodServiceLocator extends org.apache.axis.client.Service implements de.epages.WebServices.ShippingMethodService.Stub.ShippingMethodService {

/**
 * epages5 Shipping Method Service
 */
    ...
    public de.epages.WebServices.ShippingMethodService.Stub.Port_ShippingMethod_PortType getport_ShippingMethod() throws javax.xml.rpc.ServiceException {
    ...
    public de.epages.WebServices.ShippingMethodService.Stub.Port_ShippingMethod_PortType getport_ShippingMethod(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            de.epages.WebServices.ShippingMethodService.Stub.Bind_ShippingMethod_SOAPStub _stub = new de.epages.WebServices.ShippingMethodService.Stub.Bind_ShippingMethod_SOAPStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (de.epages.WebServices.ShippingMethodService.Stub.Port_ShippingMethod_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                de.epages.WebServices.ShippingMethodService.Stub.Bind_ShippingMethod_SOAPStub _stub = new de.epages.WebServices.ShippingMethodService.Stub.Bind_ShippingMethod_SOAPStub(new java.net.URL(port_ShippingMethod_address), this);
                _stub.setPortName(getport_ShippingMethodWSDDServiceName());
                return _stub;
            }
        }
