...
public class TLineItemContainerIn  implements java.io.Serializable {
    ...
    private de.epages.WebServices.BasketService.Stub.TProductLineItemIn[] productLineItems;
    ...
    public TLineItemContainerIn(
           ...
           de.epages.WebServices.BasketService.Stub.TProductLineItemIn[] productLineItems,
     ...
     */
    public de.epages.WebServices.BasketService.Stub.TProductLineItemIn[] getProductLineItems() {
     ...
     */
    public void setProductLineItems(de.epages.WebServices.BasketService.Stub.TProductLineItemIn[] productLineItems) {
        this.productLineItems = productLineItems;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/BasketTypes/2013/11", "TLineItemContainerIn"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/BasketTypes/2013/11", "TProductLineItemIn"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
