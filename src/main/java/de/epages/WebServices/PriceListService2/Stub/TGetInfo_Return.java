...
public class TGetInfo_Return  implements java.io.Serializable {
    ...
    /* pricelist's name */
    private de.epages.WebServices.PriceListService2.Stub.TLocalizedValue[] name;
    ...
    private de.epages.WebServices.PriceListService2.Stub.TAttribute[] attributes;

    /* list of global value discounts sorted by value ascending (see
     * ListOfGlobalValueDiscounts) */
    private de.epages.WebServices.PriceListService2.Stub.TGlobalValueDiscount[] globalValueDiscounts;

    /* error object (see epagestypes:TError) */
    private de.epages.WebServices.PriceListService2.Stub.TError error;
    ...
    public TGetInfo_Return(
           ...
           de.epages.WebServices.PriceListService2.Stub.TLocalizedValue[] name,
           ...
           de.epages.WebServices.PriceListService2.Stub.TAttribute[] attributes,
           de.epages.WebServices.PriceListService2.Stub.TGlobalValueDiscount[] globalValueDiscounts,
           de.epages.WebServices.PriceListService2.Stub.TError error) {
           this.path = path;
           this.alias = alias;
           this._class = _class;
           this.name = name;
     ...
     */
    public de.epages.WebServices.PriceListService2.Stub.TLocalizedValue[] getName() {
        return name;
    }
     ...
     */
    public void setName(de.epages.WebServices.PriceListService2.Stub.TLocalizedValue[] name) {
        this.name = name;
    }
     ...
     */
    public de.epages.WebServices.PriceListService2.Stub.TAttribute[] getAttributes() {
        return attributes;
    }
     ...
     */
    public void setAttributes(de.epages.WebServices.PriceListService2.Stub.TAttribute[] attributes) {
        this.attributes = attributes;
    }


    /**
     * Gets the globalValueDiscounts value for this TGetInfo_Return.
     * 
     * @return globalValueDiscounts   * list of global value discounts sorted by value ascending (see
     * ListOfGlobalValueDiscounts)
     */
    public de.epages.WebServices.PriceListService2.Stub.TGlobalValueDiscount[] getGlobalValueDiscounts() {
        return globalValueDiscounts;
    }


    /**
     * Sets the globalValueDiscounts value for this TGetInfo_Return.
     * 
     * @param globalValueDiscounts   * list of global value discounts sorted by value ascending (see
     * ListOfGlobalValueDiscounts)
     */
    public void setGlobalValueDiscounts(de.epages.WebServices.PriceListService2.Stub.TGlobalValueDiscount[] globalValueDiscounts) {
        this.globalValueDiscounts = globalValueDiscounts;
    }
     ...
     */
    public de.epages.WebServices.PriceListService2.Stub.TError getError() {
        return error;
    }
     ...
     */
    public void setError(de.epages.WebServices.PriceListService2.Stub.TError error) {
        this.error = error;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/PriceListTypes/2010/08", "TGetInfo_Return"));
