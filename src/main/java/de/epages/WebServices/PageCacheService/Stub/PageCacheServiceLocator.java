...
public class PageCacheServiceLocator extends org.apache.axis.client.Service implements de.epages.WebServices.PageCacheService.Stub.PageCacheService {
 ...
 */
    ...
    public de.epages.WebServices.PageCacheService.Stub.Port_PageCache_PortType getport_PageCache(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            de.epages.WebServices.PageCacheService.Stub.Bind_PageCache_SOAPStub _stub = new de.epages.WebServices.PageCacheService.Stub.Bind_PageCache_SOAPStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (de.epages.WebServices.PageCacheService.Stub.Port_PageCache_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                de.epages.WebServices.PageCacheService.Stub.Bind_PageCache_SOAPStub _stub = new de.epages.WebServices.PageCacheService.Stub.Bind_PageCache_SOAPStub(new java.net.URL(port_PageCache_address), this);
                _stub.setPortName(getport_PageCacheWSDDServiceName());
                return _stub;
            }
        }
