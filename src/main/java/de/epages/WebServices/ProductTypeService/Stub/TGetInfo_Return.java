...
public class TGetInfo_Return  implements java.io.Serializable {
    ...
    private de.epages.WebServices.ProductTypeService.Stub.TAttribute[] attributes;
    ...
    public TGetInfo_Return(
           ...
           de.epages.WebServices.ProductTypeService.Stub.TAttribute[] attributes,
     ...
     */
    public de.epages.WebServices.ProductTypeService.Stub.TAttribute[] getAttributes() {
        return attributes;
    }
     ...
     */
    public void setAttributes(de.epages.WebServices.ProductTypeService.Stub.TAttribute[] attributes) {
        this.attributes = attributes;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/ProductTypeTypes/2007/10", "TGetInfo_Return"));
