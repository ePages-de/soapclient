...
public class ProductTypeServiceLocator extends org.apache.axis.client.Service implements de.epages.WebServices.ProductTypeService.Stub.ProductTypeService {
 ...
 */
    ...
    public de.epages.WebServices.ProductTypeService.Stub.Port_ProductType_PortType getport_ProductType(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            de.epages.WebServices.ProductTypeService.Stub.Bind_ProductType_SOAPStub _stub = new de.epages.WebServices.ProductTypeService.Stub.Bind_ProductType_SOAPStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (de.epages.WebServices.ProductTypeService.Stub.Port_ProductType_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                de.epages.WebServices.ProductTypeService.Stub.Bind_ProductType_SOAPStub _stub = new de.epages.WebServices.ProductTypeService.Stub.Bind_ProductType_SOAPStub(new java.net.URL(port_ProductType_address), this);
                _stub.setPortName(getport_ProductTypeWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("urn://epages.de/WebService/ProductTypeService/2007/10", "ProductTypeService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("urn://epages.de/WebService/ProductTypeService/2007/10", "port_ProductType"));
        }
