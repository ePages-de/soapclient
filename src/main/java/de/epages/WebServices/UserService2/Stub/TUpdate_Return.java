...
public class TUpdate_Return  implements java.io.Serializable {
    ...
    private de.epages.WebServices.UserService2.Stub.TError error;
    ...
    public TUpdate_Return(
           ...
           de.epages.WebServices.UserService2.Stub.TError error) {
           this.path = path;
     ...
     */
    public de.epages.WebServices.UserService2.Stub.TError getError() {
        return error;
    }
     ...
     */
    public void setError(de.epages.WebServices.UserService2.Stub.TError error) {
        this.error = error;
    }
