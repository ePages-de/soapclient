...
public class TSetValueDiscounts_Input  implements java.io.Serializable {
    ...
    private de.epages.WebServices.PriceListAssignmentService.Stub.TValueDiscount[] valueDiscounts;
    ...
    public TSetValueDiscounts_Input(
           ...
           de.epages.WebServices.PriceListAssignmentService.Stub.TValueDiscount[] valueDiscounts) {
     ...
     */
    public de.epages.WebServices.PriceListAssignmentService.Stub.TValueDiscount[] getValueDiscounts() {
     ...
     */
    public void setValueDiscounts(de.epages.WebServices.PriceListAssignmentService.Stub.TValueDiscount[] valueDiscounts) {
        this.valueDiscounts = valueDiscounts;
    }
