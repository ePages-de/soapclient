...
public class TUpdatePreDefAttribute_Input  implements java.io.Serializable {
    ...
    /* the predefined attribute value in case it's product attribute
     * is localizable */
    private de.epages.WebServices.ProductTypeService2.Stub.TLocalizedValue[] valueLocString;
    ...
    public TUpdatePreDefAttribute_Input(
           ...
           de.epages.WebServices.ProductTypeService2.Stub.TLocalizedValue[] valueLocString) {
           this.alias = alias;
     ...
     * is localizable
     */
    public de.epages.WebServices.ProductTypeService2.Stub.TLocalizedValue[] getValueLocString() {
     ...
     * is localizable
     */
    public void setValueLocString(de.epages.WebServices.ProductTypeService2.Stub.TLocalizedValue[] valueLocString) {
        this.valueLocString = valueLocString;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/ProductTypeTypes2/2007/11", "TUpdatePreDefAttribute_Input"));
