...
public class OrderDocumentServiceLocator extends org.apache.axis.client.Service implements de.epages.webservice.orderdocument5.stub.OrderDocumentService {
 ...
 */
    ...
    public de.epages.webservice.orderdocument5.stub.Port_OrderDocument getport_OrderDocument() throws javax.xml.rpc.ServiceException {
    ...
    public de.epages.webservice.orderdocument5.stub.Port_OrderDocument getport_OrderDocument(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            de.epages.webservice.orderdocument5.stub.Bind_OrderDocument_SOAPStub _stub = new de.epages.webservice.orderdocument5.stub.Bind_OrderDocument_SOAPStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (de.epages.webservice.orderdocument5.stub.Port_OrderDocument.class.isAssignableFrom(serviceEndpointInterface)) {
                de.epages.webservice.orderdocument5.stub.Bind_OrderDocument_SOAPStub _stub = new de.epages.webservice.orderdocument5.stub.Bind_OrderDocument_SOAPStub(new java.net.URL(port_OrderDocument_address), this);
                _stub.setPortName(getport_OrderDocumentWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("urn://epages.de/WebService/OrderDocumentService/2009/01", "OrderDocumentService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("urn://epages.de/WebService/OrderDocumentService/2009/01", "port_OrderDocument"));
        }
