...
public class TLineItemContainerOut  implements java.io.Serializable {
    ...
    private de.epages.webservice.orderdocument5.model.TProductLineItemOut[] productLineItems;

    /* the container's tax line items */
    private de.epages.webservice.orderdocument5.model.TTaxLineItem[] taxLineItems;

    /* the container's payment line item */
    private de.epages.webservice.orderdocument5.model.TPaymentLineItem paymentLineItem;

    /* the container's shipping line item */
    private de.epages.webservice.orderdocument5.model.TShippingLineItem shippingLineItem;

    /* the container's coupon line items */
    private de.epages.webservice.orderdocument5.model.TCouponLineItem[] couponLineItems;

    /* the container's shipping option line items */
    private de.epages.webservice.orderdocument5.model.TShippingOptionLineItem[] shippingOptionLineItems;

    /* the container's basket discount line items */
    private de.epages.webservice.orderdocument5.model.TGlobalValueDiscountLineItem[] globalValueDiscountLineItems;
    ...
    public TLineItemContainerOut(
           ...
           float totalTax,
           de.epages.webservice.orderdocument5.model.TProductLineItemOut[] productLineItems,
           de.epages.webservice.orderdocument5.model.TTaxLineItem[] taxLineItems,
           de.epages.webservice.orderdocument5.model.TPaymentLineItem paymentLineItem,
           de.epages.webservice.orderdocument5.model.TShippingLineItem shippingLineItem,
           de.epages.webservice.orderdocument5.model.TCouponLineItem[] couponLineItems,
           de.epages.webservice.orderdocument5.model.TShippingOptionLineItem[] shippingOptionLineItems,
           de.epages.webservice.orderdocument5.model.TGlobalValueDiscountLineItem[] globalValueDiscountLineItems) {
     ...
     */
    public de.epages.webservice.orderdocument5.model.TProductLineItemOut[] getProductLineItems() {
     ...
     */
    public void setProductLineItems(de.epages.webservice.orderdocument5.model.TProductLineItemOut[] productLineItems) {
        this.productLineItems = productLineItems;
    }
     ...
     */
    public de.epages.webservice.orderdocument5.model.TTaxLineItem[] getTaxLineItems() {
        return taxLineItems;
    }
     ...
     */
    public void setTaxLineItems(de.epages.webservice.orderdocument5.model.TTaxLineItem[] taxLineItems) {
        this.taxLineItems = taxLineItems;
    }
     ...
     */
    public de.epages.webservice.orderdocument5.model.TPaymentLineItem getPaymentLineItem() {
     ...
     */
    public void setPaymentLineItem(de.epages.webservice.orderdocument5.model.TPaymentLineItem paymentLineItem) {
        this.paymentLineItem = paymentLineItem;
    }
     ...
     */
    public de.epages.webservice.orderdocument5.model.TShippingLineItem getShippingLineItem() {
     ...
     */
    public void setShippingLineItem(de.epages.webservice.orderdocument5.model.TShippingLineItem shippingLineItem) {
        this.shippingLineItem = shippingLineItem;
    }
     ...
     */
    public de.epages.webservice.orderdocument5.model.TCouponLineItem[] getCouponLineItems() {
     ...
     */
    public void setCouponLineItems(de.epages.webservice.orderdocument5.model.TCouponLineItem[] couponLineItems) {
        this.couponLineItems = couponLineItems;
    }
     ...
     */
    public de.epages.webservice.orderdocument5.model.TShippingOptionLineItem[] getShippingOptionLineItems() {
     ...
     */
    public void setShippingOptionLineItems(de.epages.webservice.orderdocument5.model.TShippingOptionLineItem[] shippingOptionLineItems) {
        this.shippingOptionLineItems = shippingOptionLineItems;
    }
     ...
     */
    public de.epages.webservice.orderdocument5.model.TGlobalValueDiscountLineItem[] getGlobalValueDiscountLineItems() {
     ...
     */
    public void setGlobalValueDiscountLineItems(de.epages.webservice.orderdocument5.model.TGlobalValueDiscountLineItem[] globalValueDiscountLineItems) {
        this.globalValueDiscountLineItems = globalValueDiscountLineItems;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/OrderDocumentTypes/2009/01", "TLineItemContainerOut"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/OrderDocumentTypes/2009/01", "TProductLineItemOut"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("taxLineItems");
        elemField.setXmlName(new javax.xml.namespace.QName("", "TaxLineItems"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/OrderDocumentTypes/2009/01", "TTaxLineItem"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("paymentLineItem");
        elemField.setXmlName(new javax.xml.namespace.QName("", "PaymentLineItem"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/OrderDocumentTypes/2009/01", "TPaymentLineItem"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/OrderDocumentTypes/2009/01", "TShippingLineItem"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/OrderDocumentTypes/2009/01", "TCouponLineItem"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/OrderDocumentTypes/2009/01", "TShippingOptionLineItem"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/OrderDocumentTypes/2009/01", "TGlobalValueDiscountLineItem"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
