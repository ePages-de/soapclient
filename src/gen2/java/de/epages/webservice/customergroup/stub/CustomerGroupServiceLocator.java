...
public class CustomerGroupServiceLocator extends org.apache.axis.client.Service implements de.epages.webservice.customergroup.stub.CustomerGroupService {
 ...
 */
    ...
    public de.epages.webservice.customergroup.stub.Port_CustomerGroup getport_CustomerGroup(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            de.epages.webservice.customergroup.stub.Bind_CustomerGroup_SOAPStub _stub = new de.epages.webservice.customergroup.stub.Bind_CustomerGroup_SOAPStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (de.epages.webservice.customergroup.stub.Port_CustomerGroup.class.isAssignableFrom(serviceEndpointInterface)) {
                de.epages.webservice.customergroup.stub.Bind_CustomerGroup_SOAPStub _stub = new de.epages.webservice.customergroup.stub.Bind_CustomerGroup_SOAPStub(new java.net.URL(port_CustomerGroup_address), this);
                _stub.setPortName(getport_CustomerGroupWSDDServiceName());
                return _stub;
            }
        }
