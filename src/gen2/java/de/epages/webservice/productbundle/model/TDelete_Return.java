...
public class TDelete_Return  implements java.io.Serializable {
    ...
    /* is product has deleted bundled products */
     ...
     * 
     * @return deleted   * is product has deleted bundled products
     */
     ...
     * 
     * @param deleted   * is product has deleted bundled products
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/ProductBundleTypes/2007/07", "TDelete_Return"));
