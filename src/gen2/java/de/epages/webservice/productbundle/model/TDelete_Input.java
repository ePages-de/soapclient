...
public class TDelete_Input  implements java.io.Serializable {
    ...
    private de.epages.webservice.productbundle.model.TBundledProductPath[] bundledProductPaths;
    ...
    public TDelete_Input(
           ...
           de.epages.webservice.productbundle.model.TBundledProductPath[] bundledProductPaths) {
     ...
     *             see tns:ListOfBundledProductPaths
     */
    public de.epages.webservice.productbundle.model.TBundledProductPath[] getBundledProductPaths() {
     ...
     *             see tns:ListOfBundledProductPaths
     */
    public void setBundledProductPaths(de.epages.webservice.productbundle.model.TBundledProductPath[] bundledProductPaths) {
        this.bundledProductPaths = bundledProductPaths;
    }
