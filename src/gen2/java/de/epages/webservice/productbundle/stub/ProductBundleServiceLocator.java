...
public class ProductBundleServiceLocator extends org.apache.axis.client.Service implements de.epages.webservice.productbundle.stub.ProductBundleService {
 ...
 */
    ...
    public de.epages.webservice.productbundle.stub.Port_ProductBundle getport_ProductBundle() throws javax.xml.rpc.ServiceException {
    ...
    public de.epages.webservice.productbundle.stub.Port_ProductBundle getport_ProductBundle(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            de.epages.webservice.productbundle.stub.Bind_ProductBundle_SOAPStub _stub = new de.epages.webservice.productbundle.stub.Bind_ProductBundle_SOAPStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (de.epages.webservice.productbundle.stub.Port_ProductBundle.class.isAssignableFrom(serviceEndpointInterface)) {
                de.epages.webservice.productbundle.stub.Bind_ProductBundle_SOAPStub _stub = new de.epages.webservice.productbundle.stub.Bind_ProductBundle_SOAPStub(new java.net.URL(port_ProductBundle_address), this);
                _stub.setPortName(getport_ProductBundleWSDDServiceName());
                return _stub;
            }
        }
