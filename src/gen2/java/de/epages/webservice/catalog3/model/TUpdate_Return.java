...
package de.epages.webservice.catalog3.model;
...
public class TUpdate_Return  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/CatalogTypes/2008/11", "TUpdate_Return"));
