...
public class TGetInfo_Return  implements java.io.Serializable {
    ...
    private de.epages.webservice.shop3.model.TAddressNamed address;

    private de.epages.webservice.shop3.model.TAddressNamed shopAddress;

    /* the products, payments, shipping etc. of this order document
     * (see orderdocumenttypes:TLineItemContainerOut) */
    private de.epages.webservice.orderdocument6.model.TLineItemContainerOut lineItemContainer;
    ...
    public TGetInfo_Return(
           ...
           de.epages.webservice.shop3.model.TAddressNamed address,
           de.epages.webservice.shop3.model.TAddressNamed shopAddress,
           de.epages.webservice.orderdocument6.model.TLineItemContainerOut lineItemContainer,
     ...
     * @return address
     */
    public de.epages.webservice.shop3.model.TAddressNamed getAddress() {
        return address;
    }
     ...
     * @param address
     */
    public void setAddress(de.epages.webservice.shop3.model.TAddressNamed address) {
        this.address = address;
    }
     ...
     * @return shopAddress
     */
    public de.epages.webservice.shop3.model.TAddressNamed getShopAddress() {
        return shopAddress;
    }
     ...
     * @param shopAddress
     */
    public void setShopAddress(de.epages.webservice.shop3.model.TAddressNamed shopAddress) {
        this.shopAddress = shopAddress;
    }
     ...
     * (see orderdocumenttypes:TLineItemContainerOut)
     */
    public de.epages.webservice.orderdocument6.model.TLineItemContainerOut getLineItemContainer() {
     ...
     * (see orderdocumenttypes:TLineItemContainerOut)
     */
    public void setLineItemContainer(de.epages.webservice.orderdocument6.model.TLineItemContainerOut lineItemContainer) {
        this.lineItemContainer = lineItemContainer;
    }
