...
public class ShippingMethodServiceLocator extends org.apache.axis.client.Service implements de.epages.webservice.shippingmethod.stub.ShippingMethodService {
 ...
 */
    ...
    public de.epages.webservice.shippingmethod.stub.Port_ShippingMethod getport_ShippingMethod() throws javax.xml.rpc.ServiceException {
    ...
    public de.epages.webservice.shippingmethod.stub.Port_ShippingMethod getport_ShippingMethod(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            de.epages.webservice.shippingmethod.stub.Bind_ShippingMethod_SOAPStub _stub = new de.epages.webservice.shippingmethod.stub.Bind_ShippingMethod_SOAPStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (de.epages.webservice.shippingmethod.stub.Port_ShippingMethod.class.isAssignableFrom(serviceEndpointInterface)) {
                de.epages.webservice.shippingmethod.stub.Bind_ShippingMethod_SOAPStub _stub = new de.epages.webservice.shippingmethod.stub.Bind_ShippingMethod_SOAPStub(new java.net.URL(port_ShippingMethod_address), this);
                _stub.setPortName(getport_ShippingMethodWSDDServiceName());
                return _stub;
            }
        }
