...
public class UserServiceLocator extends org.apache.axis.client.Service implements de.epages.webservice.user5.stub.UserService {
 ...
 */
    ...
    public de.epages.webservice.user5.stub.Port_User getport_User() throws javax.xml.rpc.ServiceException {
    ...
    public de.epages.webservice.user5.stub.Port_User getport_User(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            de.epages.webservice.user5.stub.Bind_User_SOAPStub _stub = new de.epages.webservice.user5.stub.Bind_User_SOAPStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (de.epages.webservice.user5.stub.Port_User.class.isAssignableFrom(serviceEndpointInterface)) {
                de.epages.webservice.user5.stub.Bind_User_SOAPStub _stub = new de.epages.webservice.user5.stub.Bind_User_SOAPStub(new java.net.URL(port_User_address), this);
                _stub.setPortName(getport_UserWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("urn://epages.de/WebService/UserService/2011/03", "UserService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("urn://epages.de/WebService/UserService/2011/03", "port_User"));
        }
