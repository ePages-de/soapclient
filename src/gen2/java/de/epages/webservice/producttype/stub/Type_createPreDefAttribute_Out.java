...
public class Type_createPreDefAttribute_Out  implements java.io.Serializable {
    ...
    private de.epages.webservice.producttype.model.TCreatePreDefAttribute_Return[] preDefAttributes;
    ...
    public Type_createPreDefAttribute_Out(
           de.epages.webservice.producttype.model.TCreatePreDefAttribute_Return[] preDefAttributes,
     ...
     */
    public de.epages.webservice.producttype.model.TCreatePreDefAttribute_Return[] getPreDefAttributes() {
     ...
     */
    public void setPreDefAttributes(de.epages.webservice.producttype.model.TCreatePreDefAttribute_Return[] preDefAttributes) {
        this.preDefAttributes = preDefAttributes;
    }
