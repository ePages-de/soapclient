...
public class Type_getProductAttributeInfo_Out  implements java.io.Serializable {
    ...
    private de.epages.webservice.producttype.model.TGetProductAttributeInfo_Return[] productAttributes;
    ...
    public Type_getProductAttributeInfo_Out(
           de.epages.webservice.producttype.model.TGetProductAttributeInfo_Return[] productAttributes,
     ...
     */
    public de.epages.webservice.producttype.model.TGetProductAttributeInfo_Return[] getProductAttributes() {
     ...
     */
    public void setProductAttributes(de.epages.webservice.producttype.model.TGetProductAttributeInfo_Return[] productAttributes) {
        this.productAttributes = productAttributes;
    }
