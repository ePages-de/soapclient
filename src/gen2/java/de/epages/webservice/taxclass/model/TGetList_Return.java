...
package de.epages.webservice.taxclass.model;
...
public class TGetList_Return  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/TaxClassTypes/2006/07", "TGetList_Return"));
