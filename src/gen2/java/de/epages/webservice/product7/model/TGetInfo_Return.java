...
package de.epages.webservice.product7.model;
...
public class TGetInfo_Return  implements java.io.Serializable {
    ...
    private de.epages.webservice.product7.model.TDownload[] downloadProductMaps;
    ...
    private de.epages.webservice.product7.model.TProductPrice[] productPrices;

    /* list of manufacturer prices (see producttypes:ListOfListOfProductPrices) */
    private de.epages.webservice.product7.model.TProductPrice[] manufacturerPrices;

    /* list of deposit prices (see producttypes:ListOfListOfProductPrices) */
    private de.epages.webservice.product7.model.TProductPrice[] depositPrices;

    /* list of eco participation  prices (see producttypes:ListOfListOfProductPrices) */
    private de.epages.webservice.product7.model.TProductPrice[] ecoParticipationPrices;

    /* list of prepayment prices (see producttypes:ListOfListOfProductPrices) */
    private de.epages.webservice.product7.model.TProductPrice[] prepaymentPrices;
    ...
    public TGetInfo_Return(
           ...
           de.epages.webservice.product7.model.TDownload[] downloadProductMaps,
           ...
           de.epages.webservice.product7.model.TProductPrice[] productPrices,
           de.epages.webservice.product7.model.TProductPrice[] manufacturerPrices,
           de.epages.webservice.product7.model.TProductPrice[] depositPrices,
           de.epages.webservice.product7.model.TProductPrice[] ecoParticipationPrices,
     ...
     */
    public de.epages.webservice.product7.model.TDownload[] getDownloadProductMaps() {
     ...
     */
    public void setDownloadProductMaps(de.epages.webservice.product7.model.TDownload[] downloadProductMaps) {
        this.downloadProductMaps = downloadProductMaps;
    }
     ...
     */
    public de.epages.webservice.product7.model.TProductPrice[] getProductPrices() {
     ...
     */
    public void setProductPrices(de.epages.webservice.product7.model.TProductPrice[] productPrices) {
        this.productPrices = productPrices;
    }
     ...
     */
    public de.epages.webservice.product7.model.TProductPrice[] getManufacturerPrices() {
     ...
     */
    public void setManufacturerPrices(de.epages.webservice.product7.model.TProductPrice[] manufacturerPrices) {
        this.manufacturerPrices = manufacturerPrices;
    }
     ...
     */
    public de.epages.webservice.product7.model.TProductPrice[] getDepositPrices() {
     ...
     */
    public void setDepositPrices(de.epages.webservice.product7.model.TProductPrice[] depositPrices) {
        this.depositPrices = depositPrices;
    }
     ...
     */
    public de.epages.webservice.product7.model.TProductPrice[] getEcoParticipationPrices() {
     ...
     */
    public void setEcoParticipationPrices(de.epages.webservice.product7.model.TProductPrice[] ecoParticipationPrices) {
        this.ecoParticipationPrices = ecoParticipationPrices;
    }
     ...
     */
    public de.epages.webservice.product7.model.TProductPrice[] getPrepaymentPrices() {
     ...
     */
    public void setPrepaymentPrices(de.epages.webservice.product7.model.TProductPrice[] prepaymentPrices) {
        this.prepaymentPrices = prepaymentPrices;
    }
