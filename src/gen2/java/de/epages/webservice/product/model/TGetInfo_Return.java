...
package de.epages.webservice.product.model;
...
public class TGetInfo_Return  implements java.io.Serializable {
    ...
    private de.epages.webservice.product.model.TProductPrice[] productPrices;
    ...
    public TGetInfo_Return(
           ...
           de.epages.webservice.product.model.TProductPrice[] productPrices,
     ...
     */
    public de.epages.webservice.product.model.TProductPrice[] getProductPrices() {
     ...
     */
    public void setProductPrices(de.epages.webservice.product.model.TProductPrice[] productPrices) {
        this.productPrices = productPrices;
    }
