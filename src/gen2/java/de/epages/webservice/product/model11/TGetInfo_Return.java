...
package de.epages.webservice.product.model11;
...
public class TGetInfo_Return  implements java.io.Serializable {
    ...
    /* product's name */
    private de.epages.webservice.common.model2.TLocalizedValue[] name;

    /* product's description */
    private de.epages.webservice.common.model2.TLocalizedValue[] description;

    /* product's long description (formerly LongDescription) */
    private de.epages.webservice.common.model2.TLocalizedValue[] text;

    /* product's key words */
    private de.epages.webservice.common.model2.TLocalizedValue[] keywords;

    /* product's main characteristics in last step of checkout process,
     * in addition to description and text */
    private de.epages.webservice.common.model2.TLocalizedValue[] mainCharacteristics;

    /* Localizable page title shown in SF. */
    private de.epages.webservice.common.model2.TLocalizedValue[] title;
    ...
    private de.epages.webservice.common.model2.TLocalizedValue[] availabilityComment;
    ...
    private de.epages.webservice.common.model2.TLocalizedValue[] URI;

    /* complete url for canonical tag (based on domain name and URI,
     * i.e. http://my.do.main/myURI) */
    private de.epages.webservice.common.model2.TLocalizedValue[] canonicalURL;
    ...
    private de.epages.webservice.product.model11.TDownload[] downloadProductMaps;
    ...
    private de.epages.webservice.common.model2.TAttribute[] variationAttributes;

    /* list of product prices (see producttypes:ListOfListOfProductPrices) */
    private de.epages.webservice.product.model11.TProductPrice[] productPrices;

    /* list of manufacturer prices (see producttypes:ListOfListOfProductPrices) */
    private de.epages.webservice.product.model11.TProductPrice[] manufacturerPrices;

    /* list of deposit prices (see producttypes:ListOfListOfProductPrices) */
    private de.epages.webservice.product.model11.TProductPrice[] depositPrices;

    /* list of eco participation  prices (see producttypes:ListOfListOfProductPrices) */
    private de.epages.webservice.product.model11.TProductPrice[] ecoParticipationPrices;

    /* list of prepayment prices (see producttypes:ListOfListOfProductPrices) */
    private de.epages.webservice.product.model11.TProductPrice[] prepaymentPrices;
    ...
    private de.epages.webservice.product.model11.TShippingMethod[] shippingMethods;

    /* list of requested attributes (see epagestypes:ListOfAttributes) */
    private de.epages.webservice.common.model2.TAttribute[] attributes;

    /* error object (see epagestypes:TError) */
    private de.epages.webservice.common.model2.TError error;
    ...
    public TGetInfo_Return(
           ...
           de.epages.webservice.common.model2.TLocalizedValue[] name,
           de.epages.webservice.common.model2.TLocalizedValue[] description,
           de.epages.webservice.common.model2.TLocalizedValue[] text,
           de.epages.webservice.common.model2.TLocalizedValue[] keywords,
           de.epages.webservice.common.model2.TLocalizedValue[] mainCharacteristics,
           de.epages.webservice.common.model2.TLocalizedValue[] title,
           ...
           boolean isAvailable,
           de.epages.webservice.common.model2.TLocalizedValue[] availabilityComment,
           java.util.Calendar availabilityDate,
           de.epages.webservice.common.model2.TLocalizedValue[] URI,
           de.epages.webservice.common.model2.TLocalizedValue[] canonicalURL,
           boolean isDownloadProduct,
           java.math.BigInteger maxDownloadTime,
           java.math.BigInteger maxDownloadCount,
           de.epages.webservice.product.model11.TDownload[] downloadProductMaps,
           ...
           de.epages.webservice.common.model2.TAttribute[] variationAttributes,
           de.epages.webservice.product.model11.TProductPrice[] productPrices,
           de.epages.webservice.product.model11.TProductPrice[] manufacturerPrices,
           de.epages.webservice.product.model11.TProductPrice[] depositPrices,
           de.epages.webservice.product.model11.TProductPrice[] ecoParticipationPrices,
           de.epages.webservice.product.model11.TProductPrice[] prepaymentPrices,
           java.lang.String prepaymentType,
           java.lang.Float prepaymentValue,
           de.epages.webservice.product.model11.TShippingMethod[] shippingMethods,
           de.epages.webservice.common.model2.TAttribute[] attributes,
           de.epages.webservice.common.model2.TError error) {
           this.path = path;
           this.alias = alias;
           this._class = _class;
           this.name = name;
     ...
     */
    public de.epages.webservice.common.model2.TLocalizedValue[] getName() {
        return name;
    }
     ...
     */
    public void setName(de.epages.webservice.common.model2.TLocalizedValue[] name) {
        this.name = name;
    }
     ...
     */
    public de.epages.webservice.common.model2.TLocalizedValue[] getDescription() {
        return description;
    }
     ...
     */
    public void setDescription(de.epages.webservice.common.model2.TLocalizedValue[] description) {
        this.description = description;
    }
     ...
     */
    public de.epages.webservice.common.model2.TLocalizedValue[] getText() {
        return text;
    }
     ...
     */
    public void setText(de.epages.webservice.common.model2.TLocalizedValue[] text) {
        this.text = text;
    }
     ...
     */
    public de.epages.webservice.common.model2.TLocalizedValue[] getKeywords() {
        return keywords;
    }
     ...
     */
    public void setKeywords(de.epages.webservice.common.model2.TLocalizedValue[] keywords) {
        this.keywords = keywords;
    }
     ...
     * in addition to description and text
     */
    public de.epages.webservice.common.model2.TLocalizedValue[] getMainCharacteristics() {
     ...
     * in addition to description and text
     */
    public void setMainCharacteristics(de.epages.webservice.common.model2.TLocalizedValue[] mainCharacteristics) {
        this.mainCharacteristics = mainCharacteristics;
    }
     ...
     */
    public de.epages.webservice.common.model2.TLocalizedValue[] getTitle() {
        return title;
    }
     ...
     */
    public void setTitle(de.epages.webservice.common.model2.TLocalizedValue[] title) {
        this.title = title;
    }
     ...
     */
    public de.epages.webservice.common.model2.TLocalizedValue[] getAvailabilityComment() {
     ...
     */
    public void setAvailabilityComment(de.epages.webservice.common.model2.TLocalizedValue[] availabilityComment) {
        this.availabilityComment = availabilityComment;
    }
     ...
     */
    public de.epages.webservice.common.model2.TLocalizedValue[] getURI() {
        return URI;
    }
     ...
     */
    public void setURI(de.epages.webservice.common.model2.TLocalizedValue[] URI) {
        this.URI = URI;
    }
     ...
     * i.e. http://my.do.main/myURI)
     */
    public de.epages.webservice.common.model2.TLocalizedValue[] getCanonicalURL() {
        return canonicalURL;
    }
     ...
     * i.e. http://my.do.main/myURI)
     */
    public void setCanonicalURL(de.epages.webservice.common.model2.TLocalizedValue[] canonicalURL) {
        this.canonicalURL = canonicalURL;
    }
     ...
     */
    public de.epages.webservice.product.model11.TDownload[] getDownloadProductMaps() {
     ...
     */
    public void setDownloadProductMaps(de.epages.webservice.product.model11.TDownload[] downloadProductMaps) {
        this.downloadProductMaps = downloadProductMaps;
    }
     ...
     *             (see epagestypes:ListOfAttributes)
     */
    public de.epages.webservice.common.model2.TAttribute[] getVariationAttributes() {
     ...
     *             (see epagestypes:ListOfAttributes)
     */
    public void setVariationAttributes(de.epages.webservice.common.model2.TAttribute[] variationAttributes) {
        this.variationAttributes = variationAttributes;
    }
     ...
     */
    public de.epages.webservice.product.model11.TProductPrice[] getProductPrices() {
     ...
     */
    public void setProductPrices(de.epages.webservice.product.model11.TProductPrice[] productPrices) {
        this.productPrices = productPrices;
    }
     ...
     */
    public de.epages.webservice.product.model11.TProductPrice[] getManufacturerPrices() {
     ...
     */
    public void setManufacturerPrices(de.epages.webservice.product.model11.TProductPrice[] manufacturerPrices) {
        this.manufacturerPrices = manufacturerPrices;
    }
     ...
     */
    public de.epages.webservice.product.model11.TProductPrice[] getDepositPrices() {
     ...
     */
    public void setDepositPrices(de.epages.webservice.product.model11.TProductPrice[] depositPrices) {
        this.depositPrices = depositPrices;
    }
     ...
     */
    public de.epages.webservice.product.model11.TProductPrice[] getEcoParticipationPrices() {
     ...
     */
    public void setEcoParticipationPrices(de.epages.webservice.product.model11.TProductPrice[] ecoParticipationPrices) {
        this.ecoParticipationPrices = ecoParticipationPrices;
    }
     ...
     */
    public de.epages.webservice.product.model11.TProductPrice[] getPrepaymentPrices() {
     ...
     */
    public void setPrepaymentPrices(de.epages.webservice.product.model11.TProductPrice[] prepaymentPrices) {
        this.prepaymentPrices = prepaymentPrices;
    }
     ...
     */
    public de.epages.webservice.product.model11.TShippingMethod[] getShippingMethods() {
     ...
     */
    public void setShippingMethods(de.epages.webservice.product.model11.TShippingMethod[] shippingMethods) {
        this.shippingMethods = shippingMethods;
    }
     ...
     */
    public de.epages.webservice.common.model2.TAttribute[] getAttributes() {
        return attributes;
    }
     ...
     */
    public void setAttributes(de.epages.webservice.common.model2.TAttribute[] attributes) {
        this.attributes = attributes;
    }
     ...
     */
    public de.epages.webservice.common.model2.TError getError() {
        return error;
    }
     ...
     */
    public void setError(de.epages.webservice.common.model2.TError error) {
        this.error = error;
    }
