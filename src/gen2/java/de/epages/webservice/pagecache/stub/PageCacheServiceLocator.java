...
package de.epages.webservice.pagecache.stub;

public class PageCacheServiceLocator extends org.apache.axis.client.Service implements de.epages.webservice.pagecache.stub.PageCacheService {
 ...
 */
    ...
    public de.epages.webservice.pagecache.stub.Port_PageCache getport_PageCache() throws javax.xml.rpc.ServiceException {
    ...
    public de.epages.webservice.pagecache.stub.Port_PageCache getport_PageCache(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            de.epages.webservice.pagecache.stub.Bind_PageCache_SOAPStub _stub = new de.epages.webservice.pagecache.stub.Bind_PageCache_SOAPStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (de.epages.webservice.pagecache.stub.Port_PageCache.class.isAssignableFrom(serviceEndpointInterface)) {
                de.epages.webservice.pagecache.stub.Bind_PageCache_SOAPStub _stub = new de.epages.webservice.pagecache.stub.Bind_PageCache_SOAPStub(new java.net.URL(port_PageCache_address), this);
                _stub.setPortName(getport_PageCacheWSDDServiceName());
                return _stub;
            }
        }
