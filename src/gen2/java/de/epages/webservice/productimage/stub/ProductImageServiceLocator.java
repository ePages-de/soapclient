...
public class ProductImageServiceLocator extends org.apache.axis.client.Service implements de.epages.webservice.productimage.stub.ProductImageService {
 ...
 */
    ...
    public de.epages.webservice.productimage.stub.Port_ProductImage getport_ProductImage() throws javax.xml.rpc.ServiceException {
    ...
    public de.epages.webservice.productimage.stub.Port_ProductImage getport_ProductImage(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            de.epages.webservice.productimage.stub.Bind_ProductImage_SOAPStub _stub = new de.epages.webservice.productimage.stub.Bind_ProductImage_SOAPStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (de.epages.webservice.productimage.stub.Port_ProductImage.class.isAssignableFrom(serviceEndpointInterface)) {
                de.epages.webservice.productimage.stub.Bind_ProductImage_SOAPStub _stub = new de.epages.webservice.productimage.stub.Bind_ProductImage_SOAPStub(new java.net.URL(port_ProductImage_address), this);
                _stub.setPortName(getport_ProductImageWSDDServiceName());
                return _stub;
            }
        }
