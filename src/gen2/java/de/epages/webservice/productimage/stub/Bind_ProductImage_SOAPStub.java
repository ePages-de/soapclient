...
package de.epages.webservice.productimage.stub;

public class Bind_ProductImage_SOAPStub extends org.apache.axis.client.Stub implements de.epages.webservice.productimage.stub.Port_ProductImage {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setReturnClass(de.epages.webservice.productimage.model.TDelete_Return[].class);
        oper.setReturnQName(new javax.xml.namespace.QName("", "Files"));
        oper.setStyle(org.apache.axis.constants.Style.RPC);
        oper.setUse(org.apache.axis.constants.Use.ENCODED);
        _operations[3] = oper;
    ...
    public Bind_ProductImage_SOAPStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            cachedSerQNames.add(qName);
            cls = de.epages.webservice.productimage.model.TImageData[].class;
            cachedSerClasses.add(cls);
            ...
            cachedSerQNames.add(qName);
            cls = de.epages.webservice.productimage.model.TDelete_Return.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = de.epages.webservice.productimage.model.TScaleParams.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = de.epages.webservice.productimage.model.TUpload_Input.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = de.epages.webservice.productimage.model.TUpload_Return.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = de.epages.webservice.productimage.model.TUploadScale_Input.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = de.epages.webservice.productimage.model.TUploadScale_Return.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
    ...
    public de.epages.webservice.productimage.model.TUpload_Return[] upload(java.lang.String TObjectPath, de.epages.webservice.productimage.model.TUpload_Input imageData) throws java.rmi.RemoteException {
        if (super.cachedEndpoint == null) {
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {TObjectPath, imageData});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                return (de.epages.webservice.productimage.model.TUpload_Return[]) _resp;
            } catch (java.lang.Exception _exception) {
                return (de.epages.webservice.productimage.model.TUpload_Return[]) org.apache.axis.utils.JavaUtils.convert(_resp, de.epages.webservice.productimage.model.TUpload_Return[].class);
            }
        }
  ...
  throw axisFaultException;
    ...
    public de.epages.webservice.productimage.model.TUploadScale_Return[] uploadscale(java.lang.String TObjectPath, de.epages.webservice.productimage.model.TUploadScale_Input imageData, de.epages.webservice.productimage.model.TScaleParams scaleParams) throws java.rmi.RemoteException {
        if (super.cachedEndpoint == null) {
            throw new org.apache.axis.NoEndPointException();
        }
        org.apache.axis.client.Call _call = createCall();
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {TObjectPath, imageData, scaleParams});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            extractAttachments(_call);
            try {
                return (de.epages.webservice.productimage.model.TUploadScale_Return[]) _resp;
            } catch (java.lang.Exception _exception) {
                return (de.epages.webservice.productimage.model.TUploadScale_Return[]) org.apache.axis.utils.JavaUtils.convert(_resp, de.epages.webservice.productimage.model.TUploadScale_Return[].class);
            }
        }
  } catch (org.apache.axis.AxisFault axisFaultException) {
  throw axisFaultException;
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {TObjectPath, TFileName});
  ...
  throw axisFaultException;
    ...
    public de.epages.webservice.productimage.model.TDelete_Return[] delete(java.lang.String TObjectPath, java.lang.String[] TListOfFileNames) throws java.rmi.RemoteException {
        if (super.cachedEndpoint == null) {
            throw new org.apache.axis.NoEndPointException();
        }
        org.apache.axis.client.Call _call = createCall();
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {TObjectPath, TListOfFileNames});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            extractAttachments(_call);
            try {
                return (de.epages.webservice.productimage.model.TDelete_Return[]) _resp;
            } catch (java.lang.Exception _exception) {
                return (de.epages.webservice.productimage.model.TDelete_Return[]) org.apache.axis.utils.JavaUtils.convert(_resp, de.epages.webservice.productimage.model.TDelete_Return[].class);
            }
        }
  } catch (org.apache.axis.AxisFault axisFaultException) {
  throw axisFaultException;
