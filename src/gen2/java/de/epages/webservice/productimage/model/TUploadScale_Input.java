 ...
 */
public class TUploadScale_Input  implements java.io.Serializable {
    /* list of filecontents and names */
    private de.epages.webservice.productimage.model.TImageData[] imageData;

    /* the filenames for the slideshow, separated with ";" */
    private java.lang.String imagesSlideShowString;

    public TUploadScale_Input() {
    }

    public TUploadScale_Input(
           de.epages.webservice.productimage.model.TImageData[] imageData,
    ...
    /**
     * Gets the imageData value for this TUploadScale_Input.
     * 
     * @return imageData   * list of filecontents and names
     */
    public de.epages.webservice.productimage.model.TImageData[] getImageData() {
        return imageData;
    }


    /**
     * Sets the imageData value for this TUploadScale_Input.
     * 
     * @param imageData   * list of filecontents and names
     */
    public void setImageData(de.epages.webservice.productimage.model.TImageData[] imageData) {
        this.imageData = imageData;
    }


    /**
     * Gets the imagesSlideShowString value for this TUploadScale_Input.
     * 
    ...
    /**
     * Sets the imagesSlideShowString value for this TUploadScale_Input.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof TUploadScale_Input)) return false;
        TUploadScale_Input other = (TUploadScale_Input) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(TUploadScale_Input.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/ProductImageTypes/2006/03", "TUploadScale_Input"));
