...
public class TGetInfoList_Return  implements java.io.Serializable {
    ...
    private de.epages.webservice.common.model.TLocalizedValue[] productTypeName;

    private de.epages.webservice.productattribute2.model.TPreDefAttribute[] preDefAttributes;
    ...
    public TGetInfoList_Return(
           ...
           de.epages.webservice.common.model.TLocalizedValue[] productTypeName,
           de.epages.webservice.productattribute2.model.TPreDefAttribute[] preDefAttributes,
     ...
     */
    public de.epages.webservice.common.model.TLocalizedValue[] getProductTypeName() {
        return productTypeName;
    }
     ...
     */
    public void setProductTypeName(de.epages.webservice.common.model.TLocalizedValue[] productTypeName) {
        this.productTypeName = productTypeName;
    }
     ...
     */
    public de.epages.webservice.productattribute2.model.TPreDefAttribute[] getPreDefAttributes() {
        return preDefAttributes;
    }
     ...
     */
    public void setPreDefAttributes(de.epages.webservice.productattribute2.model.TPreDefAttribute[] preDefAttributes) {
        this.preDefAttributes = preDefAttributes;
    }
