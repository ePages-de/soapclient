...
public class TLineItemContainerIn  implements java.io.Serializable {
    ...
    private de.epages.webservice.order2.model.TProductLineItemIn[] productLineItems;
    ...
    public TLineItemContainerIn(
           ...
           de.epages.webservice.order2.model.TProductLineItemIn[] productLineItems,
     ...
     */
    public de.epages.webservice.order2.model.TProductLineItemIn[] getProductLineItems() {
     ...
     */
    public void setProductLineItems(de.epages.webservice.order2.model.TProductLineItemIn[] productLineItems) {
        this.productLineItems = productLineItems;
    }
