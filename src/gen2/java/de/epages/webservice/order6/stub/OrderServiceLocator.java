...
public class OrderServiceLocator extends org.apache.axis.client.Service implements de.epages.webservice.order6.stub.OrderService {
 ...
 */
    ...
    public de.epages.webservice.order6.stub.Port_Order getport_Order() throws javax.xml.rpc.ServiceException {
    ...
    public de.epages.webservice.order6.stub.Port_Order getport_Order(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            de.epages.webservice.order6.stub.Bind_Order_SOAPStub _stub = new de.epages.webservice.order6.stub.Bind_Order_SOAPStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (de.epages.webservice.order6.stub.Port_Order.class.isAssignableFrom(serviceEndpointInterface)) {
                de.epages.webservice.order6.stub.Bind_Order_SOAPStub _stub = new de.epages.webservice.order6.stub.Bind_Order_SOAPStub(new java.net.URL(port_Order_address), this);
                _stub.setPortName(getport_OrderWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("urn://epages.de/WebService/OrderService/2010/01", "OrderService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("urn://epages.de/WebService/OrderService/2010/01", "port_Order"));
        }
