...
public class TPriceListScalePrice  implements java.io.Serializable {
    ...
    private de.epages.webservice.pricelistassignment.model.TScalePrice[] scalePrices;
    ...
    public TPriceListScalePrice(
           ...
           de.epages.webservice.pricelistassignment.model.TScalePrice[] scalePrices) {
     ...
     * pricelistassignmenttypes:TScalePrice)
     */
    public de.epages.webservice.pricelistassignment.model.TScalePrice[] getScalePrices() {
        return scalePrices;
    }
     ...
     * pricelistassignmenttypes:TScalePrice)
     */
    public void setScalePrices(de.epages.webservice.pricelistassignment.model.TScalePrice[] scalePrices) {
        this.scalePrices = scalePrices;
    }
