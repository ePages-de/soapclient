...
public class PriceListServiceLocator extends org.apache.axis.client.Service implements de.epages.webservice.pricelist.stub.PriceListService {
 ...
 */
    ...
    public de.epages.webservice.pricelist.stub.Port_PriceList getport_PriceList() throws javax.xml.rpc.ServiceException {
    ...
    public de.epages.webservice.pricelist.stub.Port_PriceList getport_PriceList(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            de.epages.webservice.pricelist.stub.Bind_PriceList_SOAPStub _stub = new de.epages.webservice.pricelist.stub.Bind_PriceList_SOAPStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (de.epages.webservice.pricelist.stub.Port_PriceList.class.isAssignableFrom(serviceEndpointInterface)) {
                de.epages.webservice.pricelist.stub.Bind_PriceList_SOAPStub _stub = new de.epages.webservice.pricelist.stub.Bind_PriceList_SOAPStub(new java.net.URL(port_PriceList_address), this);
                _stub.setPortName(getport_PriceListWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("urn://epages.de/WebService/PriceListService/2005/01", "PriceListService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("urn://epages.de/WebService/PriceListService/2005/01", "port_PriceList"));
        }
