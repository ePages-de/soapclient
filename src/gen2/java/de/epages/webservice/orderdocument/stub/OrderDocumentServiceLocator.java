...
public class OrderDocumentServiceLocator extends org.apache.axis.client.Service implements de.epages.webservice.orderdocument.stub.OrderDocumentService {
 ...
 */
    ...
    public de.epages.webservice.orderdocument.stub.Port_OrderDocument getport_OrderDocument() throws javax.xml.rpc.ServiceException {
    ...
    public de.epages.webservice.orderdocument.stub.Port_OrderDocument getport_OrderDocument(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            de.epages.webservice.orderdocument.stub.Bind_OrderDocument_SOAPStub _stub = new de.epages.webservice.orderdocument.stub.Bind_OrderDocument_SOAPStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (de.epages.webservice.orderdocument.stub.Port_OrderDocument.class.isAssignableFrom(serviceEndpointInterface)) {
                de.epages.webservice.orderdocument.stub.Bind_OrderDocument_SOAPStub _stub = new de.epages.webservice.orderdocument.stub.Bind_OrderDocument_SOAPStub(new java.net.URL(port_OrderDocument_address), this);
                _stub.setPortName(getport_OrderDocumentWSDDServiceName());
                return _stub;
            }
        }
