...
public class TGetProductsAssignedToCatalog_Return  implements java.io.Serializable {
    ...
    private de.epages.webservice.assignment.model.TAssignedProduct[] products;
    ...
    public TGetProductsAssignedToCatalog_Return(
           ...
           de.epages.webservice.assignment.model.TAssignedProduct[] products,
     ...
     */
    public de.epages.webservice.assignment.model.TAssignedProduct[] getProducts() {
        return products;
    }
     ...
     */
    public void setProducts(de.epages.webservice.assignment.model.TAssignedProduct[] products) {
        this.products = products;
    }
