...
public class TLineItemContainerIn  implements java.io.Serializable {
    ...
    private de.epages.webservice.order9.model.TProductLineItemIn[] productLineItems;
    ...
    public TLineItemContainerIn(
           ...
           de.epages.webservice.order9.model.TProductLineItemIn[] productLineItems,
     ...
     */
    public de.epages.webservice.order9.model.TProductLineItemIn[] getProductLineItems() {
     ...
     */
    public void setProductLineItems(de.epages.webservice.order9.model.TProductLineItemIn[] productLineItems) {
        this.productLineItems = productLineItems;
    }
