...
public class TLineItemContainerOut  implements java.io.Serializable {
    ...
    private de.epages.webservice.order3.model.TProductLineItemOut[] productLineItems;

    /* the container's tax line items */
    private de.epages.webservice.order3.model.TTaxLineItem[] taxLineItems;

    /* the container's payment line item */
    private de.epages.webservice.order3.model.TPaymentLineItem paymentLineItem;

    /* the container's shipping line item */
    private de.epages.webservice.order3.model.TShippingLineItem shippingLineItem;
    ...
    public TLineItemContainerOut(
           ...
           float totalTax,
           de.epages.webservice.order3.model.TProductLineItemOut[] productLineItems,
           de.epages.webservice.order3.model.TTaxLineItem[] taxLineItems,
           de.epages.webservice.order3.model.TPaymentLineItem paymentLineItem,
           de.epages.webservice.order3.model.TShippingLineItem shippingLineItem) {
     ...
     */
    public de.epages.webservice.order3.model.TProductLineItemOut[] getProductLineItems() {
     ...
     */
    public void setProductLineItems(de.epages.webservice.order3.model.TProductLineItemOut[] productLineItems) {
        this.productLineItems = productLineItems;
    }
     ...
     */
    public de.epages.webservice.order3.model.TTaxLineItem[] getTaxLineItems() {
        return taxLineItems;
    }
     ...
     */
    public void setTaxLineItems(de.epages.webservice.order3.model.TTaxLineItem[] taxLineItems) {
        this.taxLineItems = taxLineItems;
    }
     ...
     */
    public de.epages.webservice.order3.model.TPaymentLineItem getPaymentLineItem() {
     ...
     */
    public void setPaymentLineItem(de.epages.webservice.order3.model.TPaymentLineItem paymentLineItem) {
        this.paymentLineItem = paymentLineItem;
    }
     ...
     */
    public de.epages.webservice.order3.model.TShippingLineItem getShippingLineItem() {
     ...
     */
    public void setShippingLineItem(de.epages.webservice.order3.model.TShippingLineItem shippingLineItem) {
        this.shippingLineItem = shippingLineItem;
    }
