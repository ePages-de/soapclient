...
public class TLineItemContainerIn  implements java.io.Serializable {
    ...
    private de.epages.webservice.order8.model.TProductLineItemIn[] productLineItems;
    ...
    public TLineItemContainerIn(
           ...
           de.epages.webservice.order8.model.TProductLineItemIn[] productLineItems,
     ...
     */
    public de.epages.webservice.order8.model.TProductLineItemIn[] getProductLineItems() {
     ...
     */
    public void setProductLineItems(de.epages.webservice.order8.model.TProductLineItemIn[] productLineItems) {
        this.productLineItems = productLineItems;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/OrderTypes/2011/01", "TLineItemContainerIn"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/OrderTypes/2011/01", "TProductLineItemIn"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
