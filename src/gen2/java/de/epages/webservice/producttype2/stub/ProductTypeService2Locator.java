...
public class ProductTypeService2Locator extends org.apache.axis.client.Service implements de.epages.webservice.producttype2.stub.ProductTypeService2 {
 ...
 */
    ...
    public de.epages.webservice.producttype2.stub.Port_ProductType getport_ProductType() throws javax.xml.rpc.ServiceException {
    ...
    public de.epages.webservice.producttype2.stub.Port_ProductType getport_ProductType(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            de.epages.webservice.producttype2.stub.Bind_ProductType_SOAPStub _stub = new de.epages.webservice.producttype2.stub.Bind_ProductType_SOAPStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (de.epages.webservice.producttype2.stub.Port_ProductType.class.isAssignableFrom(serviceEndpointInterface)) {
                de.epages.webservice.producttype2.stub.Bind_ProductType_SOAPStub _stub = new de.epages.webservice.producttype2.stub.Bind_ProductType_SOAPStub(new java.net.URL(port_ProductType_address), this);
                _stub.setPortName(getport_ProductTypeWSDDServiceName());
                return _stub;
            }
        }
