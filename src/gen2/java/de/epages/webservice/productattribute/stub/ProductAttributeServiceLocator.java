...
public class ProductAttributeServiceLocator extends org.apache.axis.client.Service implements de.epages.webservice.productattribute.stub.ProductAttributeService {
 ...
 */
    ...
    public de.epages.webservice.productattribute.stub.Port_ProductAttribute getport_ProductAttribute() throws javax.xml.rpc.ServiceException {
    ...
    public de.epages.webservice.productattribute.stub.Port_ProductAttribute getport_ProductAttribute(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            de.epages.webservice.productattribute.stub.Bind_ProductAttribute_SOAPStub _stub = new de.epages.webservice.productattribute.stub.Bind_ProductAttribute_SOAPStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (de.epages.webservice.productattribute.stub.Port_ProductAttribute.class.isAssignableFrom(serviceEndpointInterface)) {
                de.epages.webservice.productattribute.stub.Bind_ProductAttribute_SOAPStub _stub = new de.epages.webservice.productattribute.stub.Bind_ProductAttribute_SOAPStub(new java.net.URL(port_ProductAttribute_address), this);
                _stub.setPortName(getport_ProductAttributeWSDDServiceName());
                return _stub;
            }
        }
