...
public class TUpload_Input  implements java.io.Serializable {
    ...
    private de.epages.webservice.catalog6.model.TImageData[] imageData;

    public TUpload_Input() {
    }

    public TUpload_Input(
           de.epages.webservice.catalog6.model.TImageData[] imageData) {
     ...
     */
    public de.epages.webservice.catalog6.model.TImageData[] getImageData() {
        return imageData;
    }
     ...
     */
    public void setImageData(de.epages.webservice.catalog6.model.TImageData[] imageData) {
        this.imageData = imageData;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/CatalogTypes/2011/03", "TUpload_Input"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("imageData");
        elemField.setXmlName(new javax.xml.namespace.QName("", "ImageData"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/CatalogTypes/2011/03", "TImageData"));
