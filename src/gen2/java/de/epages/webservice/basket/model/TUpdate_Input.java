...
public class TUpdate_Input  implements java.io.Serializable {
    ...
    private de.epages.webservice.basket.model.TLineItemContainerIn lineItemContainer;
    ...
    public TUpdate_Input(
           ...
           de.epages.webservice.basket.model.TLineItemContainerIn lineItemContainer,
     ...
     */
    public de.epages.webservice.basket.model.TLineItemContainerIn getLineItemContainer() {
     ...
     */
    public void setLineItemContainer(de.epages.webservice.basket.model.TLineItemContainerIn lineItemContainer) {
        this.lineItemContainer = lineItemContainer;
    }
