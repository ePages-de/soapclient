...
public class TLineItemContainerIn  implements java.io.Serializable {
    ...
    private de.epages.webservice.basket.model.TProductLineItemIn[] productLineItems;
    ...
    public TLineItemContainerIn(
           ...
           de.epages.webservice.basket.model.TProductLineItemIn[] productLineItems,
     ...
     */
    public de.epages.webservice.basket.model.TProductLineItemIn[] getProductLineItems() {
     ...
     */
    public void setProductLineItems(de.epages.webservice.basket.model.TProductLineItemIn[] productLineItems) {
        this.productLineItems = productLineItems;
    }
