...
public class TGetInfo_Return  implements java.io.Serializable {
    ...
    private de.epages.webservice.shop2.model.TAddress address;

    private de.epages.webservice.shop2.model.TAddress shopAddress;

    /* the products, payments, shipping etc. of this order document
     * (see orderdocumenttypes:TLineItemContainerOut) */
    private de.epages.webservice.orderdocument2.model.TLineItemContainerOut lineItemContainer;
    ...
    public TGetInfo_Return(
           ...
           de.epages.webservice.shop2.model.TAddress address,
           de.epages.webservice.shop2.model.TAddress shopAddress,
           de.epages.webservice.orderdocument2.model.TLineItemContainerOut lineItemContainer,
     ...
     * @return address
     */
    public de.epages.webservice.shop2.model.TAddress getAddress() {
        return address;
    }
     ...
     * @param address
     */
    public void setAddress(de.epages.webservice.shop2.model.TAddress address) {
        this.address = address;
    }
     ...
     * @return shopAddress
     */
    public de.epages.webservice.shop2.model.TAddress getShopAddress() {
        return shopAddress;
    }
     ...
     * @param shopAddress
     */
    public void setShopAddress(de.epages.webservice.shop2.model.TAddress shopAddress) {
        this.shopAddress = shopAddress;
    }
     ...
     * (see orderdocumenttypes:TLineItemContainerOut)
     */
    public de.epages.webservice.orderdocument2.model.TLineItemContainerOut getLineItemContainer() {
     ...
     * (see orderdocumenttypes:TLineItemContainerOut)
     */
    public void setLineItemContainer(de.epages.webservice.orderdocument2.model.TLineItemContainerOut lineItemContainer) {
        this.lineItemContainer = lineItemContainer;
    }
