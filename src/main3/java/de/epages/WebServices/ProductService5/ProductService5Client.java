...
import de.epages.WebServices.ProductService5.Stub.Bind_Product_SOAPStub;
import de.epages.WebServices.ProductService5.Stub.ProductService;
import de.epages.WebServices.ProductService5.Stub.ProductServiceLocator;
...
public class ProductService5Client {
    private ProductService service;
    private Bind_Product_SOAPStub stub;
    private static Logger log = Logger.getLogger(ProductService5Client.class.getName());

    /**
     * Class constructor
     */
    public ProductService5Client(WebServiceConfiguration config) {
