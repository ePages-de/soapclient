package de.epages.WebServices.ProductService2;
...
import de.epages.WebServices.ProductService2.Stub.Bind_Product_SOAPStub;
import de.epages.WebServices.ProductService2.Stub.ProductService;
import de.epages.WebServices.ProductService2.Stub.ProductServiceLocator;
import de.epages.WebServices.ProductService2.Stub.TCreate_Input;
import de.epages.WebServices.ProductService2.Stub.TCreate_Return;
import de.epages.WebServices.ProductService2.Stub.TDelete_Return;
import de.epages.WebServices.ProductService2.Stub.TExists_Return;
import de.epages.WebServices.ProductService2.Stub.TFind_Input;
import de.epages.WebServices.ProductService2.Stub.TGetInfo_Return;
import de.epages.WebServices.ProductService2.Stub.TUpdate_Input;
import de.epages.WebServices.ProductService2.Stub.TUpdate_Return;

public class ProductService2Client {
    private ProductService service;
    private Bind_Product_SOAPStub stub;
    private static Logger log = Logger.getLogger(ProductService2Client.class.getName());

    /**
     * Class constructor
     */
    public ProductService2Client(WebServiceConfiguration config) {
