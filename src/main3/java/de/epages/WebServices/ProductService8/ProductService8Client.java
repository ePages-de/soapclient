...
import de.epages.WebServices.ProductService8.Stub.Bind_Product_SOAPStub;
import de.epages.WebServices.ProductService8.Stub.ProductService;
import de.epages.WebServices.ProductService8.Stub.ProductServiceLocator;
import de.epages.WebServices.ProductService8.Stub.TCreate_Input;
import de.epages.WebServices.ProductService8.Stub.TCreate_Return;
import de.epages.WebServices.ProductService8.Stub.TDelete_Return;
import de.epages.WebServices.ProductService8.Stub.TExists_Return;
import de.epages.WebServices.ProductService8.Stub.TFind_Input;
import de.epages.WebServices.ProductService8.Stub.TGetInfo_Return;
import de.epages.WebServices.ProductService8.Stub.TUpdate_Input;
import de.epages.WebServices.ProductService8.Stub.TUpdate_Return;

public class ProductService8Client {
    private ProductService service;
    private Bind_Product_SOAPStub stub;
    private static Logger log = Logger.getLogger(ProductService8Client.class.getName());

    /**
     * Class constructor
     */
    public ProductService8Client(WebServiceConfiguration config) {
