...
import de.epages.WebServices.ProductService7.Stub.Bind_Product_SOAPStub;
import de.epages.WebServices.ProductService7.Stub.ProductService;
import de.epages.WebServices.ProductService7.Stub.ProductServiceLocator;
...
public class ProductService7Client {
    private ProductService service;
    private Bind_Product_SOAPStub stub;
    private static Logger log = Logger.getLogger(ProductService7Client.class.getName());

    /**
     * Class constructor
     */
    public ProductService7Client(WebServiceConfiguration config) {
