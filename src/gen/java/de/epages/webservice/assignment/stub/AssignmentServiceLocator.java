...
public class AssignmentServiceLocator extends org.apache.axis.client.Service implements de.epages.webservice.assignment.stub.AssignmentService {
 ...
 */
    ...
    public de.epages.webservice.assignment.stub.Port_Assignment getport_Assignment() throws javax.xml.rpc.ServiceException {
    ...
    public de.epages.webservice.assignment.stub.Port_Assignment getport_Assignment(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            de.epages.webservice.assignment.stub.Bind_Assignment_SOAPStub _stub = new de.epages.webservice.assignment.stub.Bind_Assignment_SOAPStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (de.epages.webservice.assignment.stub.Port_Assignment.class.isAssignableFrom(serviceEndpointInterface)) {
                de.epages.webservice.assignment.stub.Bind_Assignment_SOAPStub _stub = new de.epages.webservice.assignment.stub.Bind_Assignment_SOAPStub(new java.net.URL(port_Assignment_address), this);
                _stub.setPortName(getport_AssignmentWSDDServiceName());
                return _stub;
            }
        }
