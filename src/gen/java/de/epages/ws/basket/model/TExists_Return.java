...
/**
 * a single return value of a exists() basket call.
...
public class TExists_Return  implements java.io.Serializable {
    ...
    /* a boolean flag indicating that this basket exists */
    ...
    /**
     * Gets the GUID value for this TExists_Return.
     * 
     * @return GUID
     */
    ...
    /**
     * Sets the GUID value for this TExists_Return.
     * 
     * @param GUID
     */
     ...
     * 
     * @return exists   * a boolean flag indicating that this basket exists
     */
     ...
     * 
     * @param exists   * a boolean flag indicating that this basket exists
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/BasketTypes/2013/11", "TExists_Return"));
