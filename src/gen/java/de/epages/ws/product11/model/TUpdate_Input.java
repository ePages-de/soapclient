...
public class TUpdate_Input  implements java.io.Serializable {
    ...
    private de.epages.ws.product11.model.TDownload[] downloadProductMaps;
    ...
    private de.epages.ws.product11.model.TProductPrice[] manufacturerPrices;

    /* list of deposit prices (see producttypes:ListOfListOfProductPrices) */
    private de.epages.ws.product11.model.TProductPrice[] depositPrices;

    /* list of eco participation  prices (see producttypes:ListOfListOfProductPrices) */
    private de.epages.ws.product11.model.TProductPrice[] ecoParticipationPrices;

    /* list of prepayment prices (see producttypes:ListOfListOfProductPrices) */
    private de.epages.ws.product11.model.TProductPrice[] prepaymentPrices;
    ...
    public TUpdate_Input(
           ...
           de.epages.ws.product11.model.TDownload[] downloadProductMaps,
           ...
           de.epages.ws.product11.model.TProductPrice[] ecoParticipationPrices,
           de.epages.ws.product11.model.TProductPrice[] prepaymentPrices,
     ...
     */
    public de.epages.ws.product11.model.TDownload[] getDownloadProductMaps() {
     ...
     */
    public void setDownloadProductMaps(de.epages.ws.product11.model.TDownload[] downloadProductMaps) {
        this.downloadProductMaps = downloadProductMaps;
    }
     ...
     */
    public de.epages.ws.product11.model.TProductPrice[] getProductPrices() {
     ...
     */
    public void setProductPrices(de.epages.ws.product11.model.TProductPrice[] productPrices) {
        this.productPrices = productPrices;
    }
     ...
     */
    public de.epages.ws.product11.model.TProductPrice[] getManufacturerPrices() {
     ...
     */
    public void setManufacturerPrices(de.epages.ws.product11.model.TProductPrice[] manufacturerPrices) {
        this.manufacturerPrices = manufacturerPrices;
    }
     ...
     */
    public de.epages.ws.product11.model.TProductPrice[] getDepositPrices() {
     ...
     */
    public void setDepositPrices(de.epages.ws.product11.model.TProductPrice[] depositPrices) {
        this.depositPrices = depositPrices;
    }
     ...
     */
    public de.epages.ws.product11.model.TProductPrice[] getEcoParticipationPrices() {
     ...
     */
    public void setEcoParticipationPrices(de.epages.ws.product11.model.TProductPrice[] ecoParticipationPrices) {
        this.ecoParticipationPrices = ecoParticipationPrices;
    }
     ...
     */
    public de.epages.ws.product11.model.TProductPrice[] getPrepaymentPrices() {
     ...
     */
    public void setPrepaymentPrices(de.epages.ws.product11.model.TProductPrice[] prepaymentPrices) {
        this.prepaymentPrices = prepaymentPrices;
    }
     ...
     */
    public de.epages.ws.product11.model.TShippingMethod[] getShippingMethods() {
     ...
     */
    public void setShippingMethods(de.epages.ws.product11.model.TShippingMethod[] shippingMethods) {
        this.shippingMethods = shippingMethods;
    }
