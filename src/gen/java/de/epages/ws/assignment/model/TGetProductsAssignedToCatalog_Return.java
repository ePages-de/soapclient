...
public class TGetProductsAssignedToCatalog_Return  implements java.io.Serializable {
    ...
    private de.epages.ws.assignment.model.TAssignedProduct[] products;
    ...
    public TGetProductsAssignedToCatalog_Return(
           ...
           de.epages.ws.assignment.model.TAssignedProduct[] products,
     ...
     */
    public de.epages.ws.assignment.model.TAssignedProduct[] getProducts() {
        return products;
    }
     ...
     */
    public void setProducts(de.epages.ws.assignment.model.TAssignedProduct[] products) {
        this.products = products;
    }
