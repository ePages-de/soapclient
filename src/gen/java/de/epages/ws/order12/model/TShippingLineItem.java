...
public class TShippingLineItem  implements java.io.Serializable {
    ...
    private de.epages.ws.order12.model.TShippingTax[] taxes;
    ...
    public TShippingLineItem(
           ...
           float taxRate,
           float taxAmount,
           de.epages.ws.order12.model.TShippingTax[] taxes,
    ...
    /**
     * Gets the taxes value for this TShippingLineItem.
     * 
     * @return taxes
     */
    public de.epages.ws.order12.model.TShippingTax[] getTaxes() {
        return taxes;
    }


    /**
     * Sets the taxes value for this TShippingLineItem.
     * 
     * @param taxes
     */
    public void setTaxes(de.epages.ws.order12.model.TShippingTax[] taxes) {
        this.taxes = taxes;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/OrderTypes/2013/04", "TShippingLineItem"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/OrderTypes/2013/04", "TShippingTax"));
