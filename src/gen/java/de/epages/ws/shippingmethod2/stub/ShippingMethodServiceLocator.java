...
public class ShippingMethodServiceLocator extends org.apache.axis.client.Service implements de.epages.ws.shippingmethod2.stub.ShippingMethodService {
 ...
 */
    ...
    public de.epages.ws.shippingmethod2.stub.Port_ShippingMethod getport_ShippingMethod() throws javax.xml.rpc.ServiceException {
    ...
    public de.epages.ws.shippingmethod2.stub.Port_ShippingMethod getport_ShippingMethod(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            de.epages.ws.shippingmethod2.stub.Bind_ShippingMethod_SOAPStub _stub = new de.epages.ws.shippingmethod2.stub.Bind_ShippingMethod_SOAPStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (de.epages.ws.shippingmethod2.stub.Port_ShippingMethod.class.isAssignableFrom(serviceEndpointInterface)) {
                de.epages.ws.shippingmethod2.stub.Bind_ShippingMethod_SOAPStub _stub = new de.epages.ws.shippingmethod2.stub.Bind_ShippingMethod_SOAPStub(new java.net.URL(port_ShippingMethod_address), this);
                _stub.setPortName(getport_ShippingMethodWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("urn://epages.de/WebService/ShippingMethodService/2012/07", "ShippingMethodService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("urn://epages.de/WebService/ShippingMethodService/2012/07", "port_ShippingMethod"));
        }
