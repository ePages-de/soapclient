...
public class TDelete_Return  implements java.io.Serializable {
     ...
     * 
     * @return deleted   * a boolean flag indicating whether this product type has been
     * deleted
     */
     ...
     * 
     * @param deleted   * a boolean flag indicating whether this product type has been
     * deleted
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/ProductTypeTypes2/2007/11", "TDelete_Return"));
