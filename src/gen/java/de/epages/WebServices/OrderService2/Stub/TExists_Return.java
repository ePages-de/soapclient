...
public class TExists_Return  implements java.io.Serializable {
    ...
    /* a boolean flag indicating that this order exists */
     ...
     * 
     * @return exists   * a boolean flag indicating that this order exists
     */
     ...
     * 
     * @param exists   * a boolean flag indicating that this order exists
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/OrderTypes/2006/07", "TExists_Return"));
