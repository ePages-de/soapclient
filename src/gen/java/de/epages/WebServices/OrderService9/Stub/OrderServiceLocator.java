...
public class OrderServiceLocator extends org.apache.axis.client.Service implements de.epages.WebServices.OrderService9.Stub.OrderService {
 ...
 */
    ...
    public de.epages.WebServices.OrderService9.Stub.Port_Order_PortType getport_Order(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            de.epages.WebServices.OrderService9.Stub.Bind_Order_SOAPStub _stub = new de.epages.WebServices.OrderService9.Stub.Bind_Order_SOAPStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (de.epages.WebServices.OrderService9.Stub.Port_Order_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                de.epages.WebServices.OrderService9.Stub.Bind_Order_SOAPStub _stub = new de.epages.WebServices.OrderService9.Stub.Bind_Order_SOAPStub(new java.net.URL(port_Order_address), this);
                _stub.setPortName(getport_OrderWSDDServiceName());
                return _stub;
            }
        }
