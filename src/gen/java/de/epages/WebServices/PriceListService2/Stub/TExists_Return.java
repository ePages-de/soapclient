...
public class TExists_Return  implements java.io.Serializable {
    ...
    /* a boolean flag indicating that this pricelist exists */
     ...
     * 
     * @return exists   * a boolean flag indicating that this pricelist exists
     */
     ...
     * 
     * @param exists   * a boolean flag indicating that this pricelist exists
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/PriceListTypes/2010/08", "TExists_Return"));
