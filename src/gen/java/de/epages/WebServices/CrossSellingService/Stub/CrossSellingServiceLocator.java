...
public class CrossSellingServiceLocator extends org.apache.axis.client.Service implements de.epages.WebServices.CrossSellingService.Stub.CrossSellingService {
 ...
 */
    ...
    public de.epages.WebServices.CrossSellingService.Stub.Port_CrossSelling_PortType getport_CrossSelling() throws javax.xml.rpc.ServiceException {
    ...
    public de.epages.WebServices.CrossSellingService.Stub.Port_CrossSelling_PortType getport_CrossSelling(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            de.epages.WebServices.CrossSellingService.Stub.Bind_CrossSelling_SOAPStub _stub = new de.epages.WebServices.CrossSellingService.Stub.Bind_CrossSelling_SOAPStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (de.epages.WebServices.CrossSellingService.Stub.Port_CrossSelling_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                de.epages.WebServices.CrossSellingService.Stub.Bind_CrossSelling_SOAPStub _stub = new de.epages.WebServices.CrossSellingService.Stub.Bind_CrossSelling_SOAPStub(new java.net.URL(port_CrossSelling_address), this);
                _stub.setPortName(getport_CrossSellingWSDDServiceName());
                return _stub;
            }
        }
