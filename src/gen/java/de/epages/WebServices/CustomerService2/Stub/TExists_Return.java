...
public class TExists_Return  implements java.io.Serializable {
    ...
    /* a boolean flag indicating that this customer exists */
     ...
     * 
     * @return exists   * a boolean flag indicating that this customer exists
     */
     ...
     * 
     * @param exists   * a boolean flag indicating that this customer exists
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/CustomerTypes/2006/07", "TExists_Return"));
