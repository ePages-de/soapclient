...
public class TTaxLineItem  implements java.io.Serializable {
    ...
    /**
     * Gets the attributes value for this TTaxLineItem.
     * 
    ...
    /**
     * Sets the attributes value for this TTaxLineItem.
     * 
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/OrderDocumentTypes/2008/05", "TTaxLineItem"));
