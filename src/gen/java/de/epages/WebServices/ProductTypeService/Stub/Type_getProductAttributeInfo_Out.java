...
public class Type_getProductAttributeInfo_Out  implements java.io.Serializable {
    ...
    private de.epages.WebServices.ProductTypeService.Stub.TGetProductAttributeInfo_Return[] productAttributes;
    ...
    public Type_getProductAttributeInfo_Out(
           de.epages.WebServices.ProductTypeService.Stub.TGetProductAttributeInfo_Return[] productAttributes,
     ...
     */
    public de.epages.WebServices.ProductTypeService.Stub.TGetProductAttributeInfo_Return[] getProductAttributes() {
     ...
     */
    public void setProductAttributes(de.epages.WebServices.ProductTypeService.Stub.TGetProductAttributeInfo_Return[] productAttributes) {
        this.productAttributes = productAttributes;
    }
