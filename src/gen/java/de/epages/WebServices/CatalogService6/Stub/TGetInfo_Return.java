...
public class TGetInfo_Return  implements java.io.Serializable {
    ...
    private de.epages.WebServices.CatalogService6.Stub.TLocalizedValue[] name;

    /* localized text of catalog (see epagestypes:TLocalizedValue) */
    private de.epages.WebServices.CatalogService6.Stub.TLocalizedValue[] text;

    /* localized additional text1 of catalog (see epagestypes:TLocalizedValue) */
    private de.epages.WebServices.CatalogService6.Stub.TLocalizedValue[] text1;

    /* localized additional text2 of catalog (see epagestypes:TLocalizedValue) */
    private de.epages.WebServices.CatalogService6.Stub.TLocalizedValue[] text2;

    /* localized additional text3 of catalog (see epagestypes:TLocalizedValue) */
    private de.epages.WebServices.CatalogService6.Stub.TLocalizedValue[] text3;

    /* short uri (unique part of short URL, see CanonicalURL) */
    private de.epages.WebServices.CatalogService6.Stub.TLocalizedValue[] URI;

    /* complete url for canonical tag (based on domain name and URI,
     * i.e. http://my.do.main/myURI) */
    private de.epages.WebServices.CatalogService6.Stub.TLocalizedValue[] canonicalURL;
    ...
    private de.epages.WebServices.CatalogService6.Stub.TAttribute[] templateTypes;

    /* list of requested attributes (see epagestypes:ListOfAttributes) */
    private de.epages.WebServices.CatalogService6.Stub.TAttribute[] attributes;

    /* error object (see epagestypes:TError) */
    private de.epages.WebServices.CatalogService6.Stub.TError error;
    ...
    public TGetInfo_Return(
           ...
           de.epages.WebServices.CatalogService6.Stub.TLocalizedValue[] name,
           de.epages.WebServices.CatalogService6.Stub.TLocalizedValue[] text,
           de.epages.WebServices.CatalogService6.Stub.TLocalizedValue[] text1,
           de.epages.WebServices.CatalogService6.Stub.TLocalizedValue[] text2,
           de.epages.WebServices.CatalogService6.Stub.TLocalizedValue[] text3,
           de.epages.WebServices.CatalogService6.Stub.TLocalizedValue[] URI,
           de.epages.WebServices.CatalogService6.Stub.TLocalizedValue[] canonicalURL,
           java.lang.String[] subCatalogs,
           de.epages.WebServices.CatalogService6.Stub.TAttribute[] templateTypes,
           de.epages.WebServices.CatalogService6.Stub.TAttribute[] attributes,
           de.epages.WebServices.CatalogService6.Stub.TError error) {
           this.path = path;
           this.alias = alias;
           this._class = _class;
     ...
     */
    public de.epages.WebServices.CatalogService6.Stub.TLocalizedValue[] getName() {
        return name;
    }
     ...
     */
    public void setName(de.epages.WebServices.CatalogService6.Stub.TLocalizedValue[] name) {
        this.name = name;
    }
     ...
     */
    public de.epages.WebServices.CatalogService6.Stub.TLocalizedValue[] getText() {
        return text;
    }
     ...
     */
    public void setText(de.epages.WebServices.CatalogService6.Stub.TLocalizedValue[] text) {
        this.text = text;
    }
     ...
     */
    public de.epages.WebServices.CatalogService6.Stub.TLocalizedValue[] getText1() {
        return text1;
    }
     ...
     */
    public void setText1(de.epages.WebServices.CatalogService6.Stub.TLocalizedValue[] text1) {
        this.text1 = text1;
    }
     ...
     */
    public de.epages.WebServices.CatalogService6.Stub.TLocalizedValue[] getText2() {
        return text2;
    }
     ...
     */
    public void setText2(de.epages.WebServices.CatalogService6.Stub.TLocalizedValue[] text2) {
        this.text2 = text2;
    }
     ...
     */
    public de.epages.WebServices.CatalogService6.Stub.TLocalizedValue[] getText3() {
        return text3;
    }
     ...
     */
    public void setText3(de.epages.WebServices.CatalogService6.Stub.TLocalizedValue[] text3) {
        this.text3 = text3;
    }
     ...
     */
    public de.epages.WebServices.CatalogService6.Stub.TLocalizedValue[] getURI() {
        return URI;
    }
     ...
     */
    public void setURI(de.epages.WebServices.CatalogService6.Stub.TLocalizedValue[] URI) {
        this.URI = URI;
    }
     ...
     * i.e. http://my.do.main/myURI)
     */
    public de.epages.WebServices.CatalogService6.Stub.TLocalizedValue[] getCanonicalURL() {
        return canonicalURL;
    }
     ...
     * i.e. http://my.do.main/myURI)
     */
    public void setCanonicalURL(de.epages.WebServices.CatalogService6.Stub.TLocalizedValue[] canonicalURL) {
        this.canonicalURL = canonicalURL;
    }
     ...
     * to show the category as image, image, text and image order
     */
    public de.epages.WebServices.CatalogService6.Stub.TAttribute[] getTemplateTypes() {
     ...
     * to show the category as image, image, text and image order
     */
    public void setTemplateTypes(de.epages.WebServices.CatalogService6.Stub.TAttribute[] templateTypes) {
        this.templateTypes = templateTypes;
    }
     ...
     */
    public de.epages.WebServices.CatalogService6.Stub.TAttribute[] getAttributes() {
        return attributes;
    }
     ...
     */
    public void setAttributes(de.epages.WebServices.CatalogService6.Stub.TAttribute[] attributes) {
        this.attributes = attributes;
    }
     ...
     */
    public de.epages.WebServices.CatalogService6.Stub.TError getError() {
        return error;
    }
     ...
     */
    public void setError(de.epages.WebServices.CatalogService6.Stub.TError error) {
        this.error = error;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/CatalogTypes/2011/03", "TGetInfo_Return"));
