...
public class TCreate_Return  implements java.io.Serializable {
    ...
    /* a boolean flag indicating that this user was created */
     ...
     * 
     * @return created   * a boolean flag indicating that this user was created
     */
     ...
     * 
     * @param created   * a boolean flag indicating that this user was created
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/UserTypes/2006/07", "TCreate_Return"));
