...
public class TAttribute  implements java.io.Serializable {
    ...
    private de.epages.WebServices.ProductService3.Stub.TLocalizedValue[] localizedValues;
    ...
    public TAttribute(
           ...
           de.epages.WebServices.ProductService3.Stub.TLocalizedValue[] localizedValues,
     ...
     *             see epagestypes:ListOfLocalizedValues
     */
    public de.epages.WebServices.ProductService3.Stub.TLocalizedValue[] getLocalizedValues() {
     ...
     *             see epagestypes:ListOfLocalizedValues
     */
    public void setLocalizedValues(de.epages.WebServices.ProductService3.Stub.TLocalizedValue[] localizedValues) {
        this.localizedValues = localizedValues;
    }
