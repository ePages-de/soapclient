package de.epages.WebServices.ProductService7;

import de.epages.WebServices.ProductService7.Stub.*;
 ...
 *
 */
public class Product7TestCase {
    private static Logger log = Logger.getLogger(Product7TestCase.class.getName());
    ProductService7Client serviceClient;
    ...
    public void testGetInfo(boolean isAlreadyUpdated) {
        ...
        if (isAlreadyUpdated) {
            ...
            assertEquals("updated localized LongDescription", Product_in.getText()[0].getValue(), hashLongDescription.get(Product_in.getText()[0].getLanguageCode()));
            assertEquals("updated localized LongDescription", Product_in.getText()[1].getValue(), hashLongDescription.get(Product_in.getText()[1].getLanguageCode()));
            assertEquals("updated localized Title", Product_in.getTitle()[0].getValue(), hashTitle.get(Product_in.getTitle()[0].getLanguageCode()));
            assertEquals("updated localized Title", Product_in.getTitle()[1].getValue(), hashTitle.get(Product_in.getTitle()[1].getLanguageCode()));
