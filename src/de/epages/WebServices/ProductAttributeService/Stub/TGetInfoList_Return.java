...
public class TGetInfoList_Return  implements java.io.Serializable {
    ...
    private de.epages.WebServices.ProductAttributeService.Stub.TError error;
    ...
    public TGetInfoList_Return(
           ...
           de.epages.WebServices.ProductAttributeService.Stub.TError error) {
           this.alias = alias;
           this.path = path;
     ...
     */
    public de.epages.WebServices.ProductAttributeService.Stub.TError getError() {
        return error;
    }
     ...
     */
    public void setError(de.epages.WebServices.ProductAttributeService.Stub.TError error) {
        this.error = error;
    }
