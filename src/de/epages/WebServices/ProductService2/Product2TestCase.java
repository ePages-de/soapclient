...
import de.epages.WebServices.ProductService2.Stub.*;
 ...
 * Time: 14:19:18
 */
public class Product2TestCase {
    private static Logger log = Logger.getLogger(Product2TestCase.class.getName());
    ...
    public void testGetInfo(boolean isAlreadyUpdated) {
        ...
        if (isAlreadyUpdated) {
            ...
            assertEquals("AvailabilityDate", Product_update.getAvailabilityDate().getTime(), Product_info_out.getAvailabilityDate().getTime()   );
        }
        else {
            ...
            assertEquals("updated localized AvailabilityComment", Product_in.getAvailabilityComment()[0].getValue(), hashAComment.get(Product_in.getAvailabilityComment()[0].getLanguageCode()));
            assertEquals("updated localized AvailabilityComment", Product_in.getAvailabilityComment()[1].getValue(), hashAComment.get(Product_in.getAvailabilityComment()[1].getLanguageCode()));
