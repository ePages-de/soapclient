...
public class TGetInfo_Return  implements java.io.Serializable {
    ...
    private de.epages.WebServices.UserService.Stub.TError error;
    ...
    public TGetInfo_Return(
           ...
           de.epages.WebServices.UserService.Stub.TError error) {
           this.path = path;
           this.alias = alias;
           this._class = _class;
     ...
     */
    public de.epages.WebServices.UserService.Stub.TError getError() {
        return error;
    }
     ...
     */
    public void setError(de.epages.WebServices.UserService.Stub.TError error) {
        this.error = error;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/UserTypes/2005/01", "TGetInfo_Return"));
