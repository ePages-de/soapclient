...
import de.epages.WebServices.ProductService6.Stub.*;
 ...
 *
 */
public class Product6TestCase {
    private static Logger log = Logger.getLogger(Product6TestCase.class.getName());
    ...
    public void setUp() {
        ...
        Product_in.setLongDescription(new TLocalizedValue[]{
        ...
        Product_update.setLongDescription(new TLocalizedValue[]{
    ...
    public void testGetInfo(boolean isAlreadyUpdated) {
        ...
        hashLongDescription.put(Product_info_out.getLongDescription()[0].getLanguageCode(), Product_info_out.getLongDescription()[0].getValue());
        hashLongDescription.put(Product_info_out.getLongDescription()[1].getLanguageCode(), Product_info_out.getLongDescription()[1].getValue());
        ...
        if (isAlreadyUpdated) {
            ...
            assertEquals("updated localized LongDescription", Product_update.getLongDescription()[0].getValue(), hashLongDescription.get(Product_update.getLongDescription()[0].getLanguageCode()));
            assertEquals("updated localized LongDescription", Product_update.getLongDescription()[1].getValue(), hashLongDescription.get(Product_update.getLongDescription()[1].getLanguageCode()));
            ...
            assertEquals("updated localized LongDescription", Product_in.getLongDescription()[0].getValue(), hashLongDescription.get(Product_in.getLongDescription()[0].getLanguageCode()));
            assertEquals("updated localized LongDescription", Product_in.getLongDescription()[1].getValue(), hashLongDescription.get(Product_in.getLongDescription()[1].getLanguageCode()));
