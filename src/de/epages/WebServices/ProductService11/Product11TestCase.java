...
import de.epages.WebServices.ProductService11.Stub.*;
...
public class Product11TestCase {
    private static Logger log = Logger.getLogger(Product11TestCase.class.getName());
    ...
    @Before
    public void setUp() {
        serviceClient = new ProductService11Client();
        ...
        Product_in.setText(new TLocalizedValue[]{
                new TLocalizedValue("de", "Test-Hauptprodukt Beschreibung"),
                new TLocalizedValue("en", "test master product long description"),
            });
        Product_in.setTitle(new TLocalizedValue[]{
                new TLocalizedValue("de", "Test-Pagetitle"),
                new TLocalizedValue("en", "test page title"),
            });
        Product_in.setMainCharacteristics(new TLocalizedValue[]{
                new TLocalizedValue("de", "EiFon lila 128GB"),
        ...
        Product_in.setManufacturerPrices(new TProductPrice[]{
                new TProductPrice((float)150, "EUR", "gross"),
            });
        Product_in.setDepositPrices(new TProductPrice[]{
                new TProductPrice((float)5, "EUR", "gross"),
            });
        Product_in.setPrepaymentPrices(new TProductPrice[]{
                new TProductPrice((float)10, "EUR", "gross"),
            });
        Product_in.setEcoParticipationPrices(new TProductPrice[]{
                new TProductPrice((float)7, "EUR", "gross"),
            });
        ...
        Product_update.setText(new TLocalizedValue[]{
                new TLocalizedValue("de", "Test-Hauptprodukt Beschreibung modifiziert"),
                new TLocalizedValue("en", "test master product long description updated"),
            });
        Product_update.setTitle(new TLocalizedValue[]{
                new TLocalizedValue("de", "Test-Pagetitle modifiziert"),
                new TLocalizedValue("en", "test page title updated"),
            });
        Product_update.setMainCharacteristics(new TLocalizedValue[]{
                new TLocalizedValue("de", "EiFon rosa 64GB"),
        ...
        Product_update.setManufacturerPrices(new TProductPrice[]{
                new TProductPrice((float)150.50, "EUR", "gross"),
            });
        Product_update.setDepositPrices(new TProductPrice[]{
                new TProductPrice((float)5.50, "EUR", "gross"),
            });
        Product_update.setPrepaymentPrices(new TProductPrice[]{
                new TProductPrice((float)10.50, "EUR", "gross"),
            });
        Product_update.setEcoParticipationPrices(new TProductPrice[]{
                new TProductPrice((float)7.50, "EUR", "gross"),
            });
    ...
    public void testGetInfo(boolean isAlreadyUpdated) {
        ...
        hashMainCharact.put(Product_info_out.getMainCharacteristics()[0].getLanguageCode(), Product_info_out.getMainCharacteristics()[0].getValue());
        hashMainCharact.put(Product_info_out.getMainCharacteristics()[1].getLanguageCode(), Product_info_out.getMainCharacteristics()[1].getValue());
        ...
        priceHash5.put(Product_info_out.getEcoParticipationPrices()[0].getCurrencyID(), Product_info_out.getEcoParticipationPrices()[0].getPrice());
        priceHash5.put(Product_info_out.getEcoParticipationPrices()[1].getCurrencyID(), Product_info_out.getEcoParticipationPrices()[1].getPrice());
        ...
        if (isAlreadyUpdated) {
            ...
            assertEquals("updated localized LongDescription", Product_update.getText()[0].getValue(), hashLongDescription.get(Product_update.getText()[0].getLanguageCode()));
            assertEquals("updated localized LongDescription", Product_update.getText()[1].getValue(), hashLongDescription.get(Product_update.getText()[1].getLanguageCode()));
            assertEquals("updated localized Title", Product_update.getTitle()[0].getValue(), hashTitle.get(Product_update.getTitle()[0].getLanguageCode()));
            assertEquals("updated localized Title", Product_update.getTitle()[1].getValue(), hashTitle.get(Product_update.getTitle()[1].getLanguageCode()));
            ...
            assertEquals("Price Value", Product_update.getProductPrices()[0].getPrice(), priceHash.get(Product_update.getProductPrices()[0].getCurrencyID()) );
            assertEquals("Manufacturer Price Value", Product_update.getManufacturerPrices()[0].getPrice(), priceHash2.get(Product_update.getManufacturerPrices()[0].getCurrencyID()) );
            assertEquals("Deposit Price Value", Product_update.getDepositPrices()[0].getPrice(), priceHash3.get(Product_update.getDepositPrices()[0].getCurrencyID()) );
            assertEquals("Prepayment Price Value", Product_update.getPrepaymentPrices()[0].getPrice(), priceHash4.get(Product_update.getPrepaymentPrices()[0].getCurrencyID()) );
            assertEquals("EcoParticipation Price Value", Product_update.getEcoParticipationPrices()[0].getPrice(), priceHash5.get(Product_update.getEcoParticipationPrices()[0].getCurrencyID()) );
            ...
            assertEquals("initial localized LongDescription", Product_in.getText()[0].getValue(), hashLongDescription.get(Product_in.getText()[0].getLanguageCode()));
            assertEquals("initial localized LongDescription", Product_in.getText()[1].getValue(), hashLongDescription.get(Product_in.getText()[1].getLanguageCode()));
            assertEquals("initial localized Title", Product_in.getTitle()[0].getValue(), hashTitle.get(Product_in.getTitle()[0].getLanguageCode()));
            assertEquals("initial localized Title", Product_in.getTitle()[1].getValue(), hashTitle.get(Product_in.getTitle()[1].getLanguageCode()));
            ...
            assertEquals("Price Value", Product_in.getProductPrices()[0].getPrice(), priceHash.get(Product_in.getProductPrices()[0].getCurrencyID()) );
            assertEquals("Manufacturer Price Value", Product_in.getManufacturerPrices()[0].getPrice(), priceHash2.get(Product_in.getManufacturerPrices()[0].getCurrencyID()) );
            assertEquals("Deposit Price Value", Product_in.getDepositPrices()[0].getPrice(), priceHash3.get(Product_in.getDepositPrices()[0].getCurrencyID()) );
            assertEquals("Prepayment Price Value", Product_in.getPrepaymentPrices()[0].getPrice(), priceHash4.get(Product_in.getPrepaymentPrices()[0].getCurrencyID()) );
            assertEquals("EcoParticipation Price Value", Product_in.getEcoParticipationPrices()[0].getPrice(), priceHash5.get(Product_in.getEcoParticipationPrices()[0].getCurrencyID()) );
