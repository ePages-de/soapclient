 ...
 * create a user.
 *         alias, password, email, name, billing address, shipping address
 * are mandatory.
...
public class TCreate_Input  implements java.io.Serializable {
    ...
    private de.epages.WebServices.UserService3.Stub.TAddressNamed billingAddress;

    /* user's shipping address */
    private de.epages.WebServices.UserService3.Stub.TAddressNamed shippingAddress;

    /* all user's shipping addresses identified by alias */
    private de.epages.WebServices.UserService3.Stub.TAddressNamed[] additionalAddresses;
    ...
    private de.epages.WebServices.UserService3.Stub.TAttribute[] attributes;
    ...
    public TCreate_Input(
           ...
           de.epages.WebServices.UserService3.Stub.TAddressNamed billingAddress,
           de.epages.WebServices.UserService3.Stub.TAddressNamed shippingAddress,
           de.epages.WebServices.UserService3.Stub.TAddressNamed[] additionalAddresses,
           java.lang.String[] customers,
           de.epages.WebServices.UserService3.Stub.TAttribute[] attributes) {
           this.alias = alias;
    ...
    /**
     * Gets the localeID value for this TCreate_Input.
     * 
    ...
    /**
     * Sets the localeID value for this TCreate_Input.
     * 
    ...
    /**
     * Gets the languageCode value for this TCreate_Input.
     * 
    ...
    /**
     * Sets the languageCode value for this TCreate_Input.
     * 
    ...
    /**
     * Gets the password value for this TCreate_Input.
     * 
    ...
    /**
     * Sets the password value for this TCreate_Input.
     * 
    ...
    /**
     * Gets the isActivated value for this TCreate_Input.
     * 
    ...
    /**
     * Sets the isActivated value for this TCreate_Input.
     * 
    ...
    /**
     * Gets the deleteConfirmation value for this TCreate_Input.
     * 
    ...
    /**
     * Sets the deleteConfirmation value for this TCreate_Input.
     * 
    ...
    /**
     * Gets the isLoginCookieAllowed value for this TCreate_Input.
     * 
    ...
    /**
     * Sets the isLoginCookieAllowed value for this TCreate_Input.
     * 
    ...
    /**
     * Gets the reminderQuestion value for this TCreate_Input.
     * 
    ...
    /**
     * Sets the reminderQuestion value for this TCreate_Input.
     * 
    ...
    /**
     * Gets the challengePhrase value for this TCreate_Input.
     * 
    ...
    /**
     * Sets the challengePhrase value for this TCreate_Input.
     * 
    ...
    /**
     * Gets the EMail value for this TCreate_Input.
     * 
    ...
    /**
     * Sets the EMail value for this TCreate_Input.
     * 
     ...
     */
    public de.epages.WebServices.UserService3.Stub.TAddressNamed getBillingAddress() {
     ...
     */
    public void setBillingAddress(de.epages.WebServices.UserService3.Stub.TAddressNamed billingAddress) {
        this.billingAddress = billingAddress;
    }
     ...
     */
    public de.epages.WebServices.UserService3.Stub.TAddressNamed getShippingAddress() {
     ...
     */
    public void setShippingAddress(de.epages.WebServices.UserService3.Stub.TAddressNamed shippingAddress) {
        this.shippingAddress = shippingAddress;
    }


    /**
     * Gets the additionalAddresses value for this TCreate_Input.
     * 
     * @return additionalAddresses   * all user's shipping addresses identified by alias
     */
    public de.epages.WebServices.UserService3.Stub.TAddressNamed[] getAdditionalAddresses() {
        return additionalAddresses;
    }


    /**
     * Sets the additionalAddresses value for this TCreate_Input.
     * 
     * @param additionalAddresses   * all user's shipping addresses identified by alias
     */
    public void setAdditionalAddresses(de.epages.WebServices.UserService3.Stub.TAddressNamed[] additionalAddresses) {
        this.additionalAddresses = additionalAddresses;
    }
     ...
     */
    public de.epages.WebServices.UserService3.Stub.TAttribute[] getAttributes() {
        return attributes;
    }
     ...
     */
    public void setAttributes(de.epages.WebServices.UserService3.Stub.TAttribute[] attributes) {
        this.attributes = attributes;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/UserTypes/2006/07", "TCreate_Input"));
