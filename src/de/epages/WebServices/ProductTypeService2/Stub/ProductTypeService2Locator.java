...
public class ProductTypeService2Locator extends org.apache.axis.client.Service implements de.epages.WebServices.ProductTypeService2.Stub.ProductTypeService2 {

/**
 * epages5 Product Type Service 2
 */
    ...
    public de.epages.WebServices.ProductTypeService2.Stub.Port_ProductType_PortType getport_ProductType() throws javax.xml.rpc.ServiceException {
    ...
    public de.epages.WebServices.ProductTypeService2.Stub.Port_ProductType_PortType getport_ProductType(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            de.epages.WebServices.ProductTypeService2.Stub.Bind_ProductType_SOAPStub _stub = new de.epages.WebServices.ProductTypeService2.Stub.Bind_ProductType_SOAPStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (de.epages.WebServices.ProductTypeService2.Stub.Port_ProductType_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                de.epages.WebServices.ProductTypeService2.Stub.Bind_ProductType_SOAPStub _stub = new de.epages.WebServices.ProductTypeService2.Stub.Bind_ProductType_SOAPStub(new java.net.URL(port_ProductType_address), this);
                _stub.setPortName(getport_ProductTypeWSDDServiceName());
                return _stub;
            }
        }
