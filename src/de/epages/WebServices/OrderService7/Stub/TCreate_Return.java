...
public class TCreate_Return  implements java.io.Serializable {
    ...
    /* a boolean flag indicating that this order was created */
     ...
     * 
     * @return created   * a boolean flag indicating that this order was created
     */
     ...
     * 
     * @param created   * a boolean flag indicating that this order was created
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/OrderTypes/2010/10", "TCreate_Return"));
