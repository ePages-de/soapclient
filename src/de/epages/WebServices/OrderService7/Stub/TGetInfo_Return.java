...
public class TGetInfo_Return  implements java.io.Serializable {
    ...
    private de.epages.WebServices.OrderService7.Stub.TLineItemContainerOut lineItemContainer;
    ...
    private de.epages.WebServices.OrderService7.Stub.TError error;
    ...
    public TGetInfo_Return(
           ...
           de.epages.WebServices.OrderService7.Stub.TLineItemContainerOut lineItemContainer,
           ...
           de.epages.WebServices.OrderService7.Stub.TError error) {
           this.path = path;
           this.alias = alias;
           this._class = _class;
     ...
     */
    public de.epages.WebServices.OrderService7.Stub.TLineItemContainerOut getLineItemContainer() {
     ...
     */
    public void setLineItemContainer(de.epages.WebServices.OrderService7.Stub.TLineItemContainerOut lineItemContainer) {
        this.lineItemContainer = lineItemContainer;
    }
     ...
     */
    public de.epages.WebServices.OrderService7.Stub.TError getError() {
        return error;
    }
     ...
     */
    public void setError(de.epages.WebServices.OrderService7.Stub.TError error) {
        this.error = error;
    }
