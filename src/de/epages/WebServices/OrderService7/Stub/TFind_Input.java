...
public class TFind_Input  implements java.io.Serializable {
    ...
    /* customer path of order created customer */
    ...
    /**
     * Gets the customer value for this TFind_Input.
     * 
     * @return customer   * customer path of order created customer
     */
    ...
    /**
     * Sets the customer value for this TFind_Input.
     * 
     * @param customer   * customer path of order created customer
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/OrderService/2010/10", "TFind_Input"));
