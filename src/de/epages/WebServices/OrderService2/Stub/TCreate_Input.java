 ...
 *         a set of order specific attributes that will be used to create
 * a order.
...
public class TCreate_Input  implements java.io.Serializable {
    ...
    private de.epages.WebServices.OrderService2.Stub.TLineItemContainerIn lineItemContainer;

    private de.epages.WebServices.OrderService2.Stub.TAddress billingAddress;

    private de.epages.WebServices.OrderService2.Stub.TAddress shippingAddress;

    /* list of requested attributes (see epagestypes:ListOfAttributes) */
    private de.epages.WebServices.OrderService2.Stub.TAttribute[] attributes;
    ...
    public TCreate_Input(
           ...
           de.epages.WebServices.OrderService2.Stub.TLineItemContainerIn lineItemContainer,
           de.epages.WebServices.OrderService2.Stub.TAddress billingAddress,
           de.epages.WebServices.OrderService2.Stub.TAddress shippingAddress,
           de.epages.WebServices.OrderService2.Stub.TAttribute[] attributes) {
           this.alias = alias;
    ...
    /**
     * Gets the creationDate value for this TCreate_Input.
     * 
    ...
    /**
     * Sets the creationDate value for this TCreate_Input.
     * 
    ...
    /**
     * Gets the viewedOn value for this TCreate_Input.
     * 
    ...
    /**
     * Sets the viewedOn value for this TCreate_Input.
     * 
    ...
    /**
     * Gets the inProcessOn value for this TCreate_Input.
     * 
    ...
    /**
     * Sets the inProcessOn value for this TCreate_Input.
     * 
    ...
    /**
     * Gets the pendingOn value for this TCreate_Input.
     * 
    ...
    /**
     * Sets the pendingOn value for this TCreate_Input.
     * 
    ...
    /**
     * Gets the readyForShippingOn value for this TCreate_Input.
     * 
    ...
    /**
     * Sets the readyForShippingOn value for this TCreate_Input.
     * 
    ...
    /**
     * Gets the partlyDispatchedOn value for this TCreate_Input.
     * 
    ...
    /**
     * Sets the partlyDispatchedOn value for this TCreate_Input.
     * 
    ...
    /**
     * Gets the dispatchedOn value for this TCreate_Input.
     * 
    ...
    /**
     * Sets the dispatchedOn value for this TCreate_Input.
     * 
    ...
    /**
     * Gets the shippedOn value for this TCreate_Input.
     * 
    ...
    /**
     * Sets the shippedOn value for this TCreate_Input.
     * 
    ...
    /**
     * Gets the partlyPaidOn value for this TCreate_Input.
     * 
    ...
    /**
     * Sets the partlyPaidOn value for this TCreate_Input.
     * 
    ...
    /**
     * Gets the paidOn value for this TCreate_Input.
     * 
    ...
    /**
     * Sets the paidOn value for this TCreate_Input.
     * 
    ...
    /**
     * Gets the closedOn value for this TCreate_Input.
     * 
    ...
    /**
     * Sets the closedOn value for this TCreate_Input.
     * 
    ...
    /**
     * Gets the archivedOn value for this TCreate_Input.
     * 
    ...
    /**
     * Sets the archivedOn value for this TCreate_Input.
     * 
    ...
    /**
     * Gets the partlyInvoicedOn value for this TCreate_Input.
     * 
    ...
    /**
     * Sets the partlyInvoicedOn value for this TCreate_Input.
     * 
    ...
    /**
     * Gets the invoicedOn value for this TCreate_Input.
     * 
    ...
    /**
     * Sets the invoicedOn value for this TCreate_Input.
     * 
     ...
     */
    public de.epages.WebServices.OrderService2.Stub.TLineItemContainerIn getLineItemContainer() {
     ...
     */
    public void setLineItemContainer(de.epages.WebServices.OrderService2.Stub.TLineItemContainerIn lineItemContainer) {
        this.lineItemContainer = lineItemContainer;
    }
     ...
     */
    public de.epages.WebServices.OrderService2.Stub.TAddress getBillingAddress() {
        return billingAddress;
    }
     ...
     */
    public void setBillingAddress(de.epages.WebServices.OrderService2.Stub.TAddress billingAddress) {
        this.billingAddress = billingAddress;
    }
     ...
     */
    public de.epages.WebServices.OrderService2.Stub.TAddress getShippingAddress() {
        return shippingAddress;
    }
     ...
     */
    public void setShippingAddress(de.epages.WebServices.OrderService2.Stub.TAddress shippingAddress) {
        this.shippingAddress = shippingAddress;
    }
     ...
     */
    public de.epages.WebServices.OrderService2.Stub.TAttribute[] getAttributes() {
        return attributes;
    }
     ...
     */
    public void setAttributes(de.epages.WebServices.OrderService2.Stub.TAttribute[] attributes) {
        this.attributes = attributes;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/OrderTypes/2006/07", "TCreate_Input"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/OrderTypes/2006/07", "TLineItemContainerIn"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("billingAddress");
        elemField.setXmlName(new javax.xml.namespace.QName("", "BillingAddress"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/ShopTypes/2006/07", "TAddress"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
