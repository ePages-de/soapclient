...
public class TDelete_Return  implements java.io.Serializable {
    ...
    /* a boolean flag indicating that this order was deleted */
     ...
     * 
     * @return deleted   * a boolean flag indicating that this order was deleted
     */
     ...
     * 
     * @param deleted   * a boolean flag indicating that this order was deleted
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/OrderTypes/2006/07", "TDelete_Return"));
