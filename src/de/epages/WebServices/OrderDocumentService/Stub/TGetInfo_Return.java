...
public class TGetInfo_Return  implements java.io.Serializable {
    ...
    private de.epages.WebServices.OrderDocumentService.Stub.TAddress address;

    private de.epages.WebServices.OrderDocumentService.Stub.TAddress shopAddress;

    /* the products, payments, shipping etc. of this order document
     * (see orderdocumenttypes:TLineItemContainerOut) */
    private de.epages.WebServices.OrderDocumentService.Stub.TLineItemContainerOut lineItemContainer;

    /* list of requested attributes (see epagestypes:ListOfAttributes) */
    private de.epages.WebServices.OrderDocumentService.Stub.TAttribute[] attributes;
    ...
    public TGetInfo_Return(
           ...
           de.epages.WebServices.OrderDocumentService.Stub.TAddress address,
           de.epages.WebServices.OrderDocumentService.Stub.TAddress shopAddress,
           de.epages.WebServices.OrderDocumentService.Stub.TLineItemContainerOut lineItemContainer,
           de.epages.WebServices.OrderDocumentService.Stub.TAttribute[] attributes,
     ...
     * @return address
     */
    public de.epages.WebServices.OrderDocumentService.Stub.TAddress getAddress() {
        return address;
    }
     ...
     * @param address
     */
    public void setAddress(de.epages.WebServices.OrderDocumentService.Stub.TAddress address) {
        this.address = address;
    }
     ...
     * @return shopAddress
     */
    public de.epages.WebServices.OrderDocumentService.Stub.TAddress getShopAddress() {
        return shopAddress;
    }
     ...
     * @param shopAddress
     */
    public void setShopAddress(de.epages.WebServices.OrderDocumentService.Stub.TAddress shopAddress) {
        this.shopAddress = shopAddress;
    }
     ...
     * (see orderdocumenttypes:TLineItemContainerOut)
     */
    public de.epages.WebServices.OrderDocumentService.Stub.TLineItemContainerOut getLineItemContainer() {
     ...
     * (see orderdocumenttypes:TLineItemContainerOut)
     */
    public void setLineItemContainer(de.epages.WebServices.OrderDocumentService.Stub.TLineItemContainerOut lineItemContainer) {
        this.lineItemContainer = lineItemContainer;
    }
     ...
     */
    public de.epages.WebServices.OrderDocumentService.Stub.TAttribute[] getAttributes() {
        return attributes;
    }
     ...
     */
    public void setAttributes(de.epages.WebServices.OrderDocumentService.Stub.TAttribute[] attributes) {
        this.attributes = attributes;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/OrderDocumentTypes/2005/01", "TGetInfo_Return"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/OrderDocumentTypes/2005/01", "TLineItemContainerOut"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
