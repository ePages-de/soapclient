...
public class TCreate_Input  implements java.io.Serializable {
    ...
    private de.epages.WebServices.CustomerGroupService2.Stub.TLocalizedValue[] name;
    ...
    private de.epages.WebServices.CustomerGroupService2.Stub.TAttribute[] attributes;
    ...
    public TCreate_Input(
           ...
           de.epages.WebServices.CustomerGroupService2.Stub.TLocalizedValue[] name,
           java.lang.Boolean isNewMemberDefault,
           java.lang.Boolean isNonMemberDefault,
           de.epages.WebServices.CustomerGroupService2.Stub.TAttribute[] attributes) {
           this.alias = alias;
           this.name = name;
     ...
     */
    public de.epages.WebServices.CustomerGroupService2.Stub.TLocalizedValue[] getName() {
        return name;
    }
     ...
     */
    public void setName(de.epages.WebServices.CustomerGroupService2.Stub.TLocalizedValue[] name) {
        this.name = name;
    }


    /**
     * Gets the isNewMemberDefault value for this TCreate_Input.
     * 
    ...
    /**
     * Sets the isNewMemberDefault value for this TCreate_Input.
     * 
    ...
    /**
     * Gets the isNonMemberDefault value for this TCreate_Input.
     * 
    ...
    /**
     * Sets the isNonMemberDefault value for this TCreate_Input.
     * 
     ...
     */
    public de.epages.WebServices.CustomerGroupService2.Stub.TAttribute[] getAttributes() {
        return attributes;
    }
     ...
     */
    public void setAttributes(de.epages.WebServices.CustomerGroupService2.Stub.TAttribute[] attributes) {
        this.attributes = attributes;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/CustomerGroupTypes/2011/03", "TCreate_Input"));
