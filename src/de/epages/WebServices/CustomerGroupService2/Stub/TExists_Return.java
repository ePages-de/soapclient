...
public class TExists_Return  implements java.io.Serializable {
    ...
    /* a boolean flag indicating that this group exists */
    ...
    /**
     * Gets the alias value for this TExists_Return.
     * 
     * @return alias
     */
    ...
    /**
     * Sets the alias value for this TExists_Return.
     * 
     * @param alias
     */
     ...
     * 
     * @return exists   * a boolean flag indicating that this group exists
     */
     ...
     * 
     * @param exists   * a boolean flag indicating that this group exists
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/CustomerGroupTypes/2011/03", "TExists_Return"));
