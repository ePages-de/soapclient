...
public class CustomerServiceLocator extends org.apache.axis.client.Service implements de.epages.WebServices.CustomerService4.Stub.CustomerService {
 ...
 */
    ...
    public de.epages.WebServices.CustomerService4.Stub.Port_Customer_PortType getport_Customer() throws javax.xml.rpc.ServiceException {
    ...
    public de.epages.WebServices.CustomerService4.Stub.Port_Customer_PortType getport_Customer(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            de.epages.WebServices.CustomerService4.Stub.Bind_Customer_SOAPStub _stub = new de.epages.WebServices.CustomerService4.Stub.Bind_Customer_SOAPStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (de.epages.WebServices.CustomerService4.Stub.Port_Customer_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                de.epages.WebServices.CustomerService4.Stub.Bind_Customer_SOAPStub _stub = new de.epages.WebServices.CustomerService4.Stub.Bind_Customer_SOAPStub(new java.net.URL(port_Customer_address), this);
                _stub.setPortName(getport_CustomerWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("urn://epages.de/WebService/CustomerService/2011/01", "CustomerService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("urn://epages.de/WebService/CustomerService/2011/01", "port_Customer"));
        }
