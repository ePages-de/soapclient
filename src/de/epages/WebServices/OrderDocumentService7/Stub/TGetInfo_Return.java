...
public class TGetInfo_Return  implements java.io.Serializable {
    ...
    private de.epages.WebServices.OrderDocumentService7.Stub.TAddressNamed address;

    private de.epages.WebServices.OrderDocumentService7.Stub.TAddressNamed shopAddress;

    /* the products, payments, shipping etc. of this order document
     * (see orderdocumenttypes:TLineItemContainerOut) */
    private de.epages.WebServices.OrderDocumentService7.Stub.TLineItemContainerOut lineItemContainer;
    ...
    private de.epages.WebServices.OrderDocumentService7.Stub.TError error;
    ...
    public TGetInfo_Return(
           ...
           de.epages.WebServices.OrderDocumentService7.Stub.TAddressNamed address,
           de.epages.WebServices.OrderDocumentService7.Stub.TAddressNamed shopAddress,
           de.epages.WebServices.OrderDocumentService7.Stub.TLineItemContainerOut lineItemContainer,
           de.epages.WebServices.OrderDocumentService7.Stub.TAttribute[] attributes,
           de.epages.WebServices.OrderDocumentService7.Stub.TError error) {
           this.path = path;
           this.alias = alias;
           this._class = _class;
           this.order = order;
     ...
     * @return address
     */
    public de.epages.WebServices.OrderDocumentService7.Stub.TAddressNamed getAddress() {
        return address;
    }
     ...
     * @param address
     */
    public void setAddress(de.epages.WebServices.OrderDocumentService7.Stub.TAddressNamed address) {
        this.address = address;
    }
     ...
     * @return shopAddress
     */
    public de.epages.WebServices.OrderDocumentService7.Stub.TAddressNamed getShopAddress() {
        return shopAddress;
    }
     ...
     * @param shopAddress
     */
    public void setShopAddress(de.epages.WebServices.OrderDocumentService7.Stub.TAddressNamed shopAddress) {
        this.shopAddress = shopAddress;
    }
     ...
     * (see orderdocumenttypes:TLineItemContainerOut)
     */
    public de.epages.WebServices.OrderDocumentService7.Stub.TLineItemContainerOut getLineItemContainer() {
     ...
     * (see orderdocumenttypes:TLineItemContainerOut)
     */
    public void setLineItemContainer(de.epages.WebServices.OrderDocumentService7.Stub.TLineItemContainerOut lineItemContainer) {
        this.lineItemContainer = lineItemContainer;
    }
     ...
     */
    public de.epages.WebServices.OrderDocumentService7.Stub.TError getError() {
        return error;
    }
     ...
     */
    public void setError(de.epages.WebServices.OrderDocumentService7.Stub.TError error) {
        this.error = error;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/OrderDocumentTypes/2011/08", "TGetInfo_Return"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/OrderDocumentTypes/2011/08", "TLineItemContainerOut"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
