...
public class TLineItemContainerIn  implements java.io.Serializable {
    ...
    private de.epages.WebServices.OrderDocumentService7.Stub.TProductLineItemIn[] productLineItems;
    ...
    public TLineItemContainerIn(
           ...
           de.epages.WebServices.OrderDocumentService7.Stub.TProductLineItemIn[] productLineItems,
     ...
     */
    public de.epages.WebServices.OrderDocumentService7.Stub.TProductLineItemIn[] getProductLineItems() {
     ...
     */
    public void setProductLineItems(de.epages.WebServices.OrderDocumentService7.Stub.TProductLineItemIn[] productLineItems) {
        this.productLineItems = productLineItems;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/OrderDocumentTypes/2011/08", "TLineItemContainerIn"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/OrderDocumentTypes/2011/08", "TProductLineItemIn"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
