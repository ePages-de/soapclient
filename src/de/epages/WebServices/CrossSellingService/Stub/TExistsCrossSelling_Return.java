...
public class TExistsCrossSelling_Return  implements java.io.Serializable {
    ...
    private de.epages.WebServices.CrossSellingService.Stub.TError error;
    ...
    public TExistsCrossSelling_Return(
           ...
           de.epages.WebServices.CrossSellingService.Stub.TError error) {
     ...
     */
    public de.epages.WebServices.CrossSellingService.Stub.TError getError() {
        return error;
    }
     ...
     */
    public void setError(de.epages.WebServices.CrossSellingService.Stub.TError error) {
        this.error = error;
    }
