...
public class TGetList_Return  implements java.io.Serializable {
    ...
    private de.epages.WebServices.CustomerGroupService.Stub.TError error;
    ...
    public TGetList_Return(
           ...
           de.epages.WebServices.CustomerGroupService.Stub.TError error) {
           this.alias = alias;
           this.error = error;
    }
     ...
     */
    public de.epages.WebServices.CustomerGroupService.Stub.TError getError() {
        return error;
    }
     ...
     */
    public void setError(de.epages.WebServices.CustomerGroupService.Stub.TError error) {
        this.error = error;
    }
