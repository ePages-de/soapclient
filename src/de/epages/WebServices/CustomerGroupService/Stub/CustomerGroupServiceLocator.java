...
public class CustomerGroupServiceLocator extends org.apache.axis.client.Service implements de.epages.WebServices.CustomerGroupService.Stub.CustomerGroupService {
 ...
 */
    ...
    public de.epages.WebServices.CustomerGroupService.Stub.Port_CustomerGroup_PortType getport_CustomerGroup(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            de.epages.WebServices.CustomerGroupService.Stub.Bind_CustomerGroup_SOAPStub _stub = new de.epages.WebServices.CustomerGroupService.Stub.Bind_CustomerGroup_SOAPStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (de.epages.WebServices.CustomerGroupService.Stub.Port_CustomerGroup_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                de.epages.WebServices.CustomerGroupService.Stub.Bind_CustomerGroup_SOAPStub _stub = new de.epages.WebServices.CustomerGroupService.Stub.Bind_CustomerGroup_SOAPStub(new java.net.URL(port_CustomerGroup_address), this);
                _stub.setPortName(getport_CustomerGroupWSDDServiceName());
                return _stub;
            }
        }
