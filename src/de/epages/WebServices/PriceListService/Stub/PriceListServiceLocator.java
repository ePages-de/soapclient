...
public class PriceListServiceLocator extends org.apache.axis.client.Service implements de.epages.WebServices.PriceListService.Stub.PriceListService {
 ...
 */
    ...
    public de.epages.WebServices.PriceListService.Stub.Port_PriceList_PortType getport_PriceList(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            de.epages.WebServices.PriceListService.Stub.Bind_PriceList_SOAPStub _stub = new de.epages.WebServices.PriceListService.Stub.Bind_PriceList_SOAPStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (de.epages.WebServices.PriceListService.Stub.Port_PriceList_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                de.epages.WebServices.PriceListService.Stub.Bind_PriceList_SOAPStub _stub = new de.epages.WebServices.PriceListService.Stub.Bind_PriceList_SOAPStub(new java.net.URL(port_PriceList_address), this);
                _stub.setPortName(getport_PriceListWSDDServiceName());
                return _stub;
            }
        }
