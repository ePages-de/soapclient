...
public class TCreate_Input  implements java.io.Serializable {
    ...
    private de.epages.WebServices.UserService5.Stub.TAddressNamed billingAddress;

    /* user's shipping address */
    private de.epages.WebServices.UserService5.Stub.TAddressNamed shippingAddress;

    /* all user's shipping addresses identified by alias */
    private de.epages.WebServices.UserService5.Stub.TAddressNamed[] additionalAddresses;
    ...
    private de.epages.WebServices.UserService5.Stub.TAttribute[] attributes;
    ...
    public TCreate_Input(
           ...
           de.epages.WebServices.UserService5.Stub.TAddressNamed billingAddress,
           de.epages.WebServices.UserService5.Stub.TAddressNamed shippingAddress,
           de.epages.WebServices.UserService5.Stub.TAddressNamed[] additionalAddresses,
           java.lang.String[] customers,
           de.epages.WebServices.UserService5.Stub.TAttribute[] attributes) {
           this.alias = alias;
     ...
     */
    public de.epages.WebServices.UserService5.Stub.TAddressNamed getBillingAddress() {
     ...
     */
    public void setBillingAddress(de.epages.WebServices.UserService5.Stub.TAddressNamed billingAddress) {
        this.billingAddress = billingAddress;
    }
     ...
     */
    public de.epages.WebServices.UserService5.Stub.TAddressNamed getShippingAddress() {
     ...
     */
    public void setShippingAddress(de.epages.WebServices.UserService5.Stub.TAddressNamed shippingAddress) {
        this.shippingAddress = shippingAddress;
    }
     ...
     */
    public de.epages.WebServices.UserService5.Stub.TAddressNamed[] getAdditionalAddresses() {
     ...
     */
    public void setAdditionalAddresses(de.epages.WebServices.UserService5.Stub.TAddressNamed[] additionalAddresses) {
        this.additionalAddresses = additionalAddresses;
    }
     ...
     */
    public de.epages.WebServices.UserService5.Stub.TAttribute[] getAttributes() {
        return attributes;
    }
     ...
     */
    public void setAttributes(de.epages.WebServices.UserService5.Stub.TAttribute[] attributes) {
        this.attributes = attributes;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/UserTypes/2011/03", "TCreate_Input"));
