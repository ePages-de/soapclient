...
public class UserServiceLocator extends org.apache.axis.client.Service implements de.epages.WebServices.UserService5.Stub.UserService {
 ...
 */
    ...
    public de.epages.WebServices.UserService5.Stub.Port_User_PortType getport_User(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            de.epages.WebServices.UserService5.Stub.Bind_User_SOAPStub _stub = new de.epages.WebServices.UserService5.Stub.Bind_User_SOAPStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (de.epages.WebServices.UserService5.Stub.Port_User_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                de.epages.WebServices.UserService5.Stub.Bind_User_SOAPStub _stub = new de.epages.WebServices.UserService5.Stub.Bind_User_SOAPStub(new java.net.URL(port_User_address), this);
                _stub.setPortName(getport_UserWSDDServiceName());
                return _stub;
            }
        }
