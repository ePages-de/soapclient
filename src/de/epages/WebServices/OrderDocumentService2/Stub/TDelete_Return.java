...
public class TDelete_Return  implements java.io.Serializable {
    ...
    /* a boolean flag indicating whether or not this order document
     * has been deleted */
     ...
     * 
     * @return deleted   * a boolean flag indicating whether or not this order document
     * has been deleted
     */
     ...
     * 
     * @param deleted   * a boolean flag indicating whether or not this order document
     * has been deleted
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/OrderDocumentTypes/2006/07", "TDelete_Return"));
