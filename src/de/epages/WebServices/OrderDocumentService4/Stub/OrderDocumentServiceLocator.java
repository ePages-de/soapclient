...
public class OrderDocumentServiceLocator extends org.apache.axis.client.Service implements de.epages.WebServices.OrderDocumentService4.Stub.OrderDocumentService {
 ...
 */
    ...
    public de.epages.WebServices.OrderDocumentService4.Stub.Port_OrderDocument_PortType getport_OrderDocument() throws javax.xml.rpc.ServiceException {
    ...
    public de.epages.WebServices.OrderDocumentService4.Stub.Port_OrderDocument_PortType getport_OrderDocument(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            de.epages.WebServices.OrderDocumentService4.Stub.Bind_OrderDocument_SOAPStub _stub = new de.epages.WebServices.OrderDocumentService4.Stub.Bind_OrderDocument_SOAPStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (de.epages.WebServices.OrderDocumentService4.Stub.Port_OrderDocument_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                de.epages.WebServices.OrderDocumentService4.Stub.Bind_OrderDocument_SOAPStub _stub = new de.epages.WebServices.OrderDocumentService4.Stub.Bind_OrderDocument_SOAPStub(new java.net.URL(port_OrderDocument_address), this);
                _stub.setPortName(getport_OrderDocumentWSDDServiceName());
                return _stub;
            }
        }
