...
public class TGetList_Return  implements java.io.Serializable {
     ...
     * 
     * @return path   * object path of the tax area
     */
     ...
     * 
     * @param path   * object path of the tax area
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/TaxAreaTypes/2006/07", "TGetList_Return"));
