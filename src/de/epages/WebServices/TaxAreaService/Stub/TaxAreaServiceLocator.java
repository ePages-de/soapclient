...
public class TaxAreaServiceLocator extends org.apache.axis.client.Service implements de.epages.WebServices.TaxAreaService.Stub.TaxAreaService {

/**
 * epages5 Tax Area Service
 */
    ...
    public de.epages.WebServices.TaxAreaService.Stub.Port_TaxArea_PortType getport_TaxArea() throws javax.xml.rpc.ServiceException {
    ...
    public de.epages.WebServices.TaxAreaService.Stub.Port_TaxArea_PortType getport_TaxArea(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            de.epages.WebServices.TaxAreaService.Stub.Bind_TaxArea_SOAPStub _stub = new de.epages.WebServices.TaxAreaService.Stub.Bind_TaxArea_SOAPStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (de.epages.WebServices.TaxAreaService.Stub.Port_TaxArea_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                de.epages.WebServices.TaxAreaService.Stub.Bind_TaxArea_SOAPStub _stub = new de.epages.WebServices.TaxAreaService.Stub.Bind_TaxArea_SOAPStub(new java.net.URL(port_TaxArea_address), this);
                _stub.setPortName(getport_TaxAreaWSDDServiceName());
                return _stub;
            }
        }
