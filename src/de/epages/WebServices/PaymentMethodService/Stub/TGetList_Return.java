...
public class TGetList_Return  implements java.io.Serializable {
    /* object path of the payment method */
     ...
     * 
     * @return path   * object path of the payment method
     */
     ...
     * 
     * @param path   * object path of the payment method
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/PaymentMethodTypes/2008/03", "TGetList_Return"));
