...
public class TGetPreDefAttributeInfo_Return  implements java.io.Serializable {
    ...
    /* the predefined attribute value in case it's product attribute
     * is localizable */
    private de.epages.WebServices.ProductTypeService.Stub.TLocalizedValue[] valueLocString;
    ...
    public TGetPreDefAttributeInfo_Return(
           ...
           de.epages.WebServices.ProductTypeService.Stub.TLocalizedValue[] valueLocString,
     ...
     * is localizable
     */
    public de.epages.WebServices.ProductTypeService.Stub.TLocalizedValue[] getValueLocString() {
     ...
     * is localizable
     */
    public void setValueLocString(de.epages.WebServices.ProductTypeService.Stub.TLocalizedValue[] valueLocString) {
        this.valueLocString = valueLocString;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/ProductTypeTypes/2007/10", "TGetPreDefAttributeInfo_Return"));
