...
public class TGetInfo_Return  implements java.io.Serializable {
    ...
    private de.epages.WebServices.CatalogService.Stub.TLocalizedValue[] name;

    /* localized text of catalog (see epagestypes:TLocalizedValue) */
    private de.epages.WebServices.CatalogService.Stub.TLocalizedValue[] text;
    ...
    private de.epages.WebServices.CatalogService.Stub.TAttribute[] attributes;

    /* error object (see epagestypes:TError) */
    private de.epages.WebServices.CatalogService.Stub.TError error;
    ...
    public TGetInfo_Return(
           ...
           de.epages.WebServices.CatalogService.Stub.TLocalizedValue[] name,
           de.epages.WebServices.CatalogService.Stub.TLocalizedValue[] text,
           java.lang.String[] subCatalogs,
           de.epages.WebServices.CatalogService.Stub.TAttribute[] attributes,
           de.epages.WebServices.CatalogService.Stub.TError error) {
           this.path = path;
           this.alias = alias;
           this._class = _class;
     ...
     */
    public de.epages.WebServices.CatalogService.Stub.TLocalizedValue[] getName() {
        return name;
    }
     ...
     */
    public void setName(de.epages.WebServices.CatalogService.Stub.TLocalizedValue[] name) {
        this.name = name;
    }
     ...
     */
    public de.epages.WebServices.CatalogService.Stub.TLocalizedValue[] getText() {
        return text;
    }
     ...
     */
    public void setText(de.epages.WebServices.CatalogService.Stub.TLocalizedValue[] text) {
        this.text = text;
    }
     ...
     */
    public de.epages.WebServices.CatalogService.Stub.TAttribute[] getAttributes() {
        return attributes;
    }
     ...
     */
    public void setAttributes(de.epages.WebServices.CatalogService.Stub.TAttribute[] attributes) {
        this.attributes = attributes;
    }
     ...
     */
    public de.epages.WebServices.CatalogService.Stub.TError getError() {
        return error;
    }
     ...
     */
    public void setError(de.epages.WebServices.CatalogService.Stub.TError error) {
        this.error = error;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/CatalogTypes/2005/01", "TGetInfo_Return"));
