...
public class CatalogServiceLocator extends org.apache.axis.client.Service implements de.epages.WebServices.CatalogService.Stub.CatalogService {
 ...
 */
    ...
    public de.epages.WebServices.CatalogService.Stub.Port_Catalog_PortType getport_Catalog(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            de.epages.WebServices.CatalogService.Stub.Bind_Catalog_SOAPStub _stub = new de.epages.WebServices.CatalogService.Stub.Bind_Catalog_SOAPStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (de.epages.WebServices.CatalogService.Stub.Port_Catalog_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                de.epages.WebServices.CatalogService.Stub.Bind_Catalog_SOAPStub _stub = new de.epages.WebServices.CatalogService.Stub.Bind_Catalog_SOAPStub(new java.net.URL(port_Catalog_address), this);
                _stub.setPortName(getport_CatalogWSDDServiceName());
                return _stub;
            }
        }
