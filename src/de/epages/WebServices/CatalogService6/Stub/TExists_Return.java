...
public class TExists_Return  implements java.io.Serializable {
    ...
    /* a boolean flag indicating whether or not this catalog exists */
     ...
     * 
     * @return exists   * a boolean flag indicating whether or not this catalog exists
     */
     ...
     * 
     * @param exists   * a boolean flag indicating whether or not this catalog exists
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/CatalogTypes/2011/03", "TExists_Return"));
