...
public class TUpload_Input  implements java.io.Serializable {
    ...
    private de.epages.WebServices.CatalogService6.Stub.TImageData[] imageData;

    public TUpload_Input() {
    }

    public TUpload_Input(
           de.epages.WebServices.CatalogService6.Stub.TImageData[] imageData) {
     ...
     */
    public de.epages.WebServices.CatalogService6.Stub.TImageData[] getImageData() {
        return imageData;
    }
     ...
     */
    public void setImageData(de.epages.WebServices.CatalogService6.Stub.TImageData[] imageData) {
        this.imageData = imageData;
    }
