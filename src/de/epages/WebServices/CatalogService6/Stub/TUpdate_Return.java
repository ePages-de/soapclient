...
public class TUpdate_Return  implements java.io.Serializable {
    /* path of category as it was passed, or absolute path if parent
     * has been changed */
    private java.lang.String path;

    /* a boolean flag indicating whether or not this catalog was updated */
     ...
     * 
     * @return path   * path of category as it was passed, or absolute path if parent
     * has been changed
     */
     ...
     * 
     * @param path   * path of category as it was passed, or absolute path if parent
     * has been changed
     */
     ...
     * 
     * @return updated   * a boolean flag indicating whether or not this catalog was updated
     */
     ...
     * 
     * @param updated   * a boolean flag indicating whether or not this catalog was updated
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/CatalogTypes/2011/03", "TUpdate_Return"));
