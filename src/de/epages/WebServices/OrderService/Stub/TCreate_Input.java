...
public class TCreate_Input  implements java.io.Serializable {
    ...
    private de.epages.WebServices.OrderService.Stub.TLineItemContainerIn lineItemContainer;

    private de.epages.WebServices.OrderService.Stub.TAddress billingAddress;

    private de.epages.WebServices.OrderService.Stub.TAddress shippingAddress;

    /* list of requested attributes (see epagestypes:ListOfAttributes) */
    private de.epages.WebServices.OrderService.Stub.TAttribute[] attributes;
    ...
    public TCreate_Input(
           ...
           de.epages.WebServices.OrderService.Stub.TLineItemContainerIn lineItemContainer,
           de.epages.WebServices.OrderService.Stub.TAddress billingAddress,
           de.epages.WebServices.OrderService.Stub.TAddress shippingAddress,
           de.epages.WebServices.OrderService.Stub.TAttribute[] attributes) {
           this.alias = alias;
     ...
     */
    public de.epages.WebServices.OrderService.Stub.TLineItemContainerIn getLineItemContainer() {
     ...
     */
    public void setLineItemContainer(de.epages.WebServices.OrderService.Stub.TLineItemContainerIn lineItemContainer) {
        this.lineItemContainer = lineItemContainer;
    }
     ...
     */
    public de.epages.WebServices.OrderService.Stub.TAddress getBillingAddress() {
        return billingAddress;
    }
     ...
     */
    public void setBillingAddress(de.epages.WebServices.OrderService.Stub.TAddress billingAddress) {
        this.billingAddress = billingAddress;
    }
     ...
     */
    public de.epages.WebServices.OrderService.Stub.TAddress getShippingAddress() {
        return shippingAddress;
    }
     ...
     */
    public void setShippingAddress(de.epages.WebServices.OrderService.Stub.TAddress shippingAddress) {
        this.shippingAddress = shippingAddress;
    }
     ...
     */
    public de.epages.WebServices.OrderService.Stub.TAttribute[] getAttributes() {
        return attributes;
    }
     ...
     */
    public void setAttributes(de.epages.WebServices.OrderService.Stub.TAttribute[] attributes) {
        this.attributes = attributes;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/OrderTypes/2005/01", "TCreate_Input"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/OrderTypes/2005/01", "TLineItemContainerIn"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
