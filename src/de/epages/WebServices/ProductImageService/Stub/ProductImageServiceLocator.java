...
public class ProductImageServiceLocator extends org.apache.axis.client.Service implements de.epages.WebServices.ProductImageService.Stub.ProductImageService {

/**
 * epages5 Product Image Service
 */
    ...
    public de.epages.WebServices.ProductImageService.Stub.Port_ProductImage_PortType getport_ProductImage() throws javax.xml.rpc.ServiceException {
    ...
    public de.epages.WebServices.ProductImageService.Stub.Port_ProductImage_PortType getport_ProductImage(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            de.epages.WebServices.ProductImageService.Stub.Bind_ProductImage_SOAPStub _stub = new de.epages.WebServices.ProductImageService.Stub.Bind_ProductImage_SOAPStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (de.epages.WebServices.ProductImageService.Stub.Port_ProductImage_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                de.epages.WebServices.ProductImageService.Stub.Bind_ProductImage_SOAPStub _stub = new de.epages.WebServices.ProductImageService.Stub.Bind_ProductImage_SOAPStub(new java.net.URL(port_ProductImage_address), this);
                _stub.setPortName(getport_ProductImageWSDDServiceName());
                return _stub;
            }
        }
