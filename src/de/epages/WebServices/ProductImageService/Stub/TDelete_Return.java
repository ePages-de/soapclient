...
public class TDelete_Return  implements java.io.Serializable {
    ...
    /* a boolean flag indicating that this product image was deleted */
    private java.lang.Boolean deleted;

    /* error object (see epagestypes:TError) */
    private de.epages.WebServices.ProductImageService.Stub.TError error;
    ...
    public TDelete_Return(
           ...
           de.epages.WebServices.ProductImageService.Stub.TError error) {
           this.path = path;
     ...
     * 
     * @return deleted   * a boolean flag indicating that this product image was deleted
     */
     ...
     * 
     * @param deleted   * a boolean flag indicating that this product image was deleted
     */
     ...
     */
    public de.epages.WebServices.ProductImageService.Stub.TError getError() {
        return error;
    }
     ...
     */
    public void setError(de.epages.WebServices.ProductImageService.Stub.TError error) {
        this.error = error;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/ProductImageTypes/2006/03", "TDelete_Return"));
