...
public class TGetInfo_Return  implements java.io.Serializable {
    ...
    private de.epages.WebServices.OrderDocumentService3.Stub.TAddressNamed address;

    private de.epages.WebServices.OrderDocumentService3.Stub.TAddressNamed shopAddress;

    /* the products, payments, shipping etc. of this order document
     * (see orderdocumenttypes:TLineItemContainerOut) */
    private de.epages.WebServices.OrderDocumentService3.Stub.TLineItemContainerOut lineItemContainer;

    /* list of requested attributes (see epagestypes:ListOfAttributes) */
    private de.epages.WebServices.OrderDocumentService3.Stub.TAttribute[] attributes;

    /* error object (see epagestypes:TError) */
    private de.epages.WebServices.OrderDocumentService3.Stub.TError error;
    ...
    public TGetInfo_Return(
           ...
           de.epages.WebServices.OrderDocumentService3.Stub.TAddressNamed address,
           de.epages.WebServices.OrderDocumentService3.Stub.TAddressNamed shopAddress,
           de.epages.WebServices.OrderDocumentService3.Stub.TLineItemContainerOut lineItemContainer,
           de.epages.WebServices.OrderDocumentService3.Stub.TAttribute[] attributes,
           de.epages.WebServices.OrderDocumentService3.Stub.TError error) {
           this.path = path;
           this.alias = alias;
           this._class = _class;
           this.order = order;
     ...
     * @return address
     */
    public de.epages.WebServices.OrderDocumentService3.Stub.TAddressNamed getAddress() {
        return address;
    }
     ...
     * @param address
     */
    public void setAddress(de.epages.WebServices.OrderDocumentService3.Stub.TAddressNamed address) {
        this.address = address;
    }
     ...
     * @return shopAddress
     */
    public de.epages.WebServices.OrderDocumentService3.Stub.TAddressNamed getShopAddress() {
        return shopAddress;
    }
     ...
     * @param shopAddress
     */
    public void setShopAddress(de.epages.WebServices.OrderDocumentService3.Stub.TAddressNamed shopAddress) {
        this.shopAddress = shopAddress;
    }
     ...
     * (see orderdocumenttypes:TLineItemContainerOut)
     */
    public de.epages.WebServices.OrderDocumentService3.Stub.TLineItemContainerOut getLineItemContainer() {
     ...
     * (see orderdocumenttypes:TLineItemContainerOut)
     */
    public void setLineItemContainer(de.epages.WebServices.OrderDocumentService3.Stub.TLineItemContainerOut lineItemContainer) {
        this.lineItemContainer = lineItemContainer;
    }
     ...
     */
    public de.epages.WebServices.OrderDocumentService3.Stub.TAttribute[] getAttributes() {
        return attributes;
    }
     ...
     */
    public void setAttributes(de.epages.WebServices.OrderDocumentService3.Stub.TAttribute[] attributes) {
        this.attributes = attributes;
    }
     ...
     */
    public de.epages.WebServices.OrderDocumentService3.Stub.TError getError() {
        return error;
    }
     ...
     */
    public void setError(de.epages.WebServices.OrderDocumentService3.Stub.TError error) {
        this.error = error;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/OrderDocumentTypes/2007/08", "TGetInfo_Return"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/OrderDocumentTypes/2007/08", "TLineItemContainerOut"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
