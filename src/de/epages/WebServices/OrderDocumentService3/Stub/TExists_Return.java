...
public class TExists_Return  implements java.io.Serializable {
     ...
     * 
     * @return exists   * a boolean flag indicating whether or not this order document
     * exists
     */
     ...
     * 
     * @param exists   * a boolean flag indicating whether or not this order document
     * exists
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/OrderDocumentTypes/2007/08", "TExists_Return"));
