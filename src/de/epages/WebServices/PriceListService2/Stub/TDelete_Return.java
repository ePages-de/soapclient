...
public class TDelete_Return  implements java.io.Serializable {
    ...
    /* a boolean flag indicating that this pricelist was deleted */
     ...
     * 
     * @return deleted   * a boolean flag indicating that this pricelist was deleted
     */
     ...
     * 
     * @param deleted   * a boolean flag indicating that this pricelist was deleted
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/PriceListTypes/2010/08", "TDelete_Return"));
