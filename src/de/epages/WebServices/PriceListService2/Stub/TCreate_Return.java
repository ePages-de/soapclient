...
public class TCreate_Return  implements java.io.Serializable {
    ...
    /* a boolean flag indicating that this pricelist was created */
     ...
     * 
     * @return created   * a boolean flag indicating that this pricelist was created
     */
     ...
     * 
     * @param created   * a boolean flag indicating that this pricelist was created
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/PriceListTypes/2010/08", "TCreate_Return"));
