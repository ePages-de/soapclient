...
public class TCreate_Input  implements java.io.Serializable {
    ...
    private de.epages.WebServices.OrderService4.Stub.TLineItemContainerIn lineItemContainer;

    private de.epages.WebServices.OrderService4.Stub.TAddressNamed billingAddress;

    private de.epages.WebServices.OrderService4.Stub.TAddressNamed shippingAddress;

    /* list of requested attributes (see epagestypes:ListOfAttributes) */
    private de.epages.WebServices.OrderService4.Stub.TAttribute[] attributes;
    ...
    public TCreate_Input(
           ...
           de.epages.WebServices.OrderService4.Stub.TLineItemContainerIn lineItemContainer,
           de.epages.WebServices.OrderService4.Stub.TAddressNamed billingAddress,
           de.epages.WebServices.OrderService4.Stub.TAddressNamed shippingAddress,
           de.epages.WebServices.OrderService4.Stub.TAttribute[] attributes) {
           this.alias = alias;
     ...
     */
    public de.epages.WebServices.OrderService4.Stub.TLineItemContainerIn getLineItemContainer() {
     ...
     */
    public void setLineItemContainer(de.epages.WebServices.OrderService4.Stub.TLineItemContainerIn lineItemContainer) {
        this.lineItemContainer = lineItemContainer;
    }
     ...
     */
    public de.epages.WebServices.OrderService4.Stub.TAddressNamed getBillingAddress() {
        return billingAddress;
    }
     ...
     */
    public void setBillingAddress(de.epages.WebServices.OrderService4.Stub.TAddressNamed billingAddress) {
        this.billingAddress = billingAddress;
    }
     ...
     */
    public de.epages.WebServices.OrderService4.Stub.TAddressNamed getShippingAddress() {
        return shippingAddress;
    }
     ...
     */
    public void setShippingAddress(de.epages.WebServices.OrderService4.Stub.TAddressNamed shippingAddress) {
        this.shippingAddress = shippingAddress;
    }
     ...
     */
    public de.epages.WebServices.OrderService4.Stub.TAttribute[] getAttributes() {
        return attributes;
    }
     ...
     */
    public void setAttributes(de.epages.WebServices.OrderService4.Stub.TAttribute[] attributes) {
        this.attributes = attributes;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/OrderTypes/2008/05", "TCreate_Input"));
