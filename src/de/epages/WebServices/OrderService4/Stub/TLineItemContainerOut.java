...
public class TLineItemContainerOut  implements java.io.Serializable {
    ...
    private de.epages.WebServices.OrderService4.Stub.TProductLineItemOut[] productLineItems;

    /* the container's tax line items */
    private de.epages.WebServices.OrderService4.Stub.TTaxLineItem[] taxLineItems;

    /* the container's payment line item */
    private de.epages.WebServices.OrderService4.Stub.TPaymentLineItem paymentLineItem;

    /* the container's shipping line item */
    private de.epages.WebServices.OrderService4.Stub.TShippingLineItem shippingLineItem;

    /* the container's coupon line items */
    private de.epages.WebServices.OrderService4.Stub.TCouponLineItem[] couponLineItems;

    /* the container's shipping option line items */
    private de.epages.WebServices.OrderService4.Stub.TShippingOptionLineItem[] shippingOptionLineItems;

    /* the container's basket discount line items */
    private de.epages.WebServices.OrderService4.Stub.TGlobalValueDiscountLineItem[] globalValueDiscountLineItems;
    ...
    public TLineItemContainerOut(
           ...
           float totalTax,
           de.epages.WebServices.OrderService4.Stub.TProductLineItemOut[] productLineItems,
           de.epages.WebServices.OrderService4.Stub.TTaxLineItem[] taxLineItems,
           de.epages.WebServices.OrderService4.Stub.TPaymentLineItem paymentLineItem,
           de.epages.WebServices.OrderService4.Stub.TShippingLineItem shippingLineItem,
           de.epages.WebServices.OrderService4.Stub.TCouponLineItem[] couponLineItems,
           de.epages.WebServices.OrderService4.Stub.TShippingOptionLineItem[] shippingOptionLineItems,
           de.epages.WebServices.OrderService4.Stub.TGlobalValueDiscountLineItem[] globalValueDiscountLineItems) {
     ...
     */
    public de.epages.WebServices.OrderService4.Stub.TProductLineItemOut[] getProductLineItems() {
     ...
     */
    public void setProductLineItems(de.epages.WebServices.OrderService4.Stub.TProductLineItemOut[] productLineItems) {
        this.productLineItems = productLineItems;
    }
     ...
     */
    public de.epages.WebServices.OrderService4.Stub.TTaxLineItem[] getTaxLineItems() {
        return taxLineItems;
    }
     ...
     */
    public void setTaxLineItems(de.epages.WebServices.OrderService4.Stub.TTaxLineItem[] taxLineItems) {
        this.taxLineItems = taxLineItems;
    }
     ...
     */
    public de.epages.WebServices.OrderService4.Stub.TPaymentLineItem getPaymentLineItem() {
     ...
     */
    public void setPaymentLineItem(de.epages.WebServices.OrderService4.Stub.TPaymentLineItem paymentLineItem) {
        this.paymentLineItem = paymentLineItem;
    }
     ...
     */
    public de.epages.WebServices.OrderService4.Stub.TShippingLineItem getShippingLineItem() {
     ...
     */
    public void setShippingLineItem(de.epages.WebServices.OrderService4.Stub.TShippingLineItem shippingLineItem) {
        this.shippingLineItem = shippingLineItem;
    }
     ...
     */
    public de.epages.WebServices.OrderService4.Stub.TCouponLineItem[] getCouponLineItems() {
     ...
     */
    public void setCouponLineItems(de.epages.WebServices.OrderService4.Stub.TCouponLineItem[] couponLineItems) {
        this.couponLineItems = couponLineItems;
    }
     ...
     */
    public de.epages.WebServices.OrderService4.Stub.TShippingOptionLineItem[] getShippingOptionLineItems() {
     ...
     */
    public void setShippingOptionLineItems(de.epages.WebServices.OrderService4.Stub.TShippingOptionLineItem[] shippingOptionLineItems) {
        this.shippingOptionLineItems = shippingOptionLineItems;
    }
     ...
     */
    public de.epages.WebServices.OrderService4.Stub.TGlobalValueDiscountLineItem[] getGlobalValueDiscountLineItems() {
     ...
     */
    public void setGlobalValueDiscountLineItems(de.epages.WebServices.OrderService4.Stub.TGlobalValueDiscountLineItem[] globalValueDiscountLineItems) {
        this.globalValueDiscountLineItems = globalValueDiscountLineItems;
    }
