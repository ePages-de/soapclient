...
public class TGetInfoList_Return  implements java.io.Serializable {
    ...
    private de.epages.WebServices.ProductAttributeService2.Stub.TLocalizedValue[] name;

    private de.epages.WebServices.ProductAttributeService2.Stub.TLocalizedValue[] description;
    ...
    private de.epages.WebServices.ProductAttributeService2.Stub.TLocalizedValue[] productTypeName;

    private de.epages.WebServices.ProductAttributeService2.Stub.TPreDefAttribute[] preDefAttributes;

    /* error object (see epagestypes:TError) */
    private de.epages.WebServices.ProductAttributeService2.Stub.TError error;
    ...
    public TGetInfoList_Return(
           ...
           de.epages.WebServices.ProductAttributeService2.Stub.TLocalizedValue[] name,
           de.epages.WebServices.ProductAttributeService2.Stub.TLocalizedValue[] description,
           ...
           de.epages.WebServices.ProductAttributeService2.Stub.TLocalizedValue[] productTypeName,
           de.epages.WebServices.ProductAttributeService2.Stub.TPreDefAttribute[] preDefAttributes,
           de.epages.WebServices.ProductAttributeService2.Stub.TError error) {
           this.alias = alias;
           this.name = name;
     ...
     * @return name
     */
    public de.epages.WebServices.ProductAttributeService2.Stub.TLocalizedValue[] getName() {
        return name;
    }
     ...
     * @param name
     */
    public void setName(de.epages.WebServices.ProductAttributeService2.Stub.TLocalizedValue[] name) {
        this.name = name;
    }
     ...
     * @return description
     */
    public de.epages.WebServices.ProductAttributeService2.Stub.TLocalizedValue[] getDescription() {
        return description;
    }
     ...
     * @param description
     */
    public void setDescription(de.epages.WebServices.ProductAttributeService2.Stub.TLocalizedValue[] description) {
        this.description = description;
    }
     ...
     */
    public de.epages.WebServices.ProductAttributeService2.Stub.TLocalizedValue[] getProductTypeName() {
        return productTypeName;
    }
     ...
     */
    public void setProductTypeName(de.epages.WebServices.ProductAttributeService2.Stub.TLocalizedValue[] productTypeName) {
        this.productTypeName = productTypeName;
    }
     ...
     */
    public de.epages.WebServices.ProductAttributeService2.Stub.TPreDefAttribute[] getPreDefAttributes() {
        return preDefAttributes;
    }
     ...
     */
    public void setPreDefAttributes(de.epages.WebServices.ProductAttributeService2.Stub.TPreDefAttribute[] preDefAttributes) {
        this.preDefAttributes = preDefAttributes;
    }
     ...
     */
    public de.epages.WebServices.ProductAttributeService2.Stub.TError getError() {
        return error;
    }
     ...
     */
    public void setError(de.epages.WebServices.ProductAttributeService2.Stub.TError error) {
        this.error = error;
    }
