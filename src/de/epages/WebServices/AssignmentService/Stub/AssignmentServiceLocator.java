...
public class AssignmentServiceLocator extends org.apache.axis.client.Service implements de.epages.WebServices.AssignmentService.Stub.AssignmentService {
 ...
 */
    ...
    public de.epages.WebServices.AssignmentService.Stub.Port_Assignment_PortType getport_Assignment(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            de.epages.WebServices.AssignmentService.Stub.Bind_Assignment_SOAPStub _stub = new de.epages.WebServices.AssignmentService.Stub.Bind_Assignment_SOAPStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (de.epages.WebServices.AssignmentService.Stub.Port_Assignment_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                de.epages.WebServices.AssignmentService.Stub.Bind_Assignment_SOAPStub _stub = new de.epages.WebServices.AssignmentService.Stub.Bind_Assignment_SOAPStub(new java.net.URL(port_Assignment_address), this);
                _stub.setPortName(getport_AssignmentWSDDServiceName());
                return _stub;
            }
        }
