...
public class ProductBundleServiceLocator extends org.apache.axis.client.Service implements de.epages.WebServices.ProductBundleService.Stub.ProductBundleService {
 ...
 */
    ...
    public de.epages.WebServices.ProductBundleService.Stub.Port_ProductBundle_PortType getport_ProductBundle() throws javax.xml.rpc.ServiceException {
    ...
    public de.epages.WebServices.ProductBundleService.Stub.Port_ProductBundle_PortType getport_ProductBundle(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            de.epages.WebServices.ProductBundleService.Stub.Bind_ProductBundle_SOAPStub _stub = new de.epages.WebServices.ProductBundleService.Stub.Bind_ProductBundle_SOAPStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (de.epages.WebServices.ProductBundleService.Stub.Port_ProductBundle_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                de.epages.WebServices.ProductBundleService.Stub.Bind_ProductBundle_SOAPStub _stub = new de.epages.WebServices.ProductBundleService.Stub.Bind_ProductBundle_SOAPStub(new java.net.URL(port_ProductBundle_address), this);
                _stub.setPortName(getport_ProductBundleWSDDServiceName());
                return _stub;
            }
        }
