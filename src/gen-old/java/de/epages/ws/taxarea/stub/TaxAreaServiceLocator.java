...
public class TaxAreaServiceLocator extends org.apache.axis.client.Service implements de.epages.ws.taxarea.stub.TaxAreaService {
 ...
 */
    ...
    public de.epages.ws.taxarea.stub.Port_TaxArea getport_TaxArea() throws javax.xml.rpc.ServiceException {
    ...
    public de.epages.ws.taxarea.stub.Port_TaxArea getport_TaxArea(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            de.epages.ws.taxarea.stub.Bind_TaxArea_SOAPStub _stub = new de.epages.ws.taxarea.stub.Bind_TaxArea_SOAPStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (de.epages.ws.taxarea.stub.Port_TaxArea.class.isAssignableFrom(serviceEndpointInterface)) {
                de.epages.ws.taxarea.stub.Bind_TaxArea_SOAPStub _stub = new de.epages.ws.taxarea.stub.Bind_TaxArea_SOAPStub(new java.net.URL(port_TaxArea_address), this);
                _stub.setPortName(getport_TaxAreaWSDDServiceName());
                return _stub;
            }
        }
