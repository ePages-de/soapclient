...
public class CrossSellingServiceLocator extends org.apache.axis.client.Service implements de.epages.ws.crossselling2.stub.CrossSellingService {
 ...
 */
    ...
    public de.epages.ws.crossselling2.stub.Port_CrossSelling getport_CrossSelling(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            de.epages.ws.crossselling2.stub.Bind_CrossSelling_SOAPStub _stub = new de.epages.ws.crossselling2.stub.Bind_CrossSelling_SOAPStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (de.epages.ws.crossselling2.stub.Port_CrossSelling.class.isAssignableFrom(serviceEndpointInterface)) {
                de.epages.ws.crossselling2.stub.Bind_CrossSelling_SOAPStub _stub = new de.epages.ws.crossselling2.stub.Bind_CrossSelling_SOAPStub(new java.net.URL(port_CrossSelling_address), this);
                _stub.setPortName(getport_CrossSellingWSDDServiceName());
                return _stub;
            }
        }
