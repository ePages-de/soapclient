...
public class TLineItemContainerIn  implements java.io.Serializable {
    ...
    private de.epages.ws.order3.model.TProductLineItemIn[] productLineItems;
    ...
    public TLineItemContainerIn(
           ...
           de.epages.ws.order3.model.TProductLineItemIn[] productLineItems,
     ...
     */
    public de.epages.ws.order3.model.TProductLineItemIn[] getProductLineItems() {
     ...
     */
    public void setProductLineItems(de.epages.ws.order3.model.TProductLineItemIn[] productLineItems) {
        this.productLineItems = productLineItems;
    }
