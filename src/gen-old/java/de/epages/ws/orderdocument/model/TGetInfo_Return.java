...
public class TGetInfo_Return  implements java.io.Serializable {
    ...
    private de.epages.ws.shop.model.TAddress address;

    private de.epages.ws.shop.model.TAddress shopAddress;

    /* the products, payments, shipping etc. of this order document
     * (see orderdocumenttypes:TLineItemContainerOut) */
    private de.epages.ws.orderdocument.model.TLineItemContainerOut lineItemContainer;
    ...
    public TGetInfo_Return(
           ...
           de.epages.ws.shop.model.TAddress address,
           de.epages.ws.shop.model.TAddress shopAddress,
           de.epages.ws.orderdocument.model.TLineItemContainerOut lineItemContainer,
     ...
     * @return address
     */
    public de.epages.ws.shop.model.TAddress getAddress() {
        return address;
    }
     ...
     * @param address
     */
    public void setAddress(de.epages.ws.shop.model.TAddress address) {
        this.address = address;
    }
     ...
     * @return shopAddress
     */
    public de.epages.ws.shop.model.TAddress getShopAddress() {
        return shopAddress;
    }
     ...
     * @param shopAddress
     */
    public void setShopAddress(de.epages.ws.shop.model.TAddress shopAddress) {
        this.shopAddress = shopAddress;
    }
     ...
     * (see orderdocumenttypes:TLineItemContainerOut)
     */
    public de.epages.ws.orderdocument.model.TLineItemContainerOut getLineItemContainer() {
     ...
     * (see orderdocumenttypes:TLineItemContainerOut)
     */
    public void setLineItemContainer(de.epages.ws.orderdocument.model.TLineItemContainerOut lineItemContainer) {
        this.lineItemContainer = lineItemContainer;
    }
