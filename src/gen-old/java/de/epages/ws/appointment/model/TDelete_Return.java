...
/**
 * a single return value of a delete() appointment call.
...
public class TDelete_Return  implements java.io.Serializable {
    ...
    /* a boolean flag indicating that this appointment was deleted */
     ...
     * 
     * @return deleted   * a boolean flag indicating that this appointment was deleted
     */
     ...
     * 
     * @param deleted   * a boolean flag indicating that this appointment was deleted
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/AppointmentTypes/2009/06", "TDelete_Return"));
