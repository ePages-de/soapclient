...
public class OrderServiceLocator extends org.apache.axis.client.Service implements de.epages.ws.order11.stub.OrderService {
 ...
 */
    ...
    public de.epages.ws.order11.stub.Port_Order getport_Order() throws javax.xml.rpc.ServiceException {
    ...
    public de.epages.ws.order11.stub.Port_Order getport_Order(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            de.epages.ws.order11.stub.Bind_Order_SOAPStub _stub = new de.epages.ws.order11.stub.Bind_Order_SOAPStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (de.epages.ws.order11.stub.Port_Order.class.isAssignableFrom(serviceEndpointInterface)) {
                de.epages.ws.order11.stub.Bind_Order_SOAPStub _stub = new de.epages.ws.order11.stub.Bind_Order_SOAPStub(new java.net.URL(port_Order_address), this);
                _stub.setPortName(getport_OrderWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("urn://epages.de/WebService/OrderService/2013/01", "OrderService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("urn://epages.de/WebService/OrderService/2013/01", "port_Order"));
        }
