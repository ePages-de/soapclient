...
public class ProductServiceLocator extends org.apache.axis.client.Service implements de.epages.ws.product2.stub.ProductService {
 ...
 */
    ...
    public de.epages.ws.product2.stub.Port_Product getport_Product() throws javax.xml.rpc.ServiceException {
    ...
    public de.epages.ws.product2.stub.Port_Product getport_Product(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            de.epages.ws.product2.stub.Bind_Product_SOAPStub _stub = new de.epages.ws.product2.stub.Bind_Product_SOAPStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (de.epages.ws.product2.stub.Port_Product.class.isAssignableFrom(serviceEndpointInterface)) {
                de.epages.ws.product2.stub.Bind_Product_SOAPStub _stub = new de.epages.ws.product2.stub.Bind_Product_SOAPStub(new java.net.URL(port_Product_address), this);
                _stub.setPortName(getport_ProductWSDDServiceName());
                return _stub;
            }
        }
