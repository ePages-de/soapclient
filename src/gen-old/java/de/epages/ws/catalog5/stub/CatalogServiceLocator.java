...
public class CatalogServiceLocator extends org.apache.axis.client.Service implements de.epages.ws.catalog5.stub.CatalogService {
 ...
 */
    ...
    public de.epages.ws.catalog5.stub.Port_Catalog getport_Catalog() throws javax.xml.rpc.ServiceException {
    ...
    public de.epages.ws.catalog5.stub.Port_Catalog getport_Catalog(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            de.epages.ws.catalog5.stub.Bind_Catalog_SOAPStub _stub = new de.epages.ws.catalog5.stub.Bind_Catalog_SOAPStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (de.epages.ws.catalog5.stub.Port_Catalog.class.isAssignableFrom(serviceEndpointInterface)) {
                de.epages.ws.catalog5.stub.Bind_Catalog_SOAPStub _stub = new de.epages.ws.catalog5.stub.Bind_Catalog_SOAPStub(new java.net.URL(port_Catalog_address), this);
                _stub.setPortName(getport_CatalogWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("urn://epages.de/WebService/CatalogService/2010/04", "CatalogService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("urn://epages.de/WebService/CatalogService/2010/04", "port_Catalog"));
        }
