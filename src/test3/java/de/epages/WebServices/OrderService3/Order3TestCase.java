package de.epages.WebServices.OrderService3;

import de.epages.WebServices.OrderService3.Stub.*;
 ...
 */
public class Order3TestCase extends WebServiceTestConfiguration {
    private static Logger log = Logger.getLogger(Order3TestCase.class.getName());
    ...
    public void setUp() throws RemoteException, MalformedURLException {
        ...
        orderService = new Bind_Order_SOAPStub(WEBSERVICE_URL, serviceLocator);
    ...
    public void testCreate() throws RemoteException {
        log.info("Order3TestCase: testCreate");
        try {
    ...
    public void testUpdate() throws RemoteException {
        log.info("Order3TestCase: testUpdate");
        try {
    ...
    public void testGetInfo(boolean isAlreadyUpdated) throws RemoteException {
        log.info("Order3TestCase: testGetInfo");
        try {
            TGetInfo_Return[] Orders_info_out = orderService.getInfo(Orders, OrderAttributes, AddressAttributes, null);
    ...
    public void testDelete() throws RemoteException {
        log.info("Order3TestCase: testDelete");
        try {
	        TDelete_Return[] Orders_delete_out = orderService.delete(new String[]{OrderPath});
	        assertEquals("delete result set", 1, Orders_delete_out.length);
		    }
    ...
    */
    ...
    public void testFind() {
        log.info("Order3TestCase: testFind");
