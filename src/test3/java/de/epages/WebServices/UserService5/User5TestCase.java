package de.epages.WebServices.UserService5;

import de.epages.WebServices.UserService5.Stub.*;
 ...
 */
public class User5TestCase extends WebServiceTestConfiguration {
    private static Logger log = Logger.getLogger(User5TestCase.class.getName());
   ...
   public void testDelete() {
    ...
    public void testFind() {
        log.info("User5TestCase: testFind");
        try {
            String[] users_out = userService.find(new Type_Find_Input(){{setName("Klaus");}});
