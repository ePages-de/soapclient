package de.epages.WebServices.OrderService7;

import de.epages.WebServices.OrderService7.Stub.*;
 ...
 */
public class Order7TestCase extends WebServiceTestConfiguration {
    private static Logger log = Logger.getLogger(Order7TestCase.class.getName());
