...
public class CatalogServiceTest extends WebServiceTestConfiguration {
    ...
    private TUpdate_Input Catalog_move;
    private TUpdate_Input Catalog_move_back;
    private TSortProducts_Input Catalog_sort1;
    private TSortProducts_Input Catalog_sort2;
    private TSortProducts_Input Catalog_sort3;
    ...
    public void setUp() {
        ...
        Catalog_move_back = new TUpdate_Input();
        Catalog_sort1 = new TSortProducts_Input();
        Catalog_sort2 = new TSortProducts_Input();
        Catalog_sort3 = new TSortProducts_Input();
        ...
        Catalog_move.setPath(full);
        Catalog_move.setMoveToParentCatalog("Categories/Tents");

        Catalog_move_back.setPath("Categories/Tents/" + alias);
        Catalog_move_back.setMoveToParentCatalog(path);
    ...
    /**
     * Update a Parent of a Catalog and check if the update was successful
     */
    public void testMove(TUpdate_Input Catalog) {
        TUpdate_Input[] Catalogs_up = new TUpdate_Input[] { Catalog };
        TUpdate_Return[] Catalogs_out = catalogService.update(Catalogs_up);
    ...
    /**
     * Test to get all Categories recursively
     */
