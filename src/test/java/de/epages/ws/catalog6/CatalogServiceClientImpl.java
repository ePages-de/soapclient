...
import de.epages.ws.catalog6.stub.CatalogServiceLocator;
...
public final class CatalogServiceClientImpl implements CatalogServiceClient {
    ...
    @Override
    public TUpload_Return uploadImage(String catalog, TUpload_Input imageData) {
        try {
            return stub.uploadImage(catalog, imageData);
        } catch (RemoteException e) {
            throw new WebServiceException(e);
        }
    }
