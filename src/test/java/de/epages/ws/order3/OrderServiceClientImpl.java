...
import de.epages.ws.order3.stub.OrderServiceLocator;
import de.epages.ws.order3.stub.Port_Order;
import de.epages.ws.order3.stub.TFind_Input;
...
public final class OrderServiceClientImpl implements OrderServiceClient {
    ...
    @Override
    public TGetInfo_Return[] getInfo(String[] orders, String[] attributes, String[] addressAttributes, String[] languageCodes) {
        try {
            return stub.getInfo(orders, attributes, addressAttributes, languageCodes);
