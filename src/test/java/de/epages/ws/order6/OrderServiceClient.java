...
public interface OrderServiceClient extends Port_Order {
     ...
     */
    TUpdate_Return[] update(de.epages.ws.order6.model.TUpdate_Input[] orders);

    /**
     * create new orders. This function does not send order
     *         confirmation e-mails to the customers.
     */
    TCreate_Return[] create(de.epages.ws.order6.model.TCreate_Input[] orders);

    /**
     * find orders
     */
    String[] find(de.epages.ws.order6.stub.TFind_Input searchParameters);
