...
import de.epages.ws.orderdocument3.stub.OrderDocumentServiceLocator;
...
public final class OrderDocumentServiceClientImpl implements OrderDocumentServiceClient {
    ...
    @Override
    public TGetInfo_Return[] getInfo(String[] orderDocuments, String[] attributes, String[] addressAttributes, String[] languageCodes) {
        try {
            return stub.getInfo(orderDocuments, attributes, addressAttributes, languageCodes);
