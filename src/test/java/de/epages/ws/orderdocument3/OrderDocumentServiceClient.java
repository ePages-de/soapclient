...
public interface OrderDocumentServiceClient extends Port_OrderDocument {
     ...
     * get information about a list of order documents
     */
    TGetInfo_Return[] getInfo(String[] orderDocuments, String[] attributes, String[] addressAttributes, String[] languageCodes);
     ...
     */
    TCreate_Return[] create(de.epages.ws.orderdocument3.model.TCreate_Input[] orderDocuments);
