package de.epages.WebServices.OrderDocumentService3;

import de.epages.WebServices.OrderDocumentService3.Stub.*;
 ...
 */
public class OrderDocument3TestCase extends WebServiceTestConfiguration {
    private static Logger log = Logger.getLogger(OrderDocument3TestCase.class.getName());
