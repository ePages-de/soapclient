...
public class Product8TestCase {
    ...
    public void testGetInfo(boolean isAlreadyUpdated) {
        ...
        if (isAlreadyUpdated) {
            ...
            assertEquals("Prepayment Price Value", Product_in.getPrepaymentPrices()[0].getPrice(), (float)priceHash4.get(Product_in.getPrepaymentPrices()[0].getCurrencyID()), 0.001 );
            assertEquals("EcoParticipation Price Value", Product_in.getEcoParticipationPrices()[0].getPrice(), (float)priceHash5.get(Product_in.getEcoParticipationPrices()[0].getCurrencyID()), 0.001 );
