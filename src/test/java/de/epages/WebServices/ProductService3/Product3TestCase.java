package de.epages.WebServices.ProductService3;
...
import de.epages.WebServices.ProductService3.Stub.TAttribute;
import de.epages.WebServices.ProductService3.Stub.TCreate_Input;
import de.epages.WebServices.ProductService3.Stub.TCreate_Return;
import de.epages.WebServices.ProductService3.Stub.TDelete_Return;
import de.epages.WebServices.ProductService3.Stub.TExists_Return;
import de.epages.WebServices.ProductService3.Stub.TFind_Input;
import de.epages.WebServices.ProductService3.Stub.TGetInfo_Return;
import de.epages.WebServices.ProductService3.Stub.TLocalizedValue;
import de.epages.WebServices.ProductService3.Stub.TProductPrice;
import de.epages.WebServices.ProductService3.Stub.TUpdate_Input;
import de.epages.WebServices.ProductService3.Stub.TUpdate_Return;
 ...
 * Time: 14:19:18
 */
public class Product3TestCase {
    private static Logger log = Logger.getLogger(Product3TestCase.class.getName());
    ProductService3Client serviceClient;
    ...
    @Before
    public void setUp() {
        serviceClient = new ProductService3Client(new WebServiceTestConfiguration());
