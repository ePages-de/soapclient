package de.epages.WebServices.OrderService6;

import de.epages.WebServices.OrderService6.Stub.*;
 ...
 */
public class Order6TestCase extends WebServiceTestConfiguration {
    private static Logger log = Logger.getLogger(Order6TestCase.class.getName());
