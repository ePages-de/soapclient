 ...
 */
public class Order2TestCase {
    private static Logger log = Logger.getLogger(Order2TestCase.class.getName());
    ...
    public void setUp() {
        ...
        try {
        	...
        	if( Orders_exists_out.get(0).getExists() ) {
        		List<TDelete_Return> Orders_delete_out = serviceClient.deleteOrder(new String[]{path + alias});
        	}
        }
