package de.epages.WebServices.CatalogService6;

import de.epages.WebServices.CatalogService6.Stub.*;
 ...
 */
public class Catalog6TestCase extends WebServiceTestConfiguration {
    private static Logger log = Logger.getLogger(Catalog6TestCase.class.getName());
