package de.epages.WebServices.OrderService8;

import de.epages.WebServices.OrderService8.Stub.*;
 ...
 */
public class Order8TestCase extends WebServiceTestConfiguration {
    private static Logger log = Logger.getLogger(Order8TestCase.class.getName());
