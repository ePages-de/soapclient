...
public class ProductServiceLocator extends org.apache.axis.client.Service implements ProductService {
 ...
 */
    ...
    public Port_Product getport_Product() throws javax.xml.rpc.ServiceException {
    ...
    public Port_Product getport_Product(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            Bind_Product_SOAPStub _stub = new Bind_Product_SOAPStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (Port_Product.class.isAssignableFrom(serviceEndpointInterface)) {
                Bind_Product_SOAPStub _stub = new Bind_Product_SOAPStub(new java.net.URL(port_Product_address), this);
                _stub.setPortName(getport_ProductWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("urn://epages.de/WebService/ProductService/2014/12", "ProductService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("urn://epages.de/WebService/ProductService/2014/12", "port_Product"));
        }
