...
public class TUpload_Input  implements java.io.Serializable {
    ...
    private de.epages.ws.catalog8.model.TImageData[] imageData;

    public TUpload_Input() {
    }

    public TUpload_Input(
           de.epages.ws.catalog8.model.TImageData[] imageData) {
     ...
     */
    public de.epages.ws.catalog8.model.TImageData[] getImageData() {
        return imageData;
    }
     ...
     */
    public void setImageData(de.epages.ws.catalog8.model.TImageData[] imageData) {
        this.imageData = imageData;
    }
