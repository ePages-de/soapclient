...
public class TFindDeletes_Return  implements java.io.Serializable {
    private de.epages.ws.changelog.stub.TFindDeletes[] deletes;
    ...
    public TFindDeletes_Return(
           de.epages.ws.changelog.stub.TFindDeletes[] deletes,
     ...
     * @return deletes
     */
    public de.epages.ws.changelog.stub.TFindDeletes[] getDeletes() {
        return deletes;
    }
     ...
     * @param deletes
     */
    public void setDeletes(de.epages.ws.changelog.stub.TFindDeletes[] deletes) {
        this.deletes = deletes;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/ChangeLogService/2014/06", "TFindDeletes_Return"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("deletes");
        elemField.setXmlName(new javax.xml.namespace.QName("", "Deletes"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/ChangeLogService/2014/06", "TFindDeletes"));
