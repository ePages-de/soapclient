...
public class OrderDocumentServiceLocator extends org.apache.axis.client.Service implements de.epages.ws.orderdocument7.stub.OrderDocumentService {
 ...
 */
    ...
    public de.epages.ws.orderdocument7.stub.Port_OrderDocument getport_OrderDocument() throws javax.xml.rpc.ServiceException {
    ...
    public de.epages.ws.orderdocument7.stub.Port_OrderDocument getport_OrderDocument(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            de.epages.ws.orderdocument7.stub.Bind_OrderDocument_SOAPStub _stub = new de.epages.ws.orderdocument7.stub.Bind_OrderDocument_SOAPStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (de.epages.ws.orderdocument7.stub.Port_OrderDocument.class.isAssignableFrom(serviceEndpointInterface)) {
                de.epages.ws.orderdocument7.stub.Bind_OrderDocument_SOAPStub _stub = new de.epages.ws.orderdocument7.stub.Bind_OrderDocument_SOAPStub(new java.net.URL(port_OrderDocument_address), this);
                _stub.setPortName(getport_OrderDocumentWSDDServiceName());
                return _stub;
            }
        }
