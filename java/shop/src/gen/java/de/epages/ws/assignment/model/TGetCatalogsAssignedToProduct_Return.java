...
public class TGetCatalogsAssignedToProduct_Return  implements java.io.Serializable {
    ...
    private de.epages.ws.assignment.model.TAssignedCatalog[] catalogs;
    ...
    public TGetCatalogsAssignedToProduct_Return(
           ...
           de.epages.ws.assignment.model.TAssignedCatalog[] catalogs,
     ...
     */
    public de.epages.ws.assignment.model.TAssignedCatalog[] getCatalogs() {
        return catalogs;
    }
     ...
     */
    public void setCatalogs(de.epages.ws.assignment.model.TAssignedCatalog[] catalogs) {
        this.catalogs = catalogs;
    }
