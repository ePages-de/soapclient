...
package de.epages.ws.customer6.model;
...
public class TGetInfo_Return  implements java.io.Serializable {
    ...
    /* Date and Time when the customer was updated last time. */
    ...
    private java.lang.Boolean isRatingInvitationAllowed;
    ...
    public TGetInfo_Return(
           ...
           java.lang.Boolean isRatingInvitationAllowed,
           ...
           this.isRatingInvitationAllowed = isRatingInvitationAllowed;
     ...
     * 
     * @return lastUpdate   * Date and Time when the customer was updated last time.
     */
     ...
     * 
     * @param lastUpdate   * Date and Time when the customer was updated last time.
     */
    ...
    /**
     * Gets the isRatingInvitationAllowed value for this TGetInfo_Return.
     * 
     * @return isRatingInvitationAllowed
     */
    public java.lang.Boolean getIsRatingInvitationAllowed() {
        return isRatingInvitationAllowed;
    }


    /**
     * Sets the isRatingInvitationAllowed value for this TGetInfo_Return.
     * 
     * @param isRatingInvitationAllowed
     */
    public void setIsRatingInvitationAllowed(java.lang.Boolean isRatingInvitationAllowed) {
        this.isRatingInvitationAllowed = isRatingInvitationAllowed;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        _equals = true && 
            ...
            ((this.isRatingInvitationAllowed==null && other.getIsRatingInvitationAllowed()==null) || 
             (this.isRatingInvitationAllowed!=null &&
              this.isRatingInvitationAllowed.equals(other.getIsRatingInvitationAllowed()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getIsRatingInvitationAllowed() != null) {
            _hashCode += getIsRatingInvitationAllowed().hashCode();
        }
        if (getComment() != null) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/CustomerTypes/2014/04", "TGetInfo_Return"));
        ...
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("isRatingInvitationAllowed");
        elemField.setXmlName(new javax.xml.namespace.QName("", "IsRatingInvitationAllowed"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "boolean"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
