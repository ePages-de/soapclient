...
public class TPriceListQuantityDiscount  implements java.io.Serializable {
    ...
    private de.epages.ws.pricelistassignment.model.TQuantityDiscount[] quantityDiscounts;
    ...
    public TPriceListQuantityDiscount(
           ...
           de.epages.ws.pricelistassignment.model.TQuantityDiscount[] quantityDiscounts) {
     ...
     * (see pricelistassignmenttypes:TQuantityDiscount)
     */
    public de.epages.ws.pricelistassignment.model.TQuantityDiscount[] getQuantityDiscounts() {
     ...
     * (see pricelistassignmenttypes:TQuantityDiscount)
     */
    public void setQuantityDiscounts(de.epages.ws.pricelistassignment.model.TQuantityDiscount[] quantityDiscounts) {
        this.quantityDiscounts = quantityDiscounts;
    }
