...
import de.epages.ws.order10.model.TBaseLineItem;
...
import de.epages.ws.order10.model.TLineItemContainerIn;
import de.epages.ws.order10.model.TProductLineItemIn;
...
public class OrderServiceTest {
    ...
    private TAttribute OrderAttr_in = new TAttribute("Comment","my customer commment",null,null);
    private TAttribute OrderAttr_up = new TAttribute("Comment","my updated customer comment",null,null);
    ...
    */
    public void testExists(boolean expected) {
        ...
        assertNoError(Orders_exists_out[0].getError());
    }
