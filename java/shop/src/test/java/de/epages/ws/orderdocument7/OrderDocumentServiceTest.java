...
public class OrderDocumentServiceTest {
    ...
    private static final TUpdate_Input Creditn_up = new TUpdate_Input(Creditn, "CreditNote", true, // set
                                                                                      // Issued
                                                                                      // flag
            null, null, null, null);

    private static final TUpdate_Input Creditn_up2 = new TUpdate_Input(Creditn, "CreditNote", false, // reset
                                                                                        // Issued
                                                                                        // flag
            null, null, null, null);

    private static final String[] OrderAttributes = new String[] { "Comment" };
    private static final String[] AddressAttributes = new String[] { "JobTitle" /*
                                                                    * ,"Salutation"
                                                                    */};
