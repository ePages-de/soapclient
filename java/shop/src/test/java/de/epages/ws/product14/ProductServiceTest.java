...
import de.epages.ws.product14.model.TDownload;
import de.epages.ws.product14.model.TExists_Return;
import de.epages.ws.product14.model.TGetInfo_Return;
import de.epages.ws.product14.model.TLabelDownload;
import de.epages.ws.product14.model.TLocalizedLabelDownload;
import de.epages.ws.product14.model.TProductPrice;
import de.epages.ws.product14.model.TShippingMethod;
import de.epages.ws.product14.model.TUpdate_Input;
import de.epages.ws.product14.model.TUpdate_Return;
import de.epages.ws.product14.stub.TFind_Input;
...
public class ProductServiceTest {
    ...
    public void setUp() throws IOException {
        ...
        Product_in.setEcoParticipationCategory("/EcoParticipationCategories/1");
        ...
        //	set energy label file
        //		- create a TLabelDownload object with local path
        //		- set name of this file with .setValue
        //		- Upload it via .setEnergyLabelSourceFile method
        Product_in.setEnergyLabelsString("A++");
        TLabelDownload download_in = new TLabelDownload();
        download_in.setFileContent(FileUtil.readFileFromClasspath("TestData/ProductImageService/2000px-Energy_label_2010.svg.png"));
        download_in.setValue("2000px-Energy_label_2010.svg.png");
        Product_in.setEnergyLabelSourceFile(download_in);
        
        // set datasheets
        // it is a type of TLocalizedLabelDownload field with TLocalizedLabelDownload for every language (language, file description, upload path) 
        TLocalizedLabelDownload[] datasheets_in = new TLocalizedLabelDownload[] {
        										new TLocalizedLabelDownload(
        												"de",
        												"ATmega16/32U4 Datasheet - Atmel Corporation",
        												FileUtil.readFileFromClasspath("TestData/ProductImageService/7766s.pdf")),
        										new TLocalizedLabelDownload(
        												"en",
        												"ATmega16/32U4 Datasheet - Atmel Corporation",
        												FileUtil.readFileFromClasspath("TestData/ProductImageService/7766s.pdf"))
        									};
        Product_in.setProductDataSheet(datasheets_in);
        ...
        Product_update.setEcoParticipationCategory("/EcoParticipationCategories/3");
        ...
        Product_update.setEnergyLabelsString("A+,A++");
        TLabelDownload download_update = new TLabelDownload();
        download_update.setFileContent(FileUtil.readFileFromClasspath("TestData/ProductImageService/100000000000054E00000A615F684661.jpg"));
        download_update.setValue("100000000000054E00000A615F684661.jpg");
        Product_update.setEnergyLabelSourceFile(download_update);
        
        TLocalizedLabelDownload[] datasheets_out = new TLocalizedLabelDownload[] {
        										new TLocalizedLabelDownload(
        												"de",
        												"ATmega16/32U4 Datasheet",
        												FileUtil.readFileFromClasspath("TestData/ProductImageService/7766s.pdf")),
        										new TLocalizedLabelDownload(
        												"en",
        												"ATmega16/32U4 Datasheet",
        ...
        Product_update.setProductDataSheet(datasheets_out);
    ...
    private void getInfo(boolean isAlreadyUpdated) {
        ...
        if (isAlreadyUpdated) {
            ...
            assertEquals("EcoParticipation Category", Product_update.getEcoParticipationCategory(),
            		Product_info_out.getEcoParticipationCategory());
            ...
            assertEquals("EcoParticipation Category", Product_in.getEcoParticipationCategory(),
            		Product_info_out.getEcoParticipationCategory());
