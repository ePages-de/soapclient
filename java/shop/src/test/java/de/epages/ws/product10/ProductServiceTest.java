...
import de.epages.ws.product10.model.TAttribute;
...
import de.epages.ws.product10.model.TDownload;
import de.epages.ws.product10.model.TExists_Return;
import de.epages.ws.product10.model.TGetInfo_Return;
import de.epages.ws.product10.model.TProductPrice;
import de.epages.ws.product10.model.TShippingMethod;
...
public class ProductServiceTest {
    ...
    private final TCreate_Input Product_down_up = new TCreate_Input();
    ...
    public void setUp() throws IOException {
        ...
        de.epages.ws.common.model.TAttribute attr_update = new de.epages.ws.common.model.TAttribute();
        attr_update.setName("Manufacturer");
        attr_update.setValue("java WebService client tester again");
        Product_update.setAttributes(new de.epages.ws.common.model.TAttribute[] { attr_update });
    ...
    public void testGetInfo(boolean isAlreadyUpdated) {
        ...
        if (isAlreadyUpdated) {
            ...
            assertTrue(shippingMethods.contains("Post"));
            assertTrue(shippingMethods.contains("Express"));
        }
    ...
    public void testCreateDownloadWithUpload() {
        TCreate_Input[] Products_create_in = { Product_down_up };
        TCreate_Return[] Products_create_out = serviceClient.create(Products_create_in);
