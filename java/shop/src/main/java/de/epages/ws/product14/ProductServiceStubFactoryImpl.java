...
import de.epages.ws.product14.stub.Bind_Product_SOAPStub;
...
final class ProductServiceStubFactoryImpl implements ProductServiceStubFactory {
    ...
    @Override
    public Port_Product_PortType create(WebServiceConfiguration config, ProductService serviceLocator) {
