...
public class ProductTypeServiceLocator extends org.apache.axis.client.Service implements de.epages.ws.producttype.stub.ProductTypeService {
 ...
 */
    ...
    public de.epages.ws.producttype.stub.Port_ProductType getport_ProductType(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            de.epages.ws.producttype.stub.Bind_ProductType_SOAPStub _stub = new de.epages.ws.producttype.stub.Bind_ProductType_SOAPStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (de.epages.ws.producttype.stub.Port_ProductType.class.isAssignableFrom(serviceEndpointInterface)) {
                de.epages.ws.producttype.stub.Bind_ProductType_SOAPStub _stub = new de.epages.ws.producttype.stub.Bind_ProductType_SOAPStub(new java.net.URL(port_ProductType_address), this);
                _stub.setPortName(getport_ProductTypeWSDDServiceName());
                return _stub;
            }
        }
