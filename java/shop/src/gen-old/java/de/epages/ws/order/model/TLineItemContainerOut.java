...
public class TLineItemContainerOut  implements java.io.Serializable {
    ...
    private de.epages.ws.order.model.TProductLineItemOut[] productLineItems;

    /* the container's tax line items */
    private de.epages.ws.order.model.TTaxLineItem[] taxLineItems;

    /* the container's payment line item */
    private de.epages.ws.order.model.TPaymentLineItem paymentLineItem;

    /* the container's shipping line item */
    private de.epages.ws.order.model.TShippingLineItem shippingLineItem;
    ...
    public TLineItemContainerOut(
           ...
           float totalTax,
           de.epages.ws.order.model.TProductLineItemOut[] productLineItems,
           de.epages.ws.order.model.TTaxLineItem[] taxLineItems,
           de.epages.ws.order.model.TPaymentLineItem paymentLineItem,
           de.epages.ws.order.model.TShippingLineItem shippingLineItem) {
     ...
     */
    public de.epages.ws.order.model.TProductLineItemOut[] getProductLineItems() {
     ...
     */
    public void setProductLineItems(de.epages.ws.order.model.TProductLineItemOut[] productLineItems) {
        this.productLineItems = productLineItems;
    }
     ...
     */
    public de.epages.ws.order.model.TTaxLineItem[] getTaxLineItems() {
        return taxLineItems;
    }
     ...
     */
    public void setTaxLineItems(de.epages.ws.order.model.TTaxLineItem[] taxLineItems) {
        this.taxLineItems = taxLineItems;
    }
     ...
     */
    public de.epages.ws.order.model.TPaymentLineItem getPaymentLineItem() {
     ...
     */
    public void setPaymentLineItem(de.epages.ws.order.model.TPaymentLineItem paymentLineItem) {
        this.paymentLineItem = paymentLineItem;
    }
     ...
     */
    public de.epages.ws.order.model.TShippingLineItem getShippingLineItem() {
     ...
     */
    public void setShippingLineItem(de.epages.ws.order.model.TShippingLineItem shippingLineItem) {
        this.shippingLineItem = shippingLineItem;
    }
