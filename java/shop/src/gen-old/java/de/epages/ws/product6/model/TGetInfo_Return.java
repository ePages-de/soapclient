...
package de.epages.ws.product6.model;
...
public class TGetInfo_Return  implements java.io.Serializable {
    ...
    private de.epages.ws.product6.model.TDownload[] downloadProductMaps;
    ...
    private de.epages.ws.product6.model.TProductPrice[] productPrices;

    /* list of manufacturer prices (see producttypes:ListOfListOfProductPrices) */
    private de.epages.ws.product6.model.TProductPrice[] manufacturerPrices;

    /* list of deposit prices (see producttypes:ListOfListOfProductPrices) */
    private de.epages.ws.product6.model.TProductPrice[] depositPrices;

    /* list of prepayment prices (see producttypes:ListOfListOfProductPrices) */
    private de.epages.ws.product6.model.TProductPrice[] prepaymentPrices;
    ...
    public TGetInfo_Return(
           ...
           de.epages.ws.product6.model.TDownload[] downloadProductMaps,
           ...
           de.epages.ws.product6.model.TProductPrice[] productPrices,
           de.epages.ws.product6.model.TProductPrice[] manufacturerPrices,
           de.epages.ws.product6.model.TProductPrice[] depositPrices,
           de.epages.ws.product6.model.TProductPrice[] prepaymentPrices,
     ...
     */
    public de.epages.ws.product6.model.TDownload[] getDownloadProductMaps() {
     ...
     */
    public void setDownloadProductMaps(de.epages.ws.product6.model.TDownload[] downloadProductMaps) {
        this.downloadProductMaps = downloadProductMaps;
    }
     ...
     */
    public de.epages.ws.product6.model.TProductPrice[] getProductPrices() {
     ...
     */
    public void setProductPrices(de.epages.ws.product6.model.TProductPrice[] productPrices) {
        this.productPrices = productPrices;
    }
     ...
     */
    public de.epages.ws.product6.model.TProductPrice[] getManufacturerPrices() {
     ...
     */
    public void setManufacturerPrices(de.epages.ws.product6.model.TProductPrice[] manufacturerPrices) {
        this.manufacturerPrices = manufacturerPrices;
    }
     ...
     */
    public de.epages.ws.product6.model.TProductPrice[] getDepositPrices() {
     ...
     */
    public void setDepositPrices(de.epages.ws.product6.model.TProductPrice[] depositPrices) {
        this.depositPrices = depositPrices;
    }
     ...
     */
    public de.epages.ws.product6.model.TProductPrice[] getPrepaymentPrices() {
     ...
     */
    public void setPrepaymentPrices(de.epages.ws.product6.model.TProductPrice[] prepaymentPrices) {
        this.prepaymentPrices = prepaymentPrices;
    }
