...
public class PriceListServiceLocator extends org.apache.axis.client.Service implements de.epages.ws.pricelist.stub.PriceListService {
 ...
 */
    ...
    public de.epages.ws.pricelist.stub.Port_PriceList getport_PriceList() throws javax.xml.rpc.ServiceException {
    ...
    public de.epages.ws.pricelist.stub.Port_PriceList getport_PriceList(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            de.epages.ws.pricelist.stub.Bind_PriceList_SOAPStub _stub = new de.epages.ws.pricelist.stub.Bind_PriceList_SOAPStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (de.epages.ws.pricelist.stub.Port_PriceList.class.isAssignableFrom(serviceEndpointInterface)) {
                de.epages.ws.pricelist.stub.Bind_PriceList_SOAPStub _stub = new de.epages.ws.pricelist.stub.Bind_PriceList_SOAPStub(new java.net.URL(port_PriceList_address), this);
                _stub.setPortName(getport_PriceListWSDDServiceName());
                return _stub;
            }
        }
