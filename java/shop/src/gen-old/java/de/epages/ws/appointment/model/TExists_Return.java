...
/**
 * a single return value of a exists() appointment call.
...
public class TExists_Return  implements java.io.Serializable {
    ...
    /* a boolean flag indicating that this appointment exists */
     ...
     * 
     * @return exists   * a boolean flag indicating that this appointment exists
     */
     ...
     * 
     * @param exists   * a boolean flag indicating that this appointment exists
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/AppointmentTypes/2009/06", "TExists_Return"));
