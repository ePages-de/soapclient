...
public class TLineItemContainerIn  implements java.io.Serializable {
    ...
    private de.epages.ws.order2.model.TProductLineItemIn[] productLineItems;
    ...
    public TLineItemContainerIn(
           ...
           de.epages.ws.order2.model.TProductLineItemIn[] productLineItems,
     ...
     */
    public de.epages.ws.order2.model.TProductLineItemIn[] getProductLineItems() {
     ...
     */
    public void setProductLineItems(de.epages.ws.order2.model.TProductLineItemIn[] productLineItems) {
        this.productLineItems = productLineItems;
    }
