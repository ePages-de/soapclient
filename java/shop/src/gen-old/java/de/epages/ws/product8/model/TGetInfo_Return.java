...
public class TGetInfo_Return  implements java.io.Serializable {
    ...
    private de.epages.ws.product8.model.TDownload[] downloadProductMaps;
    ...
    private de.epages.ws.product8.model.TProductPrice[] productPrices;

    /* list of manufacturer prices (see producttypes:ListOfListOfProductPrices) */
    private de.epages.ws.product8.model.TProductPrice[] manufacturerPrices;

    /* list of deposit prices (see producttypes:ListOfListOfProductPrices) */
    private de.epages.ws.product8.model.TProductPrice[] depositPrices;

    /* list of eco participation  prices (see producttypes:ListOfListOfProductPrices) */
    private de.epages.ws.product8.model.TProductPrice[] ecoParticipationPrices;

    /* list of prepayment prices (see producttypes:ListOfListOfProductPrices) */
    private de.epages.ws.product8.model.TProductPrice[] prepaymentPrices;
    ...
    private de.epages.ws.product8.model.TShippingMethod[] shippingMethods;
    ...
    public TGetInfo_Return(
           ...
           de.epages.ws.product8.model.TDownload[] downloadProductMaps,
           ...
           de.epages.ws.product8.model.TProductPrice[] productPrices,
           de.epages.ws.product8.model.TProductPrice[] manufacturerPrices,
           de.epages.ws.product8.model.TProductPrice[] depositPrices,
           de.epages.ws.product8.model.TProductPrice[] ecoParticipationPrices,
           de.epages.ws.product8.model.TProductPrice[] prepaymentPrices,
           java.lang.String prepaymentType,
           java.lang.Float prepaymentValue,
           de.epages.ws.product8.model.TShippingMethod[] shippingMethods,
     ...
     */
    public de.epages.ws.product8.model.TDownload[] getDownloadProductMaps() {
     ...
     */
    public void setDownloadProductMaps(de.epages.ws.product8.model.TDownload[] downloadProductMaps) {
        this.downloadProductMaps = downloadProductMaps;
    }
     ...
     */
    public de.epages.ws.product8.model.TProductPrice[] getProductPrices() {
     ...
     */
    public void setProductPrices(de.epages.ws.product8.model.TProductPrice[] productPrices) {
        this.productPrices = productPrices;
    }
     ...
     */
    public de.epages.ws.product8.model.TProductPrice[] getManufacturerPrices() {
     ...
     */
    public void setManufacturerPrices(de.epages.ws.product8.model.TProductPrice[] manufacturerPrices) {
        this.manufacturerPrices = manufacturerPrices;
    }
     ...
     */
    public de.epages.ws.product8.model.TProductPrice[] getDepositPrices() {
     ...
     */
    public void setDepositPrices(de.epages.ws.product8.model.TProductPrice[] depositPrices) {
        this.depositPrices = depositPrices;
    }
     ...
     */
    public de.epages.ws.product8.model.TProductPrice[] getEcoParticipationPrices() {
     ...
     */
    public void setEcoParticipationPrices(de.epages.ws.product8.model.TProductPrice[] ecoParticipationPrices) {
        this.ecoParticipationPrices = ecoParticipationPrices;
    }
     ...
     */
    public de.epages.ws.product8.model.TProductPrice[] getPrepaymentPrices() {
     ...
     */
    public void setPrepaymentPrices(de.epages.ws.product8.model.TProductPrice[] prepaymentPrices) {
        this.prepaymentPrices = prepaymentPrices;
    }
     ...
     */
    public de.epages.ws.product8.model.TShippingMethod[] getShippingMethods() {
     ...
     */
    public void setShippingMethods(de.epages.ws.product8.model.TShippingMethod[] shippingMethods) {
        this.shippingMethods = shippingMethods;
    }
