...
public class TGetInfo_Return  implements java.io.Serializable {
    ...
    private de.epages.ws.order11.model.TLineItemContainerOut lineItemContainer;
    ...
    public TGetInfo_Return(
           ...
           de.epages.ws.order11.model.TLineItemContainerOut lineItemContainer,
     ...
     */
    public de.epages.ws.order11.model.TLineItemContainerOut getLineItemContainer() {
     ...
     */
    public void setLineItemContainer(de.epages.ws.order11.model.TLineItemContainerOut lineItemContainer) {
        this.lineItemContainer = lineItemContainer;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/OrderTypes/2013/01", "TGetInfo_Return"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/OrderTypes/2013/01", "TLineItemContainerOut"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
