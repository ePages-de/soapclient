...
public class TLineItemContainerIn  implements java.io.Serializable {
    ...
    private de.epages.ws.order11.model.TProductLineItemIn[] productLineItems;
    ...
    public TLineItemContainerIn(
           ...
           de.epages.ws.order11.model.TProductLineItemIn[] productLineItems,
     ...
     */
    public de.epages.ws.order11.model.TProductLineItemIn[] getProductLineItems() {
     ...
     */
    public void setProductLineItems(de.epages.ws.order11.model.TProductLineItemIn[] productLineItems) {
        this.productLineItems = productLineItems;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/OrderTypes/2013/01", "TLineItemContainerIn"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/OrderTypes/2013/01", "TProductLineItemIn"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
