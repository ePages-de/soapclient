...
public class UserServiceLocator extends org.apache.axis.client.Service implements de.epages.ws.user3.stub.UserService {
 ...
 */
    ...
    public de.epages.ws.user3.stub.Port_User getport_User() throws javax.xml.rpc.ServiceException {
    ...
    public de.epages.ws.user3.stub.Port_User getport_User(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            de.epages.ws.user3.stub.Bind_User_SOAPStub _stub = new de.epages.ws.user3.stub.Bind_User_SOAPStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (de.epages.ws.user3.stub.Port_User.class.isAssignableFrom(serviceEndpointInterface)) {
                de.epages.ws.user3.stub.Bind_User_SOAPStub _stub = new de.epages.ws.user3.stub.Bind_User_SOAPStub(new java.net.URL(port_User_address), this);
                _stub.setPortName(getport_UserWSDDServiceName());
                return _stub;
            }
        }
