...
public class TUpload_Input  implements java.io.Serializable {
    ...
    private de.epages.ws.catalog7.model.TImageData[] imageData;

    public TUpload_Input() {
    }

    public TUpload_Input(
           de.epages.ws.catalog7.model.TImageData[] imageData) {
     ...
     */
    public de.epages.ws.catalog7.model.TImageData[] getImageData() {
        return imageData;
    }
     ...
     */
    public void setImageData(de.epages.ws.catalog7.model.TImageData[] imageData) {
        this.imageData = imageData;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/CatalogTypes/2011/10", "TUpload_Input"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("imageData");
        elemField.setXmlName(new javax.xml.namespace.QName("", "ImageData"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/CatalogTypes/2011/10", "TImageData"));
