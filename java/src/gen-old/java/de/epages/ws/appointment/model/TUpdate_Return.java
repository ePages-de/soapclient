...
/**
 * a single return value of a update() appointment call.
...
public class TUpdate_Return  implements java.io.Serializable {
    ...
    /* a boolean flag indicating that this appointment was updated */
     ...
     * 
     * @return updated   * a boolean flag indicating that this appointment was updated
     */
     ...
     * 
     * @param updated   * a boolean flag indicating that this appointment was updated
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/AppointmentTypes/2009/06", "TUpdate_Return"));
