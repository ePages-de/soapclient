...
/**
 * a single return value of a create() appointment call.
...
public class TCreate_Return  implements java.io.Serializable {
    ...
    /* a boolean flag indicating that this appointment was created */
     ...
     * 
     * @return created   * a boolean flag indicating that this appointment was created
     */
     ...
     * 
     * @param created   * a boolean flag indicating that this appointment was created
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/AppointmentTypes/2009/06", "TCreate_Return"));
