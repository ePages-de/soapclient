...
public class Bind_ProductImage_SOAPStub extends org.apache.axis.client.Stub implements de.epages.ws.productimage.stub.Port_ProductImage {
    ...
    private static void _initOperationDesc1(){
        ...
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "ImageData"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("urn://epages.de/WebService/ProductImageTypes/2006/03", "TUpload_Input"), de.epages.ws.productimage.model.TUpload_Input.class, false, false);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("urn://epages.de/WebService/ProductImageTypes/2006/03", "TUploadOut"));
        oper.setReturnClass(de.epages.ws.productimage.model.TUpload_Return[].class);
        ...
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "TObjectPath"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), java.lang.String.class, false, false);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "ImageData"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("urn://epages.de/WebService/ProductImageTypes/2006/03", "TUploadScale_Input"), de.epages.ws.productimage.model.TUploadScale_Input.class, false, false);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "ScaleParams"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("urn://epages.de/WebService/ProductImageTypes/2006/03", "TScaleParams"), de.epages.ws.productimage.model.TScaleParams.class, false, false);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("urn://epages.de/WebService/ProductImageTypes/2006/03", "TUploadScaleOut"));
        oper.setReturnClass(de.epages.ws.productimage.model.TUploadScale_Return[].class);
        oper.setReturnQName(new javax.xml.namespace.QName("", "Files"));
        oper.setStyle(org.apache.axis.constants.Style.RPC);
        oper.setUse(org.apache.axis.constants.Use.ENCODED);
        _operations[1] = oper;
        ...
        oper.setReturnClass(de.epages.ws.productimage.model.TDelete_Return[].class);
        oper.setReturnQName(new javax.xml.namespace.QName("", "Files"));
        oper.setStyle(org.apache.axis.constants.Style.RPC);
        oper.setUse(org.apache.axis.constants.Use.ENCODED);
        _operations[3] = oper;
    ...
    public Bind_ProductImage_SOAPStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            cachedSerQNames.add(qName);
            cls = de.epages.ws.productimage.model.TImageData[].class;
            cachedSerClasses.add(cls);
            ...
            cachedSerQNames.add(qName);
            cls = de.epages.ws.productimage.model.TDelete_Return.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = de.epages.ws.productimage.model.TScaleParams.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = de.epages.ws.productimage.model.TUpload_Input.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = de.epages.ws.productimage.model.TUpload_Return.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = de.epages.ws.productimage.model.TUploadScale_Input.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = de.epages.ws.productimage.model.TUploadScale_Return.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {TObjectPath, imageData});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                return (de.epages.ws.productimage.model.TUpload_Return[]) _resp;
            } catch (java.lang.Exception _exception) {
                return (de.epages.ws.productimage.model.TUpload_Return[]) org.apache.axis.utils.JavaUtils.convert(_resp, de.epages.ws.productimage.model.TUpload_Return[].class);
            }
        }
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {TObjectPath, imageData, scaleParams});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            extractAttachments(_call);
            try {
                return (de.epages.ws.productimage.model.TUploadScale_Return[]) _resp;
            } catch (java.lang.Exception _exception) {
                return (de.epages.ws.productimage.model.TUploadScale_Return[]) org.apache.axis.utils.JavaUtils.convert(_resp, de.epages.ws.productimage.model.TUploadScale_Return[].class);
            }
        }
  } catch (org.apache.axis.AxisFault axisFaultException) {
  throw axisFaultException;
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {TObjectPath, TListOfFileNames});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            extractAttachments(_call);
            try {
                return (de.epages.ws.productimage.model.TDelete_Return[]) _resp;
            } catch (java.lang.Exception _exception) {
                return (de.epages.ws.productimage.model.TDelete_Return[]) org.apache.axis.utils.JavaUtils.convert(_resp, de.epages.ws.productimage.model.TDelete_Return[].class);
            }
        }
  } catch (org.apache.axis.AxisFault axisFaultException) {
  throw axisFaultException;
