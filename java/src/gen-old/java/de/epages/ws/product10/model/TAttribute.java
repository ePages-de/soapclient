...
public class TAttribute  implements java.io.Serializable {
    ...
    private de.epages.ws.common.model.TLocalizedValue[] localizedValues;
    ...
    public TAttribute(
           ...
           de.epages.ws.common.model.TLocalizedValue[] localizedValues,
           byte[] fileContent,
     ...
     *             see epagestypes:ListOfLocalizedValues
     */
    public de.epages.ws.common.model.TLocalizedValue[] getLocalizedValues() {
     ...
     *             see epagestypes:ListOfLocalizedValues
     */
    public void setLocalizedValues(de.epages.ws.common.model.TLocalizedValue[] localizedValues) {
        this.localizedValues = localizedValues;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/ProductTypes/2012/07", "TAttribute"));
