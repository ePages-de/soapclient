...
package de.epages.ws.order6.model;
...
public class TLineItemContainerOut  implements java.io.Serializable {
    ...
    private de.epages.ws.order6.model.TProductLineItemOut[] productLineItems;

    /* the container's tax line items */
    private de.epages.ws.order6.model.TTaxLineItem[] taxLineItems;

    /* the container's payment line item */
    private de.epages.ws.order6.model.TPaymentLineItem paymentLineItem;

    /* the container's shipping line item */
    private de.epages.ws.order6.model.TShippingLineItem shippingLineItem;

    /* the container's coupon line items */
    private de.epages.ws.order6.model.TCouponLineItem[] couponLineItems;

    /* the container's shipping option line items */
    private de.epages.ws.order6.model.TShippingOptionLineItem[] shippingOptionLineItems;

    /* the container's basket discount line items */
    private de.epages.ws.order6.model.TGlobalValueDiscountLineItem[] globalValueDiscountLineItems;

    /* the container's basket payment discount line items */
    private de.epages.ws.order6.model.TPaymentDiscountLineItem[] paymentDiscountLineItems;

    /* the container's basket eco participation line items */
    private de.epages.ws.order6.model.TEcoParticipationLineItem[] ecoParticipationLineItems;
    ...
    public TLineItemContainerOut(
           ...
           float totalTax,
           de.epages.ws.order6.model.TProductLineItemOut[] productLineItems,
           de.epages.ws.order6.model.TTaxLineItem[] taxLineItems,
           de.epages.ws.order6.model.TPaymentLineItem paymentLineItem,
           de.epages.ws.order6.model.TShippingLineItem shippingLineItem,
           de.epages.ws.order6.model.TCouponLineItem[] couponLineItems,
           de.epages.ws.order6.model.TShippingOptionLineItem[] shippingOptionLineItems,
           de.epages.ws.order6.model.TGlobalValueDiscountLineItem[] globalValueDiscountLineItems,
           de.epages.ws.order6.model.TPaymentDiscountLineItem[] paymentDiscountLineItems,
           de.epages.ws.order6.model.TEcoParticipationLineItem[] ecoParticipationLineItems) {
     ...
     */
    public de.epages.ws.order6.model.TProductLineItemOut[] getProductLineItems() {
     ...
     */
    public void setProductLineItems(de.epages.ws.order6.model.TProductLineItemOut[] productLineItems) {
        this.productLineItems = productLineItems;
    }
     ...
     */
    public de.epages.ws.order6.model.TTaxLineItem[] getTaxLineItems() {
        return taxLineItems;
    }
     ...
     */
    public void setTaxLineItems(de.epages.ws.order6.model.TTaxLineItem[] taxLineItems) {
        this.taxLineItems = taxLineItems;
    }
     ...
     */
    public de.epages.ws.order6.model.TPaymentLineItem getPaymentLineItem() {
     ...
     */
    public void setPaymentLineItem(de.epages.ws.order6.model.TPaymentLineItem paymentLineItem) {
        this.paymentLineItem = paymentLineItem;
    }
     ...
     */
    public de.epages.ws.order6.model.TShippingLineItem getShippingLineItem() {
     ...
     */
    public void setShippingLineItem(de.epages.ws.order6.model.TShippingLineItem shippingLineItem) {
        this.shippingLineItem = shippingLineItem;
    }
     ...
     */
    public de.epages.ws.order6.model.TCouponLineItem[] getCouponLineItems() {
     ...
     */
    public void setCouponLineItems(de.epages.ws.order6.model.TCouponLineItem[] couponLineItems) {
        this.couponLineItems = couponLineItems;
    }
     ...
     */
    public de.epages.ws.order6.model.TShippingOptionLineItem[] getShippingOptionLineItems() {
     ...
     */
    public void setShippingOptionLineItems(de.epages.ws.order6.model.TShippingOptionLineItem[] shippingOptionLineItems) {
        this.shippingOptionLineItems = shippingOptionLineItems;
    }
     ...
     */
    public de.epages.ws.order6.model.TGlobalValueDiscountLineItem[] getGlobalValueDiscountLineItems() {
     ...
     */
    public void setGlobalValueDiscountLineItems(de.epages.ws.order6.model.TGlobalValueDiscountLineItem[] globalValueDiscountLineItems) {
        this.globalValueDiscountLineItems = globalValueDiscountLineItems;
    }
     ...
     */
    public de.epages.ws.order6.model.TPaymentDiscountLineItem[] getPaymentDiscountLineItems() {
     ...
     */
    public void setPaymentDiscountLineItems(de.epages.ws.order6.model.TPaymentDiscountLineItem[] paymentDiscountLineItems) {
        this.paymentDiscountLineItems = paymentDiscountLineItems;
    }
     ...
     */
    public de.epages.ws.order6.model.TEcoParticipationLineItem[] getEcoParticipationLineItems() {
     ...
     */
    public void setEcoParticipationLineItems(de.epages.ws.order6.model.TEcoParticipationLineItem[] ecoParticipationLineItems) {
        this.ecoParticipationLineItems = ecoParticipationLineItems;
    }
