...
public class TLineItemContainerIn  implements java.io.Serializable {
    ...
    private de.epages.ws.order9.model.TProductLineItemIn[] productLineItems;
    ...
    public TLineItemContainerIn(
           ...
           de.epages.ws.order9.model.TProductLineItemIn[] productLineItems,
     ...
     */
    public de.epages.ws.order9.model.TProductLineItemIn[] getProductLineItems() {
     ...
     */
    public void setProductLineItems(de.epages.ws.order9.model.TProductLineItemIn[] productLineItems) {
        this.productLineItems = productLineItems;
    }
