...
public class CustomerServiceLocator extends org.apache.axis.client.Service implements de.epages.ws.customer2.stub.CustomerService {
 ...
 */
    ...
    public de.epages.ws.customer2.stub.Port_Customer getport_Customer() throws javax.xml.rpc.ServiceException {
    ...
    public de.epages.ws.customer2.stub.Port_Customer getport_Customer(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            de.epages.ws.customer2.stub.Bind_Customer_SOAPStub _stub = new de.epages.ws.customer2.stub.Bind_Customer_SOAPStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (de.epages.ws.customer2.stub.Port_Customer.class.isAssignableFrom(serviceEndpointInterface)) {
                de.epages.ws.customer2.stub.Bind_Customer_SOAPStub _stub = new de.epages.ws.customer2.stub.Bind_Customer_SOAPStub(new java.net.URL(port_Customer_address), this);
                _stub.setPortName(getport_CustomerWSDDServiceName());
                return _stub;
            }
        }
