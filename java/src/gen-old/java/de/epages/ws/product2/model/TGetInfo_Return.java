...
package de.epages.ws.product2.model;
...
public class TGetInfo_Return  implements java.io.Serializable {
    ...
    private de.epages.ws.product2.model.TProductPrice[] productPrices;
    ...
    public TGetInfo_Return(
           ...
           de.epages.ws.product2.model.TProductPrice[] productPrices,
     ...
     */
    public de.epages.ws.product2.model.TProductPrice[] getProductPrices() {
     ...
     */
    public void setProductPrices(de.epages.ws.product2.model.TProductPrice[] productPrices) {
        this.productPrices = productPrices;
    }
