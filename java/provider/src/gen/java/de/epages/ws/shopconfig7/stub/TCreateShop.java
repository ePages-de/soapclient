...
public class TCreateShop  implements java.io.Serializable {
    ...
    /* secondary domain names to access the shop (optional) */
    ...
    /* password of the primary shop administrator */
    ...
    /* list of additional shop attributes (see epagestypes:ListOfAttributes).
    ...
    /**
     * Gets the secondaryDomains value for this TCreateShop.
     * 
     * @return secondaryDomains   * secondary domain names to access the shop (optional)
     */
    ...
    /**
     * Sets the secondaryDomains value for this TCreateShop.
     * 
     * @param secondaryDomains   * secondary domain names to access the shop (optional)
     */
     ...
     * 
     * @return merchantPassword   * password of the primary shop administrator
     */
     ...
     * 
     * @param merchantPassword   * password of the primary shop administrator
     */
    ...
    /**
     * Gets the attributes value for this TCreateShop.
     * 
     * @return attributes   * list of additional shop attributes (see epagestypes:ListOfAttributes).
     * Only attributes of type String are supported.
     */
    ...
    /**
     * Sets the attributes value for this TCreateShop.
     * 
     * @param attributes   * list of additional shop attributes (see epagestypes:ListOfAttributes).
     * Only attributes of type String are supported.
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/ShopConfigService/2014/03", "TCreateShop"));
