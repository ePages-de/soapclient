...
/**
 * a single return value of a exists() call.
...
public class TExists_Return  implements java.io.Serializable {
     ...
     * 
     * @return exists   * a boolean flag indicating whether or not this feature pack
     * exists
     */
     ...
     * 
     * @param exists   * a boolean flag indicating whether or not this feature pack
     * exists
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/FeaturePackTypes/2005/03", "TExists_Return"));
