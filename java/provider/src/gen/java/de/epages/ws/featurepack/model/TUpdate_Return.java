...
/**
 * a single return value of an update() call.
...
public class TUpdate_Return  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn://epages.de/WebService/FeaturePackTypes/2005/03", "TUpdate_Return"));
