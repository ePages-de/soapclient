...
public class SimpleProvisioningServiceLocator extends org.apache.axis.client.Service implements de.epages.ws.simpleprovisioning2.stub.SimpleProvisioningService {
 ...
 */
    ...
    public de.epages.ws.simpleprovisioning2.stub.Port_SimpleProvisioning getport_SimpleProvisioning() throws javax.xml.rpc.ServiceException {
    ...
    public de.epages.ws.simpleprovisioning2.stub.Port_SimpleProvisioning getport_SimpleProvisioning(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            de.epages.ws.simpleprovisioning2.stub.Bind_SimpleProvisioning_SOAPStub _stub = new de.epages.ws.simpleprovisioning2.stub.Bind_SimpleProvisioning_SOAPStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (de.epages.ws.simpleprovisioning2.stub.Port_SimpleProvisioning.class.isAssignableFrom(serviceEndpointInterface)) {
                de.epages.ws.simpleprovisioning2.stub.Bind_SimpleProvisioning_SOAPStub _stub = new de.epages.ws.simpleprovisioning2.stub.Bind_SimpleProvisioning_SOAPStub(new java.net.URL(port_SimpleProvisioning_address), this);
                _stub.setPortName(getport_SimpleProvisioningWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("urn://epages.de/WebService/SimpleProvisioningService/2013/05", "SimpleProvisioningService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("urn://epages.de/WebService/SimpleProvisioningService/2013/05", "port_SimpleProvisioning"));
        }
