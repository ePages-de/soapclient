...
import de.epages.ws.shopconfig7.stub.ShopConfigServiceLocator;
import de.epages.ws.shopconfig7.stub.Port_ShopConfig;
import de.epages.ws.shopconfig7.stub.TCreateShop;
import de.epages.ws.shopconfig7.stub.TInfoShop;
import de.epages.ws.shopconfig7.stub.TInfoShop_Input;
import de.epages.ws.shopconfig7.stub.TShopRef;
import de.epages.ws.shopconfig7.stub.TUpdateShop;
...
public final class ShopConfigServiceClientImpl implements ShopConfigServiceClient {
    ...
    @Override
    public void setSecondaryDomains(TShopRef shopRef, String[] secondaryDomains) {
        try {
            stub.setSecondaryDomains(shopRef, secondaryDomains);
        } catch (RemoteException e) {
            throw new WebServiceException(e);
        }
    }
