...
my $CustomerService = WebServiceClient
    ->uri( 'urn://epages.de/WebService/CustomerService/2006/07' )
...
sub testGetInfo {
    ...
    ok( $hResult->{'CustomerGroup'} eq WEBSERVICE_SHOP_PATH.$options->{'CustomerGroup'}, 'customer group' );
...
# get the existing customer groups from the Demo shop
sub _testGroups {
