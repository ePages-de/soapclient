...
my $options = {
    ...
    'TargetProduct' => 'Products/de_3206199010', #Deuter Schmuseb�r
...
sub testInsert {
    ...
    is( scalar @$ahResults, 1, "insert: result count" );
...
sub testInsert2 {
    ...
    is( scalar @$ahResults, @$aCrossSelling_in2, "insert2: result count" );
...
sub testGet {
    ...
    is( scalar @$ahResults, 1, "get: result count" );
