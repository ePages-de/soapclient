...
my $ProductTypeService = WebServiceClient
    ->uri( 'urn://epages.de/WebService/ProductTypeService2/2007/11' )
...
use constant ATTRIBUTE3_ALIAS    => 'attribute3';
use constant ATTRIBUTE3_PATH     => ATTRIBUTES_PATH . ATTRIBUTE3_ALIAS;
use constant ATTRIBUTE3_TYPE     => 'PreDefCustomerString';
use constant ATTRIBUTE3_NAME_DE  => 'attribute3DE';
use constant ATTRIBUTE3_NAME_EN  => 'attribute3EN';
use constant ATTRIBUTE3_DESCR_DE => 'attribute3descrDE';
use constant ATTRIBUTE3_DESCR_EN => 'attribute3descrEN';
...
sub testCreateProductAttribute {
    my @Create = (
        ...
        {'Alias'        => ATTRIBUTE3_ALIAS,
         'Type'         => ATTRIBUTE3_TYPE,
         'Name'         => [{'LanguageCode' => 'de', 'Value' => ATTRIBUTE3_NAME_DE},
                            {'LanguageCode' => 'en', 'Value' => ATTRIBUTE3_NAME_EN}],
         'Description'  => [{'LanguageCode' => 'de', 'Value' => ATTRIBUTE3_DESCR_DE},
                            {'LanguageCode' => 'en', 'Value' => ATTRIBUTE3_DESCR_EN}],
         'Position'     => 1024
        },
    ...
    my $ahAttributes = $ProductTypeService->createProductAttribute(PERL_TEST1_PATH, \@Create)->result;
    ok(4 == scalar(@$ahAttributes), 'createProductAttribute: results count');
    ...
    ok(ATTRIBUTE3_ALIAS eq $ahAttributes->[2]->{'Alias'}, ATTRIBUTE3_ALIAS . ' createProductAttribute: Alias');
    ok(!$ahAttributes->[2]->{'Error'},                    ATTRIBUTE3_ALIAS . ' createProductAttribute: no error');
    ok(ATTRIBUTE3_PATH eq $ahAttributes->[2]->{'Path'},   ATTRIBUTE3_ALIAS . ' createProductAttribute: Path');
    ok($ahAttributes->[2]->{'created'},                   ATTRIBUTE3_ALIAS . ' createProductAttribute: created true');

    ok('CurrencyID' eq $ahAttributes->[3]->{'Alias'}, 'CurrencyID createProductAttribute: Alias');
    ok($ahAttributes->[3]->{'Error'},                 'CurrencyID createProductAttribute: error');
}

#---------------------------------------------------------------------------------------------------
sub testGetAllProductAttibutesInfo {
    my $ahAttributes = $ProductTypeService->getAllProductAttributesInfo(PERL_TEST1_PATH, ['de', 'en'])->result;
...
sub testGetProductAttributeInfo {
    my $ahAttributes = $ProductTypeService->getProductAttributeInfo(
        PERL_TEST1_PATH,
...
sub testExistsProductAttribute {
    my $ahAttributes = $ProductTypeService->existsProductAttribute(
        PERL_TEST1_PATH,
        [ATTRIBUTE1_ALIAS, ATTRIBUTE2_ALIAS, NOT_EXISTING_ALIAS]
    )->result;
...
sub testUpdateProductAttribute {
    ...
    my $ahAttributes = $ProductTypeService->updateProductAttribute(PERL_TEST1_PATH, \@Update)->result;
    ...
    $ahAttributes = $ProductTypeService->getProductAttributeInfo(
        PERL_TEST1_PATH,
...
sub testDeleteProductAttribute {
    my $ahAttributes = $ProductTypeService->deleteProductAttribute(PERL_TEST1_PATH, [ATTRIBUTE1_ALIAS, NOT_EXISTING_ALIAS])->result;
    ...
    $ahAttributes = $ProductTypeService->existsProductAttribute(PERL_TEST1_PATH, [ATTRIBUTE1_ALIAS])->result;
...
sub testCreatePreDefAttribute {
    ...
    my $ahPreDefs = $ProductTypeService->createPreDefAttribute(ATTRIBUTE2_PATH, \@Create)->result;
...
sub testGetAllPreDefAttributesInfo {
    my $ahPreDefs = $ProductTypeService->getAllPreDefAttributesInfo(ATTRIBUTE2_PATH, [])->result;
...
sub testGetPreDefAttributeInfo {
    my $ahPreDefs = $ProductTypeService->getPreDefAttributeInfo(
        ATTRIBUTE2_PATH,
...
sub testExistsPreDefAttribute {
    my $ahPreDefs = $ProductTypeService->existsPreDefAttribute(
        ATTRIBUTE2_PATH,
        [PREDEF_ATTRIBUTE1_ALIAS, PREDEF_ATTRIBUTE2_ALIAS, NOT_EXISTING_ALIAS]
    )->result;
...
sub testUpdatePreDefAttibute {
    ...
    my $ahPreDefs = $ProductTypeService->updatePreDefAttribute(ATTRIBUTE2_PATH, \@Update)->result;
    ...
    $ahPreDefs = $ProductTypeService->getPreDefAttributeInfo(
        ATTRIBUTE2_PATH,
...
sub testDeletePreDefAttribute {
    my $ahPreDefs = $ProductTypeService->deletePreDefAttribute(
        ATTRIBUTE2_PATH,
    ...
    $ahPreDefs = $ProductTypeService->existsPreDefAttribute(ATTRIBUTE2_PATH, [PREDEF_ATTRIBUTE2_ALIAS])->result;
